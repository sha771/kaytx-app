/**
 * Comprehensive script to fix all package.json exports configuration in node_modules
...
function findPnpmPackagePath(pkgName) {
  ...
  for (const entry of entries) {
    // Check if the entry starts with the package name (pnpm format: pkgname@version_...)
...
console.log('Fixing all package.json exports configuration...\n');
