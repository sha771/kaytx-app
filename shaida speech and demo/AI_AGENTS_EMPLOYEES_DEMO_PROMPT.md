# KAYTX AI Agents & Employees - Demo Video Prompt
...
- Click "Deploy All"
- Show progress bar: "Deploying 5 agents..."
- Show completion: "5 agents now active"
...
| Screen | Path | Purpose |
|--------|------|---------|
| Home Dashboard | `app/home.tsx` | Main AI agents view |
| C-Suite Section | `app/home.tsx` | Executive agents |
| Department Grid | `app/home.tsx` | All 21 departments |
| Agent Builder | `app/ai-agents-employees-builder.tsx` | Agent configuration |
| Individual Agent | `app/ai-agent/[id].tsx` | Agent detail view |
| Org Chart | Custom view | Hierarchy visualization |

## Recording Tips

1. **Smooth scrolling** - Enable smooth scroll in browser settings
2. **Click highlighting** - Use OBS click effects or Camtasia cursor effects
3. **Timing** - Practice the flow before recording
4. **Clean environment** - Close all other apps, hide bookmarks
5. **Consistent zoom** - Keep zoom at 75% throughout
...
- **Corporate Uplift** - Modern, professional, building energy
- **Technology Minimal** - Subtle background, not distracting
- **Innovation Forward** - Confident, visionary tone
...
For social media (Twitter/X, LinkedIn, Instagram Reels):

| Time | Visual | Voiceover |
|------|--------|-----------|
| 0:00-0:05 | "1,100 employees?" text → Dashboard | "What if you had 1,100 AI employees?" |
| 0:05-0:12 | C-Suite + Department grid | "C-Suite executives. 21 departments." |
| 0:12-0:18 | Agent profiles + Org chart | "Specialized agents. Real hierarchy." |
| 0:18-0:25 | Deployment animation | "Deploy instantly. Scale on demand." |
| 0:25-0:30 | Logo + CTA | "KAYTX. Starts at $49/month." |
...
Try free at kaytx.com 👆

#AI #Enterprise #Workforce #Automation #Tech
```
...
| Human Employee Cost | $60,000/year |
| Cost Savings | 99% |
| Uptime | 24/7 |
...
- **Primary**: CEOs, Founders, CTOs of SMBs and mid-market companies
- **Secondary**: VP of Operations, HR Directors, CFOs
- **Tertiary**: Enterprise decision-makers exploring AI automation

### Pain Points Addressed
- High labor costs ($60K+/year per employee)
- Slow hiring and onboarding processes
- Limited expertise across all business functions
- Inability to scale workforce quickly
- High training and management overhead
- Employee turnover and burnout

### Desired Outcomes
- Instant workforce deployment
- 99% cost reduction
...
*Focused demo prompt for KAYTX AI Agents & Employees feature*
