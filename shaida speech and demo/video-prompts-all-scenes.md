# KAYTX Enterprise AI Operating System — Complete Video Scene Prompts

## HOOK — 0:00 to 0:05
**Duration:** 5 seconds | **Key Message:** Stop drowning in notifications

### Cinematic Prompt:
```
BLACK SCREEN — Absolute silence for 1 second. Then a phone notification sound. Then another. Then a cascade of notification chimes (email, WhatsApp, Slack, SMS) building to overwhelming chaos.

SUDDEN CUT — Freeze frame of a chaotic inbox with 99+ unread messages. Red badges everywhere. Numbers flying upward.

TEXT SLAMS ON SCREEN: "What if you never missed a message again?" — White text, 72px, bold, center frame.

QUICK FLASH — The chaos resolves into the pristine Unified Inbox interface. All notifications consolidate into one elegant stream.

CAMERA PUSH-IN — Through the screen into the KAYTX world. 4K, 60fps, sub-bass sound design.
```

### Visual Elements:
- **Audio:** Notification crescendo → sudden silence
- **Typography:** Bold white text with subtle motion blur
- **Transition:** Hard cut to smooth flow
- **Color:** Black → sudden full color (#0B1120 navy)
...
### Visual Elements:
- **Color Palette:** Navy (#0B1120), Cyan (#00D9FF), Purple (#7B61FF), Gold (#FFB800)
- **Key UI:** Unified stream, platform icons, priority badges, search overlay
- **Animation Style:** Horizontal flow, particle effects, glass-morphism cards
- **Typography:** SF Pro Display, bold weights for metrics
...
### Visual Elements:
- **Structure:** 3-tier orbital hierarchy with connecting data lines
- **Avatars:** Abstract geometric executive profiles with department colors
- **Animation:** Sequential reveal with 0.3s stagger, 360° camera orbit
- **Effects:** Volumetric lighting, particle connections, data stream particles
...
### Visual Elements:
- **Comparison:** Split-screen traditional vs KAYTX approach
- **Visual Metaphor:** Fire/waste vs efficient flow
- **Typography:** Massive "85%" with gold gradient, savings counter animation
- **Animation:** Counter spin-up, shockwave transition, push-through camera
...
### Visual Elements:
- **Layout:** 3-panel command center (Calendar / Publishing / Analytics)
- **Platform Icons:** Instagram, LinkedIn, Twitter/X, TikTok with brand colors
- **Data Viz:** Rising graphs, animated counters, performance meters
- **AI Elements:** Floating hashtag bubbles, suggestion glow effects
...
### Cinematic Prompt:
```
HOLOGRAPHIC CUSTOMER INTELLIGENCE — 3D contact card materializes center frame, rotating slowly with glass-morphism refraction. Faceless professional avatar rendered in elegant white wireframe, surrounded by four orbiting data spheres at cardinal points.

DATA SPHERES ACTIVATE:
- EMAIL SPHERE (Blue): Expands showing chronological thread visualization
...
### Visual Elements:
- **Central Element:** 3D rotating contact card with avatar
- **Data Spheres:** 4 orbiting spheres showing different data dimensions
- **Metrics:** Large animated counters with motion blur
- **Visualization:** Timeline history, revenue forecast projection
...
### Cinematic Prompt:
```
DUAL-WORKFORCE SYMPHONY — Screen divided by living energy bridge. LEFT SIDE bathed in WARM AMBER/GOLD tones (human workspace). RIGHT SIDE in COOL CYAN/PURPLE (AI realm). Center bridge pulses with task traffic flowing both directions.
...
### Visual Elements:
- **Color Coding:** Warm tones (human) vs Cool tones (AI)
...
## TECHNICAL SPECIFICATIONS (All Scenes)

### Format Requirements:
- **Resolution:** 4K UHD (3840x2160) primary delivery, 2K (2560x1440) web, 1080p proxies
- **Aspect Ratios:** 
  - 16:9 (1.78:1) — Primary cinematic version
  - 1:1 Square — Instagram feed/ads (crop center 70%)
  - 9:16 Vertical — TikTok/Reels/Stories (crop center 50% width)
  - 4:5 — Instagram portrait feed
- **Frame Rate:** 60fps for UI animations (deliver 24fps cinematic version for film festivals)
- **Color Space:** Rec. 709 (broadcast), HDR10+ (premium), P3-D65 (theatrical)
- **Codec:** ProRes 422 HQ (master), H.265 HEVC (delivery), H.264 (web)

### Cinematic Language:
- **Lens Choices:** 
  - Wide shots: 18-24mm for scale and immersion
  - Medium shots: 35-50mm for natural perspective
  - Details: 85-100mm macro for UI elements
- **Camera Movement:** 
  - Dolly: Smooth linear movements (0.3m/s average)
  - Orbit: 360° around subjects at 15°/sec
  - Push-in: Slow intensification (0.5m over 3s)
  - Pan: Fluid across UI panels (2-4s duration)
- **Depth of Field:** 
  - Shallow (f/1.4-f/2.8) for subject isolation
  - Deep (f/8-f/11) for complex UI layouts

### Safe Zones:
- **16:9 Title Safe:** 10% margin all sides
- **1:1 Square:** Keep critical UI within 1080x1080 center crop
- **9:16 Vertical:** Essential elements within 540px horizontal center
- **Captions:** Lower third 15% reserved for subtitle burn-in
- **Action Safe:** Keep motion graphics within 90% frame boundary

### Brand Elements (Consistent Across All Scenes):
- **Primary Navy:** #0B1120 (deep space backgrounds)
- **Accent Cyan:** #00D9FF (AI intelligence, technology)
- **Accent Purple:** #7B61FF (creativity, innovation)
- **Success Gold:** #FFB800 (achievements, metrics, ROI)
- **Alert Red:** #FF4757 (urgency, errors, warnings)
- **Human Warmth:** #FFB347, #FF9500 (human team elements)
- **Typography:** 
  - Display: SF Pro Display Bold (60-120px headlines)
  - UI: Inter SemiBold (24-48px interface elements)
  - Data: JetBrains Mono (metrics, numbers)
  - Subtitles: Inter Regular with 120% line height

### Animation Timing Standards:
- **UI Stagger:** 0.15s between sequential elements
- **Counter Duration:** 
  - <1,000: 1.5s with easing
  - 1,000-10,000: 2.0s with motion blur
  - >10,000: 2.5s with segmented counting
- **Camera Movement:** 
  - Ease-in-out-expo for dramatic moves
  - Linear for continuous orbits
  - Smooth dampening for stops
- **Transitions:** 
  - Cross-dissolve: 0.5s standard
  - Motion wipe: 0.8s match-cut
  - Shockwave: 0.3s impact frames
- **Particle Density:** 
  - Low: 25-50 (minimal scenes)
  - Medium: 100-200 (standard UI)
  - High: 500+ (AI hierarchy reveal)

### VFX Requirements:
- **Volumetric Lighting:** God rays, dust particles, atmospheric depth
- **Lens Effects:** Anamorphic flares (2.39:1 moments), chromatic aberration (subtle), lens dust
- **Particle Systems:** 
  - Data streams: 10,000+ particles with turbulence
  - Connection lines: Bezier curves with glow
  - Success bursts: Radial explosion from center
- **Shader Effects:** 
  - Glass-morphism: Blur 20px + saturation 120% + white 10% overlay
  - Holographic: Scan lines + chromatic shift + flicker
  - Energy: Fractal noise + time displacement

---

## SFX CUE SHEET (Cross-Reference with VO Script)
...
## SYNCHRONIZED VO SCRIPT WITH SCENE CROSS-REFERENCE

**Total Runtime:** 3:25 (205 seconds) | **Pacing:** 145 WPM with dramatic pauses
...
- **Tone:** Authoritative, calm, confident. No hard sell. Think enterprise keynote (Apple WWDC, Microsoft Build)
- **Pauses:** Written into timing. Critical for SFX hits at 0:02 (Hook), 0:30 (AI Workforce), 1:00 (Cost), 1:17 (Social Media), 1:40 (CRM), 2:05 (Team), 2:27 (Brand), 2:47 (Problem), 2:55 (Command), 3:23 (CTA)
- **Emphasis:** Hit numbers hard — "628 AI employees", "$49/month", "85% reduction", "$710,000+"
- **Pacing:** 145 WPM base with dynamic variation (slower on key metrics, faster on transitions)
- **Mix:** VO at -12dB, music bed at -20dB. Duck music 3dB during key metrics delivery

---

## MUSIC BED SPECIFICATIONS
...
*Generated for KAYTX Enterprise Demo Video | Runtime: 3:25 | 145 WPM VO pacing | 628 AI Agents*
