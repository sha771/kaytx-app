...
// Immediately set up global logger config BEFORE any imports/exports
(function() {
  const config = {
    logger: {
      warning: function() {},
...
// Define global logger config for reanimated web compatibility (TypeScript)
declare global {
...
export default {
  ...
  ZoomIn, ZoomOut,
  FlipInYLeft, FlipInYRight, FlipInXUp, FlipInXDown,
  FlipOutYLeft, FlipOutYRight, FlipOutXUp, FlipOutXDown,
  BounceIn, BounceOut,
  Layout,
  Easing,
  runOnUI,
