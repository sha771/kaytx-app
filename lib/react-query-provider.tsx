...
export function useAuth() {
  ...
  const login = async (email: string, password: string) => {
    setIsLoading(true);
    try {
      const result = await apiClient.auth.login.mutate({ email, password });
      return result;
    } catch (error) {
  ...
  const me = async () => {
    try {
      const result = await apiClient.auth.me.query();
      return result;
    } catch (error) {
...
export function useAIAssistant() {
  ...
  const chat = async (message: string, conversationId?: string) => {
    setIsLoading(true);
    try {
      const result = await apiClient.aiAssistant.chat.mutate({ 
  ...
  const getTasks = async () => {
    try {
      const result = await apiClient.aiAssistant.tasks.query();
      return result;
    } catch (error) {
  ...
  const createTask = async (task: { title: string; description: string; priority: string }) => {
    setIsLoading(true);
    try {
      const result = await apiClient.aiAssistant.tasks.create.mutate({
        title: task.title,
  ...
  const getMemories = async () => {
    try {
      const result = await apiClient.aiAssistant.memories.query();
      return result;
    } catch (error) {
...
export function useAIAgents() {
  ...
  const getAgents = async () => {
    try {
      const result = await apiClient.aiAgents.query();
      return result;
    } catch (error) {
  ...
  const getAgent = async (id: string) => {
    try {
      const result = await apiClient.aiAgents.get.query({ id });
      return result;
    } catch (error) {
  ...
  const createAgent = async (agent: {
    ...
    setIsLoading(true);
    try {
      const result = await apiClient.aiAgents.create.mutate(agent);
      return result;
    } catch (error) {
  ...
  const updateAgent = async (id: string, updates: any) => {
    setIsLoading(true);
    try {
      const result = await apiClient.aiAgents.update.mutate({ id, updates });
      return result;
    } catch (error) {
  ...
  const deleteAgent = async (id: string) => {
    setIsLoading(true);
    try {
      await apiClient.aiAgents.delete.mutate({ id });
    } catch (error) {
...
export function usePlatforms() {
  ...
  const getPlatforms = async () => {
    try {
      const result = await apiClient.platforms.getAll.query();
  ...
  const searchPlatforms = async (query: string) => {
    try {
      const result = await apiClient.platforms.search.query({ query });
      return result.platforms;
    } catch (error) {
  ...
  const connectPlatform = async (platform: {
    ...
    setIsLoading(true);
    try {
      const result = await apiClient.platforms.connectQR.mutate({
  ...
  const disconnectPlatform = async (platformId: string) => {
    setIsLoading(true);
    try {
      await apiClient.platforms.disconnect.mutate({ platformId });
    } catch (error) {
  ...
  const syncPlatform = async (platformId: string) => {
    setIsLoading(true);
    try {
      const result = await apiClient.platforms.sync.mutate({ platformId });
      return result;
    } catch (error) {
...
export function useAnalytics() {
  ...
  const getMetrics = async (period?: string) => {
    try {
      const result = await apiClient.analytics.getMetrics.query({ period });
      return result;
    } catch (error) {
  ...
  const getCampaigns = async () => {
    try {
      const result = await apiClient.marketing.getCampaigns.query();
      return result;
    } catch (error) {
  ...
  const getCRMData = async (type?: string) => {
    try {
      const result = await apiClient.business.getCrmData.query({ type });
      return result;
    } catch (error) {
...
export function useNotifications() {
  ...
  const getNotifications = async () => {
    try {
      const result = await apiClient.notifications.getAll.query();
      return result;
    } catch (error) {
...
export function useEnterprise() {
  ...
  const getDashboard = async () => {
    try {
      const result = await apiClient.enterprise.getSubscription.query();
      return result;
    } catch (error) {
...
export function useBridges() {
  ...
  const getBridges = async () => {
    try {
      const result = await apiClient.bridges.list.query();
      return result;
    } catch (error) {
      throw error;
    }
  ...
  const createBridge = async (bridge: {
    ...
    setIsLoading(true);
    try {
      const result = await apiClient.bridges.create.mutate({
  ...
  const connectBridge = async (bridgeId: string, credentials: any) => {
    setIsLoading(true);
    try {
      const result = await apiClient.bridges.connect.mutate({ bridgeId });
      return result;
    } catch (error) {
      throw error;
    } finally {
  ...
  const disconnectBridge = async (bridgeId: string) => {
    setIsLoading(true);
    try {
      await apiClient.bridges.disconnect.mutate({ bridgeId });
    } catch (error) {
      throw error;
    } finally {
      setIsLoading(false);
  ...
  const getBridgeHealth = async (bridgeId: string) => {
    try {
      const result = await apiClient.bridges.health.query({ bridgeId });
      return result;
    } catch (error) {
      throw error;
    }
...
export function useCalling() {
  ...
  const initiateCall = async (phoneNumber: string, options?: any) => {
    setIsLoading(true);
    try {
      const result = await apiClient.calling.initiateCall.mutate({ 
        phoneNumber,
  ...
  const endCall = async (callId: string) => {
    setIsLoading(true);
    try {
      await apiClient.calling.end.mutate({ callId });
    } catch (error) {
      throw error;
    } finally {
      setIsLoading(false);
  ...
  const getCallRecording = async (callId: string, format?: string) => {
    try {
      const result = await apiClient.calling.recording.query({ callId, format });
      return result;
    } catch (error) {
      throw error;
    }
...
export function usePrivacy() {
  ...
  const getConsentRecords = async () => {
    try {
      const result = await apiClient.privacy.getSettings.query();
      return result;
    } catch (error) {
      throw error;
    }
