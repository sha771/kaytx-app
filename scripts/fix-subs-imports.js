...
const allIcons = ['Activity','ArrowRight','BarChart3','Calculator','Calendar','ChartBarBig','ChevronRight','CircleCheckBig','Clock','ClipboardCheck','Code','Database','DollarSign','Eye','FileText','Globe','History','Key','Landmark','Layers','Leaf','Microscope','Monitor','PieChart','Rocket','Scale','Search','Shield','ShieldAlert','ShieldCheck','Star','Target','TestTube','TrendingUp','Users','Zap','AlertTriangle','Briefcase','ArrowRightLeft','Bitcoin'];
let fixes = 0;
