...
export const SKILL_LIBRARY: Record<string, AgentSkill[]> = {
  ...
  trading: [
    ...
    { id: 'trade_2', name: 'Portfolio Management', category: 'Operations', description: 'Manage investment portfolios', level: 'expert' },
    { id: 'trade_3', name: 'Risk Assessment', category: 'Analytics', description: 'Assess trading risks', level: 'advanced' },
    { id: 'trade_4', name: 'Algorithmic Trading', category: 'Technical', description: 'Execute algorithmic trades', level: 'expert' },
    { id: 'trade_5', name: 'Order Execution', category: 'Operations', description: 'Execute trade orders', level: 'advanced' },
    { id: 'trade_6', name: 'Compliance Monitoring', category: 'Operations', description: 'Monitor trading compliance', level: 'advanced' },
  ],
  real_estate: [
    { id: 're_1', name: 'Property Valuation', category: 'Analytics', description: 'Value properties accurately', level: 'advanced' },
    { id: 're_2', name: 'Lease Management', category: 'Operations', description: 'Manage lease agreements', level: 'intermediate' },
    { id: 're_3', name: 'Tenant Relations', category: 'Operations', description: 'Handle tenant communications', level: 'intermediate' },
    { id: 're_4', name: 'Property Maintenance', category: 'Operations', description: 'Coordinate property maintenance', level: 'intermediate' },
    { id: 're_5', name: 'Market Analysis', category: 'Analytics', description: 'Analyze real estate markets', level: 'advanced' },
    { id: 're_6', name: 'Investment Analysis', category: 'Analytics', description: 'Analyze property investments', level: 'expert' },
  ],
  insurance: [
    { id: 'ins_1', name: 'Underwriting', category: 'Operations', description: 'Assess insurance risks', level: 'expert' },
    { id: 'ins_2', name: 'Claims Processing', category: 'Operations', description: 'Process insurance claims', level: 'advanced' },
    { id: 'ins_3', name: 'Risk Modeling', category: 'Analytics', description: 'Model insurance risks', level: 'expert' },
    { id: 'ins_4', name: 'Policy Management', category: 'Operations', description: 'Manage insurance policies', level: 'intermediate' },
    { id: 'ins_5', name: 'Fraud Detection', category: 'Analytics', description: 'Detect insurance fraud', level: 'expert' },
    { id: 'ins_6', name: 'Regulatory Compliance', category: 'Operations', description: 'Ensure regulatory compliance', level: 'advanced' },
  ],
  healthcare: [
    { id: 'health_1', name: 'Patient Care Coordination', category: 'Operations', description: 'Coordinate patient care', level: 'advanced' },
    { id: 'health_2', name: 'Medical Billing', category: 'Operations', description: 'Process medical billing', level: 'intermediate' },
    { id: 'health_3', name: 'Health Records Management', category: 'Operations', description: 'Manage health records', level: 'advanced' },
    { id: 'health_4', name: 'Compliance Monitoring', category: 'Operations', description: 'Monitor healthcare compliance', level: 'expert' },
    { id: 'health_5', name: 'Telehealth Support', category: 'Technical', description: 'Support telehealth services', level: 'intermediate' },
    { id: 'health_6', name: 'Quality Improvement', category: 'Analytics', description: 'Improve healthcare quality', level: 'advanced' },
  ],
  manufacturing: [
    { id: 'mfg_1', name: 'Production Planning', category: 'Operations', description: 'Plan production schedules', level: 'advanced' },
    { id: 'mfg_2', name: 'Quality Control', category: 'Operations', description: 'Ensure product quality', level: 'expert' },
    { id: 'mfg_3', name: 'Supply Chain Management', category: 'Operations', description: 'Manage supply chains', level: 'advanced' },
    { id: 'mfg_4', name: 'Inventory Management', category: 'Operations', description: 'Manage inventory levels', level: 'intermediate' },
    { id: 'mfg_5', name: 'Process Optimization', category: 'Strategy', description: 'Optimize manufacturing processes', level: 'expert' },
    { id: 'mfg_6', name: 'Safety Compliance', category: 'Operations', description: 'Ensure safety compliance', level: 'expert' },
  ],
  transportation: [
    { id: 'trans_1', name: 'Route Optimization', category: 'Analytics', description: 'Optimize delivery routes', level: 'expert' },
    { id: 'trans_2', name: 'Fleet Management', category: 'Operations', description: 'Manage vehicle fleets', level: 'advanced' },
    { id: 'trans_3', name: 'Logistics Coordination', category: 'Operations', description: 'Coordinate logistics operations', level: 'advanced' },
    { id: 'trans_4', name: 'Warehouse Operations', category: 'Operations', description: 'Manage warehouse operations', level: 'intermediate' },
    { id: 'trans_5', name: 'Shipment Tracking', category: 'Technical', description: 'Track shipments in real-time', level: 'intermediate' },
    { id: 'trans_6', name: 'Freight Management', category: 'Operations', description: 'Manage freight operations', level: 'advanced' },
  ],
  government: [
    { id: 'gov_1', name: 'Policy Analysis', category: 'Analytics', description: 'Analyze government policies', level: 'expert' },
    { id: 'gov_2', name: 'Regulatory Compliance', category: 'Operations', description: 'Ensure regulatory compliance', level: 'expert' },
    { id: 'gov_3', name: 'Public Administration', category: 'Operations', description: 'Manage public services', level: 'advanced' },
    { id: 'gov_4', name: 'Grants Management', category: 'Operations', description: 'Manage grant programs', level: 'intermediate' },
    { id: 'gov_5', name: 'Transparency Reporting', category: 'Analytics', description: 'Report on government activities', level: 'advanced' },
    { id: 'gov_6', name: 'Citizen Engagement', category: 'Operations', description: 'Engage with citizens', level: 'intermediate' },
  ],
  supply_chain: [
    { id: 'sc_1', name: 'Procurement', category: 'Operations', description: 'Manage procurement processes', level: 'advanced' },
    { id: 'sc_2', name: 'Inventory Optimization', category: 'Analytics', description: 'Optimize inventory levels', level: 'expert' },
    { id: 'sc_3', name: 'Supplier Management', category: 'Operations', description: 'Manage supplier relationships', level: 'advanced' },
    { id: 'sc_4', name: 'Demand Planning', category: 'Analytics', description: 'Forecast demand accurately', level: 'expert' },
    { id: 'sc_5', name: 'Logistics Coordination', category: 'Operations', description: 'Coordinate logistics operations', level: 'advanced' },
    { id: 'sc_6', name: 'Risk Management', category: 'Analytics', description: 'Manage supply chain risks', level: 'advanced' },
  ],
  administrative: [
    { id: 'admin_1', name: 'Office Management', category: 'Operations', description: 'Manage office operations', level: 'intermediate' },
    { id: 'admin_2', name: 'Facilities Coordination', category: 'Operations', description: 'Coordinate facilities', level: 'intermediate' },
    { id: 'admin_3', name: 'Document Management', category: 'Operations', description: 'Manage documents efficiently', level: 'intermediate' },
    { id: 'admin_4', name: 'Travel Coordination', category: 'Operations', description: 'Coordinate travel arrangements', level: 'basic' },
    { id: 'admin_5', name: 'Meeting Coordination', category: 'Operations', description: 'Schedule and coordinate meetings', level: 'basic' },
    { id: 'admin_6', name: 'Supply Management', category: 'Operations', description: 'Manage office supplies', level: 'basic' },
  ],
  research: [
    { id: 'research_1', name: 'Research Design', category: 'Analytics', description: 'Design research studies', level: 'expert' },
    { id: 'research_2', name: 'Data Collection', category: 'Technical', description: 'Collect research data', level: 'advanced' },
    { id: 'research_3', name: 'Analysis', category: 'Analytics', description: 'Analyze research findings', level: 'expert' },
    { id: 'research_4', name: 'Innovation Management', category: 'Strategy', description: 'Manage innovation processes', level: 'advanced' },
    { id: 'research_5', name: 'Patent Research', category: 'Analytics', description: 'Research patent landscapes', level: 'expert' },
    { id: 'research_6', name: 'Prototype Development', category: 'Technical', description: 'Develop prototypes', level: 'advanced' },
  ],
  ai_management: [
    { id: 'aimgmt_1', name: 'Process Automation', category: 'Technical', description: 'Automate business processes', level: 'expert' },
    { id: 'aimgmt_2', name: 'RPA Management', category: 'Operations', description: 'Manage RPA bots', level: 'advanced' },
    { id: 'aimgmt_3', name: 'Workflow Optimization', category: 'Strategy', description: 'Optimize workflows', level: 'expert' },
    { id: 'aimgmt_4', name: 'AI Governance', category: 'Operations', description: 'Govern AI systems', level: 'expert' },
    { id: 'aimgmt_5', name: 'Performance Monitoring', category: 'Analytics', description: 'Monitor AI performance', level: 'advanced' },
    { id: 'aimgmt_6', name: 'Continuous Improvement', category: 'Strategy', description: 'Continuously improve AI systems', level: 'advanced' },
  ],
};
