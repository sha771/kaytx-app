...
exports.aiInfrastructureStats = exports.aiEmployeeCategories = exports.aiEmployees = void 0;
const stub = () => null;
const Phone = stub, Users = stub, UserCheck = stub, DollarSign = stub, Megaphone = stub, Headphones = stub;
const Briefcase = stub, Settings = stub, BarChart3 = stub, Target = stub, Database = stub, Handshake = stub;
const TrendingUp = stub, Zap = stub, Eye = stub, Shield = stub, PiggyBank = stub, Search = stub;
const Globe = stub, UserPlus = stub, Share2 = stub, Bot = stub, Brain = stub, Cpu = stub, Server = stub;
const Activity = stub, Clock = stub, Sparkles = stub, CircleDollarSign = stub, Calculator = stub, Crown = stub;
const Award = stub, Lightbulb = stub, Monitor = stub, MessageCircle = stub, Scale = stub, Code = stub;
const Heart = stub, Gavel = stub, Building = stub, FileText = stub, CircleCheck = stub, Layers = stub;
const PenTool = stub, Calendar = stub, Radio = stub, Hash = stub, VideoIcon = stub, Send = stub;
const Inbox = stub, ImageIcon = stub, ChartLine = stub, ChartPie = stub, Wallet = stub, Receipt = stub;
const Percent = stub, CreditCard = stub, Landmark = stub, Coins = stub, GraduationCap = stub, ClipboardCheck = stub;
const Smile = stub, UserCog = stub, UserX = stub, Package = stub, FlaskConical = stub, Route = stub;
const TestTube = stub, GitBranch = stub, Workflow = stub, Factory = stub, Truck = stub, ClipboardList = stub;
const MessageSquare = stub, ThumbsUp = stub, Star = stub, UserMinus = stub, SquarePen = stub, LayoutDashboard = stub;
const BookOpen = stub, Terminal = stub, Cloud = stub, Wifi = stub, Lock = stub, LifeBuoy = stub;
const Network = stub, FileCheck = stub, TriangleAlert = stub, ScrollText = stub, BookMarked = stub, GitMerge = stub;
const Bug = stub, TestTubes = stub, SquarePlay = stub, Mail = stub, ListTodo = stub, Bell = stub;
const NotebookTabs = stub, Microscope = stub, BellRing = stub, MessageSquareText = stub, FileBadge = stub;
const TrendingDown = stub, ChartNoAxesCombined = stub, Rocket = stub, FingerprintPattern = stub, KeyRound = stub;
const ShieldCheck = stub, ShieldAlert = stub, ScanFace = stub, IdCard = stub, Presentation = stub, Speaker = stub;
const PanelLeft = stub, PanelTop = stub, PanelsTopLeft = stub, PanelsLeftBottom = stub, PanelsRightBottom = stub;
const PanelRight = stub, PanelBottom = stub, LayoutGrid = stub, LayoutList = stub, LayoutPanelLeft = stub;
const LayoutPanelTop = stub;
const agent_capability_enhancer_1 = require("./utils/agent-capability-enhancer");
exports.aiEmployees = (0, agent_capability_enhancer_1.autoEnhanceAllEmployees)([
    // ============================================
...
exports.aiInfrastructureStats = {
    totalEmployees: exports.aiEmployees.filter(e => e.type === 'employee').length,
    totalAgents: exports.aiEmployees.filter(e => e.type === 'agent').length,
    onlineCount: exports.aiEmployees.filter(e => e.infrastructure.status === 'online').length,
    averageHealth: Math.round(exports.aiEmployees.reduce((sum, e) => sum + e.infrastructure.health, 0) / exports.aiEmployees.length),
    totalMonthlySavings: '$250,000+',
    totalTasksAutomatedDaily: exports.aiEmployees.reduce((sum, e) => sum + e.roiMetrics.tasksAutomatedDaily, 0),
};
//# sourceMappingURL=aiEmployees.js.map