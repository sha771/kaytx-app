    ...
    const renderOverview = () => (
        <View style={styles.tabContent}>
            ...
            <View style={[styles.card, { backgroundColor: theme.colors.cardBackground }]}>
                ...
                <Text style={[styles.roleText, { color: theme.colors.secondaryText }]}>{agent.replacesRole}</Text>
            </View>
            ...
            <View style={[styles.card, { backgroundColor: theme.colors.cardBackground }]}>
                ...
                <View style={styles.roiComparison}>
                    <View style={styles.roiColumn}>
                        ...
                        <Text style={[styles.roiValue, { color: '#FF3B30' }]}>{agent.humanCost}</Text>
                    ...
                    <View style={styles.roiColumn}>
                        ...
                        <Text style={[styles.roiValue, { color: '#34C759' }]}>{agent.aiCost}</Text>
                ...
                <LinearGradient colors={['#34C75920', '#34C75910']} style={styles.efficiencyBanner}>
                    ...
                    <Text style={[styles.efficiencyText, { color: '#34C759' }]}>{agent.efficiency} Profitability Increase</Text>
                </LinearGradient>
            </View>
                ...
                <>
                    <View style={[styles.card, { backgroundColor: theme.colors.cardBackground }]}>
                        ...
                        <View style={styles.performanceGrid}>
                            ...
                            <View style={styles.performanceItem}>
                                <Text style={[styles.performanceValue, { color: agent.color }]}>{agent.roiMetrics.savingsPerMonth}</Text>
                    ...
                    <View style={[styles.card, { backgroundColor: theme.colors.cardBackground }]}>
                        ...
                        <View style={styles.operationalMetrics}>
                            <View style={styles.operationalItem}>
                                ...
                                <Text style={[styles.operationalValue, { color: theme.colors.text }]}>{agent.roiMetrics.tasksAutomatedDaily.toLocaleString()}</Text>
                            </View>
                            <View style={styles.operationalItem}>
                                <Text style={[styles.operationalLabel, { color: theme.colors.secondaryText }]}>Response Time</Text>
                                <Text style={[styles.operationalValue, { color: theme.colors.text }]}>{agent.roiMetrics.responseTime}</Text>
                            </View>
                            <View style={styles.operationalItem}>
            ...
            >
                ...
                <View style={styles.heroContent}>
                    ...
                    <View style={styles.heroText}>
                        ...
                        <View style={styles.statusRow}>
                            ...
                            <Text style={styles.statusText}>{agent.infrastructure.uptime} UPTIME</Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.headerStats}>
                    <View style={styles.headerStatItem}>
                        ...
                        <Text style={styles.headerStatValue}>{agent.infrastructure.processingPower.toUpperCase()}</Text>
