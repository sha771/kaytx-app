...
const categories: SidebarCategory[] = [
  ...
  { id: 'data-intelligence', label: 'Data & Intelligence AI', icon: BarChart3, color: '#9B59B6', route: '/ai-agent/data-intelligence-ai', count: 8 },
  ...
  { id: 'engineering-development', label: 'Engineering & Development AI', icon: Code2, color: '#1565C0', route: '/ai-agent/engineering-development-ai', count: 7 },
  { id: 'ai-personal-assistant', label: 'AI Personal Assistant', icon: UserCircle, color: '#1976D2', route: '/ai-agent/ai-personal-assistant-ai', count: 7 },
