...
describe('ContextService', () => {
  ...
  beforeEach(() => {
    ...
    // Setup default mock responses with full query chaining support
    const createQueryMock = (results: any[] = []) => {
      ...
      // Promise resolver
      mock.then = (resolve: any) => resolve(results);
      
      return mock;
    };

    mockDb.select = jest.fn().mockImplementation(() => createQueryMock());
  ...
  describe('getContext', () => {
    ...
    it('should use cached context when available', async () => {
      ...
      const cacheKey = 'context:00000000-0000-0000-0000-000000000123:11111111-1111-1111-1111-111111111111:profile:prefs:activity:perms';
      Object.defineProperty(contextService as any, 'contextCache', {
        value: new Map([[cacheKey, { timestamp: Date.now() }]]),
        writable: true
      });
