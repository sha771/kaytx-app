...
const styles = StyleSheet.create({
  ...
  gridItem: { width: (width - 42) / 2, height: 200, borderRadius: 14, overflow: 'hidden' },
  ...
  addItem: { width: (width - 42) / 2, height: 200, borderRadius: 14, borderWidth: 2, borderStyle: 'dashed', justifyContent: 'center', alignItems: 'center' },
