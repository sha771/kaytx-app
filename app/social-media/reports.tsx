...
import { FileText, Download, Calendar, ChartBarBig, TrendingUp, Users, Clock, ChevronRight, Plus } from 'lucide-react-native';
...
export default function PerformanceReports() {
  ...
  const reportTypes = [
    ...
    { id: '4', title: 'Content Performance', icon: ChartBarBig, color: '#AF52DE', desc: 'Post-level analytics' },
  ];
