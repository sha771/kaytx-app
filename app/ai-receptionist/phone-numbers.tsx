  ...
  const statsMetrics = useMemo(() => {
    if (statsData) {
      return [
        ...
        { title: 'Capacity', value: `${statsData.avgHealthScore}%`, icon: ChartBarBig, color: '#AF52DE', bgColor: '#AF52DE15' },
    ...
    return [
      ...
      { title: 'Capacity', value: '94%', icon: ChartBarBig, color: '#AF52DE', bgColor: '#AF52DE15' },
      { title: 'Avg Response', value: '1.8s', icon: Zap, color: '#32ADE6', bgColor: '#32ADE615' },
