...
export default function VPPropertyMgmtPage() {
  ...
  const capabilities = ['Property Mgmt', 'Lease Admin', 'Maintenance', 'Tenant Relations', 'Valuation', 'Market Analysis', 'Portfolio Opt', 'Compliance'];
  const responsibilities = [
    'Property Portfolio Strategy & Growth',
    'Lease Administration & Tenant Relations',
  ...
  const activities = [
    { time: '3 min ago', text: 'Updated property valuation for 12 assets' },
    { time: '20 min ago', text: 'Processed 8 lease renewal applications' },
    { time: '1 hour ago', text: 'Completed maintenance schedule optimization' },
    { time: '3 hours ago', text: 'Published monthly portfolio performance report' },
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { backgroundColor: theme.colors.primary + '18' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>VP Property Management</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Real Estate & Property Department</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The VP Property Management AI oversees real estate portfolio strategy, tenant relations, and facilities operations. This agent ensures property value optimization, regulatory compliance, and seamless tenant experiences across all assets.
        </Text>
      </View>
    ...
    <AgentFeatures agentId="vp-property-mgmt" agentName="VP Property Management" />
