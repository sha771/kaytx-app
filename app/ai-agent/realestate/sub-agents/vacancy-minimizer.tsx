...
export default function VacancyMinimizerPage() {
  ...
  const stats = [{label:'Tasks',value:'2,045',icon:CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.8s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.1%',icon:Target,color:'#558B2F'}];
  const capabilities = ['Vacancy Reduction','Downtime Minimization','Marketing Acceleration','Tenant Matching','Incentive Optimization','Turnover Analysis'];
  const responsibilities = ['Vacancy reduction strategy execution','Downtime minimization between tenants','Marketing acceleration for vacant units','Tenant matching & qualification','Incentive optimization for quick lease-up','Turnover analysis & prevention'];
  const activities = [{time:'3 min ago',text:'Reduced average vacancy from 45 to 18 days',icon:CircleCheckBig},{time:'15 min ago',text:'Filled 25 vacant units this quarter',icon:Clock},{time:'30 min ago',text:'Analyzed turnover patterns across 8 properties',icon:Zap}];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Vacancy Minimizer</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>The AI Vacancy Minimizer provides specialized capabilities supporting the AI Leasing Manager within the Real Estate division, delivering automated analysis, tracking, and optimization.</Text></View>
      ...
      <AgentFeatures agentId="vacancy-minimizer" agentName="AI Vacancy Minimizer" />
