...
export default function NoiOptimizerPage() {
  const agent = {
    ...
    description: 'Automated Noi Optimizer agent specializing in realestate operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
