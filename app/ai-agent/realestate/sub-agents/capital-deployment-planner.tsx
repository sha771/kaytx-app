...
export default function CapitalDeploymentPlannerPage() {
  const agent = {
    id: 'capital-deployment-planner',
    name: 'AI Capital Deployment Planner',
    title: 'Realestate Agent',
    description: 'Automated Capital Deployment Planner agent specializing in realestate operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Capital Deployment Planner',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
