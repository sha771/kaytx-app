...
export default function CostEstimatorPage() {
  const agent = {
    ...
    description: 'Automated Cost Estimator agent specializing in realestate operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
