...
export default function ValueEstimatorPage() {
  const agent = {
    ...
    description: 'Automated Value Estimator agent specializing in realestate operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
