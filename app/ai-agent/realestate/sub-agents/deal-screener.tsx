...
export default function DealScreenerPage() {
  const agent = {
    ...
    description: 'Automated Deal Screener agent specializing in realestate operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
