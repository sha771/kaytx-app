...
export default function WorkOrderPrioritizerPage() {
  const agent = {
    id: 'work-order-prioritizer',
    name: 'AI Work Order Prioritizer',
    title: 'Realestate Agent',
    description: 'Automated Work Order Prioritizer agent specializing in realestate operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Work Order Prioritizer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
