...
export default function CommunicationCoordinatorPage() {
  const agent = {
    ...
    description: 'Automated Communication Coordinator agent specializing in realestate operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
