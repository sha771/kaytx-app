...
export default function LeaseAbstractorPage() {
  const agent = {
    ...
    description: 'Automated Lease Abstractor agent specializing in realestate operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
