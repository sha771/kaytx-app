...
export default function TenantQualifierPage() {
  const agent = {
    ...
    description: 'Automated Tenant Qualifier agent specializing in realestate operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
