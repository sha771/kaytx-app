...
import { Building2, Activity, Star, CheckCircle2, Clock, Target, ArrowRight, Zap } from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

export default function AgentPage() {
  const { theme } = useTheme();
  const stats = [{label:'Tasks',value:'3,966',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.6%',icon:Target,color:'#33691E'}];
  ...
  const activities = [{time:'3 min ago',text:'Reviewed development pipeline of $500M',icon:CheckCircle2},{time:'6 min ago',text:'Approved 2 new development projects',icon:Clock},{time:'9 min ago',text:'Managed stakeholder communications',icon:Zap}];
  return (
