  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>Property Marketing</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Property Marketing</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>The Property Marketing AI executes specialized tasks, automates workflows, and delivers consistent high-quality performance within the Real Estate department.</Text></View>
      ...
      <AgentFeatures agentId="property-marketing" agentName="Property Marketing" />
    </ScrollView>
  );
}
