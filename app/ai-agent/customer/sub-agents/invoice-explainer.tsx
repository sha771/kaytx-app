...
import { Activity, ChartBarBig, CircleCheck, Zap, ChevronLeft, ArrowRight, FileText, Receipt } from 'lucide-react-native';
...
const ACCENT = '#007AFF';
const AGENT_NAME = 'AI Invoice Explainer';
const AGENT_TITLE = 'Billing Clarity Engine';
const AGENT_DESC = 'Generates, explains, and breaks down complex invoices with line-item clarity for customers. Translates billing jargon into plain language, pro-rates charges, and answers billing questions with full transparency.';
const PARENT_NAME = 'AI Billing Support';
const PARENT_ROUTE = '/ai-agent/customer-experience/billing-support';

const METRICS = [
  { label: 'Explained Today', value: '1.8k', color: ACCENT },
  { label: 'Clarity Score', value: '98%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.8s', color: '#007AFF' },
  { label: 'Satisfaction', value: '96%', color: '#5856D6' },
];

const RECENT_TASKS = [
  { action: 'Explained prorated charges to enterprise customer #4421', time: '2m ago' },
  { action: 'Generated line-item breakdown for $3,200 quarterly invoice', time: '8m ago' },
  { action: 'Answered 12 billing questions about usage-based pricing', time: '15m ago' },
  { action: 'Translated tax calculations for multi-state customer', time: '25m ago' },
  { action: 'Created visual invoice infographic for visual learners', time: '40m ago' },
  { action: 'Flagged 3 billing discrepancies for review', time: '1h ago' },
];

const CAPABILITIES = [
  'Line-Item Explanation',
  'Plain Language Translation',
  'Pro-Ration Calculation Display',
  'Tax Breakdown Clarification',
  'Usage-Based Pricing Explanations',
  'Discount & Credit Itemization',
  'Multi-Period Invoice Breakdown',
...
const PERFORMANCE_BARS = [
  { label: 'Explanation Clarity', value: 98, color: '#00C853' },
  { label: 'Customer Understanding', value: 96, color: ACCENT },
  { label: 'Response Speed', value: 92, color: '#007AFF' },
  { label: 'Issue Resolution Rate', value: 94, color: '#5856D6' },
  { label: 'Satisfaction Score', value: 96, color: '#FF9500' },
];

const A2A_ENDPOINTS = [
  '/consult/invoice-explainer',
  '/billing/explain-invoice',
  '/billing/breakdown-line-items',
  '/billing/calculate-proration',
  '/billing/clarify-tax',
  '/billing/generate-infographic',
];
