...
export default function InvoiceExplainerPage() {
  const agent = {
    ...
    description: 'Automated Invoice Explainer agent specializing in customer operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
