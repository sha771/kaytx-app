...
export default function TroubleshootingGuidePage() {
  const agent = {
    ...
    description: 'Automated Troubleshooting Guide agent specializing in customer operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Troubleshooting Guide',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
