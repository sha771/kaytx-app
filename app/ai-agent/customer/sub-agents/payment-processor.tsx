...
export default function PaymentProcessorPage() {
  const agent = {
    ...
    description: 'Automated Payment Processor agent specializing in customer operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
