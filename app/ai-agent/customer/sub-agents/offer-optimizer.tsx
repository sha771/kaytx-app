...
export default function OfferOptimizerPage() {
  const agent = {
    ...
    description: 'Automated Offer Optimizer agent specializing in customer operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
