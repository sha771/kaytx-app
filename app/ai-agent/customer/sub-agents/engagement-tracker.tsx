...
import { Activity, ChartBarBig, CircleCheck, Zap, ChevronLeft, ArrowRight, TrendingUp, Eye } from 'lucide-react-native';
...
const ACCENT = '#AF52DE';
const AGENT_NAME = 'AI Engagement Tracker';
const AGENT_TITLE = 'Real-Time Engagement Intelligence';
const AGENT_DESC = 'Monitors real-time engagement metrics across all touchpoints, detects engagement drops, triggers re-engagement campaigns, and provides predictive churn analytics to maximize customer lifetime value.';
const PARENT_NAME = 'AI Loyalty & Engagement';
const PARENT_ROUTE = '/ai-agent/customer-experience/loyalty-engagement';

const METRICS = [
  { label: 'Tracked Today', value: '12.4k', color: ACCENT },
  { label: 'Engage Rate', value: '78%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.12s', color: '#007AFF' },
  { label: 'Churn Saved', value: '340', color: '#5856D6' },
];

const RECENT_TASKS = [
  { action: 'Detected engagement drop for Silver tier segment — triggered re-engagement', time: '1m ago' },
  { action: 'Tracked 2,400 email opens across 3 campaigns', time: '5m ago' },
  { action: 'Predicted churn risk for 18 accounts — flagged for outreach', time: '12m ago' },
  { action: 'Generated weekly engagement heatmap for product team', time: '25m ago' },
  { action: 'Auto-launched win-back push notification for dormant users', time: '40m ago' },
  { action: 'Updated engagement scoring model with latest behavioral data', time: '1h ago' },
];
...
const CAPABILITIES = [
  ...
  'Cross-Channel Engagement Fusion',
];

const PERFORMANCE_BARS = [
  { label: 'Detection Accuracy', value: 96, color: '#00C853' },
  { label: 'Churn Prediction', value: 91, color: ACCENT },
  { label: 'Re-Engagement Success', value: 84, color: '#007AFF' },
  { label: 'Tracking Coverage', value: 99, color: '#5856D6' },
  { label: 'Speed of Insight', value: 97, color: '#FF9500' },
];

const A2A_ENDPOINTS = [
  '/consult/engagement-tracker',
  '/engagement/monitor-realtime',
  '/engagement/detect-drop',
  '/engagement/predict-churn',
  '/engagement/trigger-reengage',
  '/engagement/generate-heatmap',
];
