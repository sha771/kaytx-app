...
export default function EngagementTrackerPage() {
  const agent = {
    ...
    description: 'Automated Engagement Tracker agent specializing in customer operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Engagement Tracker',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
