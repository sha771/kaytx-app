...
import { Activity, ChartBarBig, CircleCheck, Zap, ChevronLeft, ArrowRight, ClipboardList, PenTool } from 'lucide-react-native';
...
const ACCENT = '#5856D6';
const AGENT_NAME = 'AI Survey Designer';
const AGENT_TITLE = 'Intelligent Survey Architecture';
const AGENT_DESC = 'Designs contextual, high-response-rate surveys with smart question logic, adaptive branching, and multi-channel distribution. Optimizes survey length, question phrasing, and timing to maximize completion rates and data quality.';
const PARENT_NAME = 'AI Feedback & Survey';
const PARENT_ROUTE = '/ai-agent/customer-experience/feedback-survey';

const METRICS = [
  { label: 'Surveys Built', value: '1.8k', color: ACCENT },
  { label: 'Avg Response', value: '72%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.3s', color: '#007AFF' },
  { label: 'Quality Score', value: '96%', color: '#5856D6' },
];

const RECENT_TASKS = [
  { action: 'Auto-designed post-purchase NPS survey with 12 questions', time: '3m ago' },
  { action: 'Optimized CSAT survey length — reduced from 15 to 8 questions', time: '10m ago' },
  { action: 'Created adaptive branching logic for product feedback survey', time: '20m ago' },
  { action: 'A/B tested question phrasing for onboarding survey', time: '35m ago' },
  { action: 'Scheduled quarterly employee engagement survey distribution', time: '50m ago' },
  { action: 'Generated survey template library for 5 industry verticals', time: '1h ago' },
];

const CAPABILITIES = [
  'Contextual Survey Generation',
  'Adaptive Question Branching',
  'Response Rate Optimization',
  'Multi-Channel Distribution',
  'Question Phrasing A/B Testing',
...
const PERFORMANCE_BARS = [
  { label: 'Response Rate Optimization', value: 89, color: '#00C853' },
  { label: 'Question Quality Score', value: 96, color: ACCENT },
  { label: 'Completion Rate', value: 82, color: '#007AFF' },
  { label: 'Design Speed', value: 94, color: '#5856D6' },
  { label: 'Data Quality Index', value: 93, color: '#FF9500' },
];

const A2A_ENDPOINTS = [
  '/consult/survey-designer',
  '/survey/design-contextual',
  '/survey/optimize-length',
  '/survey/create-branching',
  '/survey/distribute-multi-channel',
  '/survey/ab-test-phrasing',
];
