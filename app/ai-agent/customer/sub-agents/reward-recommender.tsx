...
import { Activity, ChartBarBig, CircleCheck, Zap, ChevronLeft, ArrowRight, Gift, Sparkles } from 'lucide-react-native';
...
const ACCENT = '#AF52DE';
const AGENT_NAME = 'AI Reward Recommender';
const AGENT_TITLE = 'Personalized Rewards Intelligence';
const AGENT_DESC = 'Recommends personalized rewards based on customer behavior, purchase history, tier status, and preference profiles. Optimizes reward ROI while maximizing customer delight and retention.';
const PARENT_NAME = 'AI Loyalty & Engagement';
const PARENT_ROUTE = '/ai-agent/customer-experience/loyalty-engagement';

const METRICS = [
  { label: 'Recs Today', value: '4.2k', color: ACCENT },
  { label: 'Accept Rate', value: '87%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.15s', color: '#007AFF' },
  { label: 'ROI Lift', value: '+34%', color: '#5856D6' },
];

const RECENT_TASKS = [
  { action: 'Recommended premium dining reward for Gold tier member', time: '2m ago' },
  { action: 'Personalized travel reward for high-value customer segment', time: '8m ago' },
  { action: 'Optimized reward catalog based on Q3 redemption data', time: '15m ago' },
  { action: 'Triggered surprise milestone reward for 5-year loyalty', time: '25m ago' },
  { action: 'A/B tested reward presentation for mobile vs email', time: '40m ago' },
  { action: 'Generated reward performance report for stakeholders', time: '1h ago' },
];

const CAPABILITIES = [
  'Behavioral Reward Matching',
  'Tier-Based Recommendation Logic',
  'Preference Profile Analysis',
  'Reward ROI Optimization',
  'Surprise & Delight Triggers',
  'Cross-Sell Reward Pairing',
  'Seasonal Catalog Curation',
  'A/B Reward Presentation Testing',
  'Redemption Prediction Engine',
  'Customer Delight Scoring',
];

const PERFORMANCE_BARS = [
  { label: 'Recommendation Accuracy', value: 91, color: '#00C853' },
  { label: 'Acceptance Rate', value: 87, color: ACCENT },
  { label: 'ROI Optimization', value: 89, color: '#007AFF' },
  { label: 'Personalization Depth', value: 93, color: '#5856D6' },
  { label: 'Customer Delight Score', value: 95, color: '#FF9500' },
];

const A2A_ENDPOINTS = [
  '/consult/reward-recommender',
  '/rewards/recommend-personalized',
  '/rewards/optimize-catalog',
  '/rewards/trigger-milestone',
  '/rewards/analyze-redemption',
  '/rewards/ab-test-presentation',
];
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.section, { backgroundColor: colors.card }]}>
          ...
          <TouchableOpacity onPress={() => router.push(PARENT_ROUTE)} style={[styles.parentCard, { backgroundColor: colors.background }]}>
            ...
            <View style={styles.parentInfo}>
              ...
              <Text style={[styles.parentDesc, { color: colors.text + '70' }]}>Main Agent</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  parentCard: { flexDirection: 'row', alignItems: 'center', padding: 16, borderRadius: 14, gap: 12 },
  parentIcon: { width: 44, height: 44, borderRadius: 12, justifyContent: 'center', alignItems: 'center' },
  parentInfo: { flex: 1 },
