...
import { Activity, ChartBarBig, CircleCheck, Zap, ChevronLeft, ArrowRight, BarChart3, MessageSquare } from 'lucide-react-native';
...
const ACCENT = '#5856D6';
const AGENT_NAME = 'AI Response Analyzer';
const AGENT_TITLE = 'NLP Response Intelligence';
const AGENT_DESC = 'Analyzes open-text survey responses with advanced NLP, categorizes sentiment, identifies emerging patterns, and surfaces actionable themes from customer feedback across all channels.';
const PARENT_NAME = 'AI Feedback & Survey';
const PARENT_ROUTE = '/ai-agent/customer-experience/feedback-survey';

const METRICS = [
  { label: 'Analyzed Today', value: '6.2k', color: ACCENT },
  { label: 'Categorization', value: '97.3%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.18s', color: '#007AFF' },
  { label: 'Theme Accuracy', value: '95%', color: '#5856D6' },
];

const RECENT_TASKS = [
  { action: 'Categorized 120 NPS comments into 8 sentiment clusters', time: '1m ago' },
  { action: 'Detected emerging pricing complaint trend in Q4 responses', time: '5m ago' },
  { action: 'Auto-tagged 340 feedback entries with 12 topic labels', time: '12m ago' },
  { action: 'Identified 3 new product friction points from open-text analysis', time: '20m ago' },
  { action: 'Cross-referenced survey sentiment with support ticket data', time: '35m ago' },
  { action: 'Generated sentiment distribution report for executive review', time: '1h ago' },
];

const CAPABILITIES = [
  'NLP Sentiment Categorization',
  'Open-Text Theme Extraction',
  'Emerging Trend Detection',
  'Multi-Language Response Analysis',
  'Auto-Tagging & Classification',
  'Sentiment Shift Tracking',
  'Cross-Channel Response Fusion',
...
const PERFORMANCE_BARS = [
  { label: 'Categorization Accuracy', value: 97, color: '#00C853' },
  { label: 'Theme Detection', value: 93, color: ACCENT },
  { label: 'Sentiment Precision', value: 95, color: '#007AFF' },
  { label: 'Processing Speed', value: 98, color: '#5856D6' },
  { label: 'Trend Detection Rate', value: 89, color: '#FF9500' },
];

const A2A_ENDPOINTS = [
  '/consult/response-analyzer',
  '/feedback/analyze-responses',
  '/feedback/categorize-sentiment',
  '/feedback/detect-trends',
  '/feedback/extract-themes',
  '/feedback/cross-channel-fusion',
];
