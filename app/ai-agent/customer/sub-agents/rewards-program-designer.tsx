...
export default function RewardsProgramDesignerPage() {
  const agent = {
    id: 'rewards-program-designer',
    name: 'AI Rewards Program Designer',
    title: 'Customer Agent',
    description: 'Automated Rewards Program Designer agent specializing in customer operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Rewards Program Designer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
