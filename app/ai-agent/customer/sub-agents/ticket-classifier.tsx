...
export default function TicketClassifierPage() {
  const agent = {
    ...
    description: 'Automated Ticket Classifier agent specializing in customer operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Ticket Classifier',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
