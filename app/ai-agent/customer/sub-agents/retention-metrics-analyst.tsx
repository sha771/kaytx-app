...
export default function RetentionMetricsAnalystPage() {
  const agent = {
    id: 'retention-metrics-analyst',
    name: 'AI Retention Metrics Analyst',
    title: 'Customer Agent',
    description: 'Automated Retention Metrics Analyst agent specializing in customer operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Retention Metrics Analyst',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
