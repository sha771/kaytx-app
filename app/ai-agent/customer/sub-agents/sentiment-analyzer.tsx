...
export default function SentimentAnalyzerPage() {
  const agent = {
    ...
    description: 'Automated Sentiment Analyzer agent specializing in customer operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Sentiment Analyzer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
