...
export default function PersonalizationEnginePage() {
  const agent = {
    ...
    description: 'Automated Personalization Engine agent specializing in customer operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Personalization Engine',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
