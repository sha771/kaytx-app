...
export default function AtRiskIdentifierPage() {
  const agent = {
    ...
    description: 'Automated At Risk Identifier agent specializing in customer operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
