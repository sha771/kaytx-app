...
import { Headphones, Activity, CheckCircle2, Clock, Target, BarChart3, MessageSquare, Calendar, Shield, ArrowRight, Users, Zap, Star, TrendingUp, Heart } from 'lucide-react-native';
...
export default function VPCustomerSuccessPage() {
  ...
  const stats = [
    { label: 'Tasks Done', value: '18,742', icon: CheckCircle2, color: '#34C759' },
    { label: 'Uptime', value: '99.95%', icon: Activity, color: '#007AFF' },
    { label: 'Response', value: '1.1s', icon: Clock, color: '#FF9500' },
    { label: 'Accuracy', value: '98.8%', icon: Target, color: '#AF52DE' },
  ];

  const capabilities = [
    'Success Strategy', 'Health Scoring', 'Onboarding Design', 'Expansion Revenue',
    'Adoption Tracking', 'QBR Automation', 'Playbook Builder', 'Risk Alerts'
  ];

  const responsibilities = [
    'Customer Success Strategy & Playbooks',
    'Customer Health Scoring & Risk Management',
    'Onboarding & Adoption Program Design',
  ...
  const activities = [
    ...
    { time: '1 hour ago', text: 'Completed 45 health score updates', icon: BarChart3 },
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { backgroundColor: theme.colors.primary + '18' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: theme.colors.primary + '25' }]}>
          <Headphones size={48} color={theme.colors.primary} />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>VP Customer Success</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Customer Experience Department</Text>
        <View style={styles.badgesRow}>
          ...
          <View style={[styles.badge, { backgroundColor: '#FF950022' }]}>
            ...
            <Text style={[styles.badgeText, { color: '#FF9500' }]}>8 Reports</Text>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The VP Customer Success AI drives customer success initiatives, ensures clients achieve desired outcomes, and maximizes lifetime value through proactive engagement, health scoring, and expansion programs.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="vp-customer-success" agentName="VP Customer Success" />
    </ScrollView>
  );
}
