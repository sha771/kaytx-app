...
export default function AgentPage() {
  const agent = {
    ...
    description: 'The feedback-survey AI provides specialized services and automation within its department.',
