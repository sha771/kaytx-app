...
const INSIGHTS_GENERATED_DATA = {
  labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
  datasets: [
    {
      data: [120, 145, 138, 165, 152, 85, 92],
    },
  ],
};

const ANALYSIS_TYPE_DATA = [
  {
    name: 'Predictive',
    population: 35,
    color: '#10B981',
...
const DATA_VOLUME_DATA = {
  labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
  datasets: [
    {
      data: [450, 520, 580, 650, 720, 810],
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.chartsSection}>
        {renderLineChart(PERFORMANCE_TREND_DATA, 'Performance Trend (6 Months)', '#10B981')}
        {renderBarChart(INSIGHTS_GENERATED_DATA, 'Insights Generated (Weekly)')}
        {renderPieChart(ANALYSIS_TYPE_DATA, 'Analysis Type Distribution')}
        {renderLineChart(MODEL_ACCURACY_DATA, 'Model Accuracy (Quarterly)', '#10B981')}
        {renderLineChart(DATA_VOLUME_DATA, 'Data Volume (6 Months)', '#3B82F6')}
        {renderPieChart(PREDICTION_ACCURACY_DATA, 'Prediction Accuracy')}
      </View>
