...
const ACCENT = '#2E7D32';
const AGENT_NAME = 'AI Sales Data Analyst';
const AGENT_TITLE = 'Sales Intelligence AI';
const AGENT_DESC = 'Transforms sales data into actionable insights, forecasts, and performance recommendations.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '67', color: ACCENT },
  { label: 'Success Rate', value: '94%', color: '#00C853' },
  { label: 'Avg Speed', value: '2.0s', color: '#007AFF' },
  { label: 'Accuracy', value: '94.6%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Built Q3 sales performance dashboard",
        "time": "10m ago"
    },
    {
        "action": "Identified top 5 revenue drivers",
        "time": "30m ago"
    },
    {
        "action": "Forecasted Q4 pipeline accuracy",
        "time": "1h ago"
    },
    {
        "action": "Analyzed win/loss by segment",
        "time": "2h ago"
    },
    {
        "action": "Generated rep leaderboard report",
        "time": "3h ago"
    }
];
