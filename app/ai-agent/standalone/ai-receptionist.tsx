...
const ACCENT = '#00ACC1';
const AGENT_NAME = 'AI Receptionist';
const AGENT_TITLE = 'Virtual Receptionist AI';
const AGENT_DESC = 'Handles inbound calls, routes inquiries, schedules appointments, and greets visitors professionally.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '189', color: ACCENT },
  { label: 'Success Rate', value: '96%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.3s', color: '#007AFF' },
  { label: 'Accuracy', value: '96.4%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Answered 45 inbound calls",
        "time": "1m ago"
    },
    {
        "action": "Scheduled 12 appointments",
        "time": "10m ago"
    },
    {
        "action": "Routed 8 calls to departments",
        "time": "20m ago"
    },
    {
        "action": "Handled visitor check-in",
        "time": "30m ago"
    },
    {
        "action": "Sent meeting confirmations",
        "time": "45m ago"
    }
];
