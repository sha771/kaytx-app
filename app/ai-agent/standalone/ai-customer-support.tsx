...
const ACCENT = '#26A69A';
const AGENT_NAME = 'AI Customer Support';
const AGENT_TITLE = 'Customer Support AI';
const AGENT_DESC = 'Resolves customer inquiries instantly across channels with human-quality empathy and accuracy.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '456', color: ACCENT },
  { label: 'Success Rate', value: '94%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.5s', color: '#007AFF' },
  { label: 'Accuracy', value: '94.3%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Resolved 45 chat inquiries",
        "time": "1m ago"
    },
    {
        "action": "Escalated 3 complex tickets",
        "time": "5m ago"
    },
    {
        "action": "Sent 12 proactive follow-ups",
        "time": "15m ago"
    },
    {
        "action": "Updated knowledge base with FAQ",
        "time": "30m ago"
    },
    {
        "action": "Handled billing dispute for client",
        "time": "45m ago"
    }
];
