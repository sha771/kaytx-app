...
const ACCENT = '#00BCD4';
const AGENT_NAME = 'AI CRM Assistant';
const AGENT_TITLE = 'CRM Automation AI';
const AGENT_DESC = 'Keeps CRM data clean, enriches records, and automates data entry so sales teams focus on selling.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '312', color: ACCENT },
  { label: 'Success Rate', value: '97%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.3s', color: '#007AFF' },
  { label: 'Accuracy', value: '97.8%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Enriched 45 contact records",
        "time": "2m ago"
    },
    {
        "action": "Deduplicated 12 accounts",
        "time": "10m ago"
    },
    {
        "action": "Auto-logged 28 email activities",
        "time": "20m ago"
    },
    {
        "action": "Updated 5 deal stages",
        "time": "35m ago"
    },
    {
        "action": "Synced LinkedIn data to CRM",
        "time": "1h ago"
    }
];
