...
const ACCENT = '#AB47BC';
const AGENT_NAME = 'AI Marketer';
const AGENT_TITLE = 'Digital Marketing AI';
const AGENT_DESC = 'Executes multi-channel marketing campaigns, creates content, and optimizes for growth.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '90.9%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Scheduled 8 social media posts",
        "time": "5m ago"
    },
    {
        "action": "Wrote 3 blog post outlines",
        "time": "20m ago"
    },
    {
        "action": "Launched email nurture sequence",
        "time": "40m ago"
    },
    {
        "action": "Optimized landing page copy",
        "time": "1h ago"
    },
    {
        "action": "Generated weekly marketing report",
        "time": "2h ago"
    }
];
