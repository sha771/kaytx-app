...
const ACCENT = '#1976D2';
const AGENT_NAME = 'AI Proposal Generator';
const AGENT_TITLE = 'Sales Proposal AI';
const AGENT_DESC = 'Creates compelling, personalized sales proposals and RFP responses that close deals faster.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '34', color: ACCENT },
  { label: 'Success Rate', value: '91%', color: '#00C853' },
  { label: 'Avg Speed', value: '3.5s', color: '#007AFF' },
  { label: 'Accuracy', value: '91.8%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Generated proposal for Acme Corp",
        "time": "5m ago"
    },
    {
        "action": "Responded to RFP from TechCo",
        "time": "25m ago"
    },
    {
        "action": "Personalized deck for enterprise deal",
        "time": "45m ago"
    },
    {
        "action": "Created ROI calculator for client",
        "time": "1h ago"
    },
    {
        "action": "Drafted SOW for new project",
        "time": "2h ago"
    }
];
