...
const ACCENT = '#039BE5';
const AGENT_NAME = 'AI Retention Specialist';
const AGENT_TITLE = 'Customer Retention AI';
const AGENT_DESC = 'Predicts churn risk, deploys retention interventions, and drives net revenue retention.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '56', color: ACCENT },
  { label: 'Success Rate', value: '90%', color: '#00C853' },
  { label: 'Avg Speed', value: '1.8s', color: '#007AFF' },
  { label: 'Accuracy', value: '91.3%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Identified 5 high-churn risk accounts",
        "time": "8m ago"
    },
    {
        "action": "Triggered save campaign for at-risk customer",
        "time": "25m ago"
    },
    {
        "action": "Generated NRR report for Q3",
        "time": "45m ago"
    },
    {
        "action": "Analyzed cancel survey responses",
        "time": "1h ago"
    },
    {
        "action": "Created win-back email sequence",
        "time": "2h ago"
    }
];
