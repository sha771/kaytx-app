...
import { Activity, ChartBarBig, CircleCheck, Zap, ChevronLeft } from 'lucide-react-native';
...
const ACCENT = '#F44336';
const AGENT_NAME = 'AI Negotiator';
const AGENT_TITLE = 'Autonomous Negotiation AI';
const AGENT_DESC = 'Conducts real-time negotiations autonomously within defined parameters to close favorable deals.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '12', color: ACCENT },
  { label: 'Success Rate', value: '87%', color: '#00C853' },
  { label: 'Avg Speed', value: '3.0s', color: '#007AFF' },
  { label: 'Accuracy', value: '88.4%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Negotiated vendor renewal — saved 15%",
        "time": "15m ago"
    },
    {
        "action": "Counter-offered on SaaS contract",
        "time": "45m ago"
    },
    {
        "action": "Reached agreement on SLA terms",
        "time": "1h ago"
    },
    {
        "action": "Escalated deal above authority",
        "time": "2h ago"
    },
    {
        "action": "Completed procurement negotiation",
        "time": "3h ago"
    }
];
