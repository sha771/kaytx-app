...
const ACCENT = '#F06292';
const AGENT_NAME = 'AI Social Media Manager';
const AGENT_TITLE = 'Social Content AI';
const AGENT_DESC = 'Creates, schedules, and analyzes social content across all platforms to grow brand presence.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '92.7%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Scheduled 12 posts across platforms",
        "time": "5m ago"
    },
    {
        "action": "Generated 5 viral thread concepts",
        "time": "20m ago"
    },
    {
        "action": "Replied to 34 comments",
        "time": "40m ago"
    },
    {
        "action": "Analyzed top performing content",
        "time": "1h ago"
    },
    {
