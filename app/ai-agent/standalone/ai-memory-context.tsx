...
const ACCENT = '#78909C';
const AGENT_NAME = 'AI Memory Context';
const AGENT_TITLE = 'Persistent Memory AI';
const AGENT_DESC = 'Maintains long-term context and memory across all agent interactions for consistent personalization.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '1204', color: ACCENT },
  { label: 'Success Rate', value: '99%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.05s', color: '#007AFF' },
  { label: 'Accuracy', value: '99.9%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Stored context from sales call",
        "time": "1m ago"
    },
    {
        "action": "Retrieved user preference for report format",
        "time": "3m ago"
    },
    {
        "action": "Updated contact relationship map",
        "time": "8m ago"
    },
    {
        "action": "Synced memory across 5 agents",
        "time": "15m ago"
    },
    {
        "action": "Compressed 30-day interaction log",
        "time": "30m ago"
    }
];
