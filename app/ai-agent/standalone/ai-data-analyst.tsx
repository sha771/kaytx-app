...
const AGENT_DESC = 'Transforms raw data into actionable insights, dashboards, and predictive forecasts automatically.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '95.7%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Analyzed Q3 revenue breakdown",
        "time": "8m ago"
    },
    {
        "action": "Built cohort retention analysis",
        "time": "25m ago"
    },
    {
        "action": "Flagged anomaly in conversion data",
        "time": "45m ago"
    },
    {
        "action": "Created executive dashboard",
        "time": "1h ago"
    },
    {
        "action": "Ran predictive churn model",
        "time": "2h ago"
    }
];
