...
const ACCENT = '#9C27B0';
const AGENT_NAME = 'AI Competitive Analyst';
const AGENT_TITLE = 'Market Intelligence AI';
const AGENT_DESC = 'Tracks competitors, analyzes market shifts, and provides real-time battlecards and positioning insights.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '92.9%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Updated competitor battlecards",
        "time": "8m ago"
    },
    {
        "action": "Tracked Salesforce product launch",
        "time": "25m ago"
    },
    {
        "action": "Analyzed pricing page changes",
        "time": "45m ago"
    },
    {
        "action": "Generated win/loss analysis",
        "time": "1h ago"
    },
    {
        "action": "Monitored 12 competitor mentions",
        "time": "2h ago"
    }
];
