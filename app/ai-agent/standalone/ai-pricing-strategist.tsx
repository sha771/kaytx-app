...
const ACCENT = '#00897B';
const AGENT_NAME = 'AI Pricing Strategist';
const AGENT_TITLE = 'Dynamic Pricing AI';
const AGENT_DESC = 'Analyzes market conditions, competitor pricing, and elasticity to optimize pricing for maximum revenue.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '92.6%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Analyzed competitor pricing changes",
        "time": "8m ago"
    },
    {
        "action": "Recommended 8% price increase for Pro",
        "time": "25m ago"
    },
    {
        "action": "Built price elasticity model",
        "time": "50m ago"
    },
    {
        "action": "Simulated discount impact on margin",
        "time": "1h ago"
    },
    {
        "action": "Updated pricing tier recommendations",
        "time": "2h ago"
    }
];
