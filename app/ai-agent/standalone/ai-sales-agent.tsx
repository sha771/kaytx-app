...
const AGENT_TITLE = 'Autonomous Sales AI';
const AGENT_DESC = 'Prospects, qualifies, pitches, and closes deals autonomously within your defined sales process.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '145', color: ACCENT },
  { label: 'Success Rate', value: '87%', color: '#00C853' },
  { label: 'Avg Speed', value: '1.0s', color: '#007AFF' },
  { label: 'Accuracy', value: '88.2%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Sent 50 personalized outreach emails",
        "time": "2m ago"
    },
    {
    ...
    {
        "action": "Moved 5 deals to proposal stage",
        "time": "30m ago"
    },
    {
        "action": "Closed $24K SMB deal autonomously",
        "time": "1h ago"
    },
    {
        "action": "Scheduled 8 discovery calls",
        "time": "2h ago"
    }
];
