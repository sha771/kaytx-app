...
const ACCENT = '#FF6D00';
const AGENT_NAME = 'AI Campaign Optimizer';
const AGENT_TITLE = 'Marketing Campaign AI';
const AGENT_DESC = 'Optimizes ad campaigns across channels in real-time, maximizing ROAS and conversion efficiency.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '234', color: ACCENT },
  { label: 'Success Rate', value: '91%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.8s', color: '#007AFF' },
  { label: 'Accuracy', value: '92.1%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Reallocated $5K budget to top ad",
        "time": "3m ago"
    },
    {
        "action": "Paused 3 underperforming creatives",
        "time": "12m ago"
    },
    {
        "action": "A/B tested 2 ad headlines",
        "time": "30m ago"
    },
    {
        "action": "Generated campaign performance report",
        "time": "1h ago"
    },
    {
        "action": "Updated keyword bids for Google",
        "time": "2h ago"
    }
];
