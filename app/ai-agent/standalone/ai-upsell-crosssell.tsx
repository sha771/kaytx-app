...
const AGENT_DESC = 'Identifies upsell and cross-sell opportunities across the customer base to expand revenue automatically.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '78', color: ACCENT },
  { label: 'Success Rate', value: '88%', color: '#00C853' },
  { label: 'Avg Speed', value: '1.5s', color: '#007AFF' },
  { label: 'Accuracy', value: '89.4%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Identified 12 upsell opportunities",
        "time": "8m ago"
    },
    {
        "action": "Triggered cross-sell for Acme Corp",
        "time": "25m ago"
    },
    {
        "action": "Generated expansion playbook",
        "time": "45m ago"
    },
    {
        "action": "Tracked $45K expansion pipeline",
        "time": "1h ago"
    },
    {
        "action": "Sent personalized upgrade offers",
        "time": "2h ago"
    }
];
