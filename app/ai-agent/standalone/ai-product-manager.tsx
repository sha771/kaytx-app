...
const ACCENT = '#5E35B1';
const AGENT_NAME = 'AI Product Manager';
const AGENT_TITLE = 'Product Intelligence AI';
const AGENT_DESC = 'Manages product lifecycle from discovery to launch with data-driven prioritization and roadmapping.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '28', color: ACCENT },
  { label: 'Success Rate', value: '92%', color: '#00C853' },
  { label: 'Avg Speed', value: '2.2s', color: '#007AFF' },
  { label: 'Accuracy', value: '92.3%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Updated product roadmap Q4",
        "time": "10m ago"
    },
    {
        "action": "Prioritized 8 backlog items by RICE",
        "time": "30m ago"
    },
    {
        "action": "Created PRD for auth redesign",
        "time": "1h ago"
    },
    {
        "action": "Defined success metrics for feature",
        "time": "2h ago"
    },
    {
        "action": "Ran product review with engineering",
        "time": "3h ago"
    }
];
