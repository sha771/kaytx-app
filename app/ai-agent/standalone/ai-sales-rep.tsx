...
const ACCENT = '#558B2F';
const AGENT_NAME = 'AI Sales Rep';
const AGENT_TITLE = 'Outbound Sales AI';
const AGENT_DESC = 'Executes high-volume outbound prospecting, personalized outreach, and meeting generation at scale.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '200', color: ACCENT },
  { label: 'Success Rate', value: '88%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.8s', color: '#007AFF' },
  { label: 'Accuracy', value: '89.1%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Sent 100 personalized sequences",
        "time": "2m ago"
    },
    {
        "action": "Booked 8 qualified meetings",
        "time": "15m ago"
    },
    {
        "action": "Researched 20 target accounts",
        "time": "30m ago"
    },
    {
        "action": "Updated sequences in Outreach",
        "time": "45m ago"
    },
    {
        "action": "Tracked reply rates across campaigns",
        "time": "1h ago"
    }
];
