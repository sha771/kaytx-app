...
const ACCENT = '#4CAF50';
const AGENT_NAME = 'AI Lead Dev Rep';
const AGENT_TITLE = 'Lead Development AI';
const AGENT_DESC = 'Qualifies inbound leads, enriches prospect data, and books meetings for sales reps automatically.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '123', color: ACCENT },
  { label: 'Success Rate', value: '88%', color: '#00C853' },
  { label: 'Avg Speed', value: '1.0s', color: '#007AFF' },
  { label: 'Accuracy', value: '89.2%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Qualified 28 inbound leads",
        "time": "3m ago"
    },
    {
        "action": "Booked 5 enterprise demos",
        "time": "18m ago"
    },
    {
        "action": "Enriched 34 prospect profiles",
        "time": "35m ago"
    },
    {
        "action": "Sent personalized outreach to 20 leads",
        "time": "1h ago"
    },
    {
        "action": "Scored leads by ICP fit",
        "time": "2h ago"
    }
];
