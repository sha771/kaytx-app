...
const ACCENT = '#EF5350';
const AGENT_NAME = 'AI Negotiation Specialist';
const AGENT_TITLE = 'Deal Negotiation AI';
const AGENT_DESC = 'Optimizes deal terms, coaches negotiation strategy, and helps close deals at best possible terms.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '23', color: ACCENT },
  { label: 'Success Rate', value: '89%', color: '#00C853' },
  { label: 'Avg Speed', value: '2.5s', color: '#007AFF' },
  { label: 'Accuracy', value: '90.1%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Analyzed 3 contract redlines",
        "time": "10m ago"
    },
    {
        "action": "Suggested counter-offer strategy",
        "time": "30m ago"
    },
    {
        "action": "Prepared negotiation brief",
        "time": "1h ago"
    },
    {
        "action": "Coached rep on pricing objection",
        "time": "2h ago"
    },
    {
        "action": "Saved $28K in procurement deal",
        "time": "3h ago"
    }
];
