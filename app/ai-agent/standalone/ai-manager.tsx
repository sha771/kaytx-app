...
const ACCENT = '#FF7043';
const AGENT_NAME = 'AI Manager';
const AGENT_TITLE = 'Team Management AI';
const AGENT_DESC = 'Coordinates team tasks, tracks OKRs, manages project timelines, and removes blockers.';
...
const RECENT_TASKS = [
    {
        "action": "Assigned 12 tasks across team",
        "time": "5m ago"
    },
    {
    ...
    {
        "action": "Identified 2 critical blockers",
        "time": "35m ago"
    },
    {
        "action": "Generated team productivity report",
        "time": "1h ago"
    },
    {
        "action": "Ran standup summary digest",
        "time": "2h ago"
    }
];
