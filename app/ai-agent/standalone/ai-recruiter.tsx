...
const ACCENT = '#43A047';
const AGENT_NAME = 'AI Recruiter';
const AGENT_TITLE = 'Standalone Recruiting AI';
const AGENT_DESC = 'Autonomously sources, screens, and pipelines top talent for any role at scale.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '93.8%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Sourced 30 senior engineers",
        "time": "3m ago"
    },
    {
        "action": "Screened 45 resumes by JD match",
        "time": "15m ago"
    },
    {
        "action": "Sent outreach to 20 passives",
        "time": "30m ago"
    },
    {
        "action": "Scheduled 8 phone screens",
        "time": "1h ago"
    },
    {
        "action": "Updated candidate pipeline in ATS",
        "time": "2h ago"
    }
];
