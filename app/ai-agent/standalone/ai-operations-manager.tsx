...
const ACCENT = '#FF8F00';
const AGENT_NAME = 'AI Operations Manager';
const AGENT_TITLE = 'Operations Coordination AI';
const AGENT_DESC = 'Manages day-to-day operational workflows, vendor coordination, and cross-functional execution.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '93.7%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Coordinated 5 cross-team workflows",
        "time": "5m ago"
    },
    {
        "action": "Resolved supply chain delay",
        "time": "20m ago"
    },
    {
        "action": "Updated SOP documentation",
        "time": "40m ago"
    },
    {
        "action": "Managed vendor onboarding",
        "time": "1h ago"
    },
    {
        "action": "Generated operations status report",
        "time": "2h ago"
    }
];
