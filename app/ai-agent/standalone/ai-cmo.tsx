...
const ACCENT = '#E91E63';
const AGENT_NAME = 'AI CMO';
const AGENT_TITLE = 'Chief Marketing Officer AI';
const AGENT_DESC = 'Drives marketing strategy, brand vision, and growth at CMO level with AI precision.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '18', color: ACCENT },
  { label: 'Success Rate', value: '93%', color: '#00C853' },
  { label: 'Avg Speed', value: '3.0s', color: '#007AFF' },
  { label: 'Accuracy', value: '93.5%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Defined Q4 marketing strategy",
        "time": "10m ago"
    },
    {
        "action": "Approved brand campaign brief",
        "time": "35m ago"
    },
    {
        "action": "Reviewed MQL funnel performance",
        "time": "1h ago"
    },
    {
        "action": "Competitive positioning analysis",
        "time": "2h ago"
    },
    {
        "action": "Presented marketing ROI to board",
        "time": "3h ago"
    }
];
