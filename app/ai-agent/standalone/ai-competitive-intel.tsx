...
const ACCENT = '#673AB7';
const AGENT_NAME = 'AI Competitive Intel';
const AGENT_TITLE = 'Competitive Intelligence AI';
const AGENT_DESC = 'Gathers and synthesizes competitive intelligence from news, reviews, job boards, and social signals.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '91.2%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Scanned 500 reviews on G2/Capterra",
        "time": "5m ago"
    },
    {
        "action": "Detected competitor job posting surge",
        "time": "20m ago"
    },
    {
        "action": "Tracked product roadmap signals",
        "time": "40m ago"
    },
    {
        "action": "Generated intel brief for sales",
        "time": "1h ago"
    },
    {
        "action": "Monitored 8 competitor LinkedIn pages",
        "time": "2h ago"
    }
];
