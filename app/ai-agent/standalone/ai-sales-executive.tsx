...
const ACCENT = '#1B5E20';
const AGENT_NAME = 'AI Sales Executive';
const AGENT_TITLE = 'Enterprise Sales AI';
const AGENT_DESC = 'Manages complex enterprise sales cycles, builds executive relationships, and drives strategic deals.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '23', color: ACCENT },
  { label: 'Success Rate', value: '89%', color: '#00C853' },
  { label: 'Avg Speed', value: '3.0s', color: '#007AFF' },
  { label: 'Accuracy', value: '89.7%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Managed Fortune 500 deal at $500K",
        "time": "15m ago"
    },
    {
        "action": "Prepared executive briefing doc",
        "time": "45m ago"
    },
    {
        "action": "Coordinated multi-stakeholder demo",
        "time": "1h ago"
    },
    {
        "action": "Navigated procurement negotiation",
        "time": "2h ago"
    },
    {
        "action": "Created champion enablement kit",
        "time": "3h ago"
    }
];
