...
const ACCENT = '#007AFF';
const AGENT_NAME = 'AI Account Manager';
const AGENT_TITLE = 'Account Management AI';
const AGENT_DESC = 'Manages client accounts, tracks health scores, and drives retention and expansion revenue.';
const PARENT_NAME = 'Standalone Agents';

const METRICS = [
  { label: 'Tasks Today', value: '45', color: ACCENT },
  { label: 'Success Rate', value: '94%', color: '#00C853' },
  { label: 'Avg Speed', value: '1.5s', color: '#007AFF' },
  { label: 'Accuracy', value: '94.8%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Reviewed 8 client health scores",
        "time": "5m ago"
    },
    {
        "action": "Sent renewal reminder to Acme Corp",
        "time": "20m ago"
    },
    {
        "action": "Created QBR presentation",
        "time": "45m ago"
    },
    {
        "action": "Flagged 3 at-risk accounts",
        "time": "1h ago"
    },
    {
        "action": "Updated CRM with account notes",
        "time": "2h ago"
    }
];
