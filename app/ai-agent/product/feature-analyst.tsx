...
const ACCENT = '#7C3AED';
const AGENT_NAME = 'AI Feature Analyst';
const AGENT_TITLE = 'Feature Intelligence AI';
const AGENT_DESC = 'Analyzes feature requests, scores impact using RICE, and provides data-driven prioritization.';
const PARENT_NAME = 'Product & R&D AI';
...
const RECENT_TASKS = [
    {
        "action": "Analyzed 15 feature requests",
        "time": "8m ago"
    },
    {
        "action": "Scored features by RICE model",
        "time": "25m ago"
    },
    {
        "action": "Identified top user-requested feature",
        "time": "45m ago"
    },
    {
        "action": "Built impact vs effort matrix",
        "time": "1h ago"
    },
    {
        "action": "Feature spec completed for v3.2",
        "time": "2h ago"
    }
];
