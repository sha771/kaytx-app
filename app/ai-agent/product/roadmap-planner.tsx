...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'209',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.1s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.8%',icon:Target,color:'#6A1B9A'}];
  const capabilities = ['Roadmap Creation','Feature Prioritization','Strategic Alignment'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Roadmap Planner</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Creates and manages product roadmaps, prioritizes features, and aligns with strategy.</Text></View>
      ...
      <AgentFeatures agentId="roadmap-planner" agentName="AI Roadmap Planner" />
    </ScrollView>
  );
}
