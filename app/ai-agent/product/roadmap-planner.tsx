...
const ACCENT = '#8B5CF6';
const AGENT_NAME = 'AI Roadmap Planner';
const AGENT_TITLE = 'Product Roadmap AI';
const AGENT_DESC = 'Builds and maintains product roadmaps aligned with user needs, business goals, and engineering capacity.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '93.4%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Updated Q4 product roadmap",
        "time": "10m ago"
    },
    {
        "action": "Prioritized 12 backlog items",
        "time": "30m ago"
    },
    {
        "action": "Aligned roadmap with OKRs",
        "time": "1h ago"
    },
    {
        "action": "Created feature dependency map",
        "time": "2h ago"
    },
    {
        "action": "Roadmap review with stakeholders",
        "time": "3h ago"
    }
];
