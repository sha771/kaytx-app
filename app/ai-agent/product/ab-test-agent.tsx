...
const ACCENT = '#5B21B6';
const AGENT_NAME = 'AI A/B Test Agent';
const AGENT_TITLE = 'Experimentation AI';
const AGENT_DESC = 'Designs, runs, and analyzes A/B tests to optimize conversion rates and user experience.';
const PARENT_NAME = 'Product & R&D AI';

const METRICS = [
  { label: 'Tasks Today', value: '8', color: ACCENT },
...
const RECENT_TASKS = [
    {
        "action": "Launched A/B test for CTA button",
        "time": "20m ago"
    },
    {
        "action": "Declared variant B winner p<0.05",
        "time": "1h ago"
    },
    {
        "action": "Designed multivariate test plan",
        "time": "2h ago"
    },
    {
        "action": "Calculated statistical significance",
        "time": "3h ago"
    },
    {
        "action": "Shipped winning variant to 100%",
        "time": "4h ago"
    }
];
