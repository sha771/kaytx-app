...
const ACCENT = '#6D28D9';
const AGENT_NAME = 'AI UX Researcher';
const AGENT_TITLE = 'User Research AI';
const AGENT_DESC = 'Conducts user research, synthesizes session recordings, and generates actionable UX insights.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '90.5%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Analyzed 50 heat map sessions",
        "time": "15m ago"
    },
    {
        "action": "Synthesized user interview findings",
        "time": "40m ago"
    },
    {
        "action": "Generated usability test report",
        "time": "1h ago"
    },
    {
        "action": "Identified drop-off in checkout flow",
        "time": "2h ago"
    },
    {
        "action": "Created user journey map v2",
        "time": "3h ago"
    }
];
