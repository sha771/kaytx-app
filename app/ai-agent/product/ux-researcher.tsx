...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'204',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.6s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.0%',icon:Target,color:'#6A1B9A'}];
  const capabilities = ['UX Research','User Behavior Analysis','Design Recommendations'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI UX Researcher</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Conducts UX research, analyzes user behavior, and provides design recommendations.</Text></View>
      ...
      <AgentFeatures agentId="ux-researcher" agentName="AI UX Researcher" />
    </ScrollView>
  );
}
