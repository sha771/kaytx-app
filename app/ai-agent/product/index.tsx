...
import { Lightbulb, Activity, Star, Users, CircleCheckBig, Clock, Target, ArrowRight, ChartBarBig, MessageSquare, Calendar, Shield, FlaskConical, Palette, Code, Rocket, LayoutDashboard } from 'lucide-react-native';
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <TouchableOpacity onPress={() => router.push('/ai-agent/product/sub-agents')} style={[styles.subAgentButton, { backgroundColor: '#8B5CF615' }]}>
          <Package size={20} color="#8B5CF6" />
          <Text style={[styles.subAgentButtonText, { color: '#8B5CF6' }]}>View All 30 Sub-Agents</Text>
