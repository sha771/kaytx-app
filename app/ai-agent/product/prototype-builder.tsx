...
const ACCENT = '#4C1D95';
const AGENT_NAME = 'AI Prototype Builder';
const AGENT_TITLE = 'Rapid Prototyping AI';
const AGENT_DESC = 'Creates interactive prototypes, wireframes, and user flow diagrams to validate ideas fast.';
const PARENT_NAME = 'Product & R&D AI';

const METRICS = [
  { label: 'Tasks Today', value: '6', color: ACCENT },
  { label: 'Success Rate', value: '87%', color: '#00C853' },
  { label: 'Avg Speed', value: '4.0s', color: '#007AFF' },
  { label: 'Accuracy', value: '87.6%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Built checkout flow prototype",
        "time": "30m ago"
    },
    {
        "action": "Created onboarding wireframes",
        "time": "1h ago"
    },
    {
        "action": "Generated user flow diagram",
        "time": "2h ago"
    },
    {
        "action": "Prototyped mobile nav redesign",
        "time": "3h ago"
    },
    {
        "action": "Shared prototype for user testing",
        "time": "4h ago"
    }
];
