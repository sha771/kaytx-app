...
export default function SprintReviewerPage() {
  const agent = {
    ...
    title: 'Product Agent',
    description: 'Automated Sprint Reviewer agent specializing in product operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
