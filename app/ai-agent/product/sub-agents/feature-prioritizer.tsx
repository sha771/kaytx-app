...
export default function FeaturePrioritizerPage() {
  const agent = {
    ...
    title: 'Product Agent',
    description: 'Automated Feature Prioritizer agent specializing in product operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Feature Prioritizer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
