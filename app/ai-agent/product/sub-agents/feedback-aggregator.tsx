...
export default function FeedbackAggregatorPage() {
  const agent = {
    ...
    title: 'Product Agent',
    description: 'Automated Feedback Aggregator agent specializing in product operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Feedback Aggregator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
