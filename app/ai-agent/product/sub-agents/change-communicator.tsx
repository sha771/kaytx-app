...
export default function ChangeCommunicatorPage() {
  const agent = {
    id: 'change-communicator',
    name: 'AI Change Communicator',
    title: 'Product Agent',
    description: 'Automated Change Communicator agent specializing in product operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Change Communicator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
