...
const agent = {
  ...
  description: 'Analyzes sales data, predicts future trends, and provides accurate revenue forecasts.',
  icon: User,
  color: '#34C759',
  type: 'subagent' as const,
  category: 'sales-revenue',
  parentCategory: 'Sales & Revenue',
  capabilities: ['Sales Analysis', 'Trend Prediction', 'Revenue Forecasting', 'Pipeline Management', 'Performance Analytics'],
