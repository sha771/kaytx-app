...
const ACCENT = '#28A745';
const AGENT_NAME = 'AI Upsell & Cross-Sell';
const AGENT_TITLE = 'Revenue Expansion AI';
const AGENT_DESC = 'Identifies expansion opportunities across the customer base using usage metrics and behavior triggers.';
const PARENT_NAME = 'Sales & Revenue AI';

const METRICS = [
  { label: 'Tasks Today', value: '112', color: ACCENT },
  { label: 'Success Rate', value: '88%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.8s', color: '#007AFF' },
  { label: 'Accuracy', value: '89.5%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Identified 15 new upsell targets",
        "time": "2m ago"
    },
    {
        "action": "Triggered automated cross-sell sequence",
        "time": "20m ago"
    },
    {
        "action": "Analyzed product adoption metrics",
        "time": "40m ago"
    },
    {
        "action": "Generated personalized upgrade offer",
        "time": "1h ago"
    },
    {
        "action": "Alerted AE to expansion opportunity",
        "time": "2h ago"
    }
];
