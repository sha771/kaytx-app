...
const AGENT_DESC = 'Creates fully customized, data-driven sales proposals and RFP responses in seconds.';
const PARENT_NAME = 'Sales & Revenue AI';

const METRICS = [
  { label: 'Tasks Today', value: '42', color: ACCENT },
  { label: 'Success Rate', value: '98%', color: '#00C853' },
  { label: 'Avg Speed', value: '2.5s', color: '#007AFF' },
  { label: 'Accuracy', value: '98.2%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Generated $120k enterprise proposal",
        "time": "10m ago"
    },
    {
        "action": "Responded to 80-question RFP",
        "time": "45m ago"
    },
    {
        "action": "Applied negotiated dynamic pricing",
        "time": "1h ago"
    },
    {
        "action": "Sent proposal for e-signature",
        "time": "2h ago"
    },
    {
        "action": "Updated case study references",
        "time": "3h ago"
    }
];
