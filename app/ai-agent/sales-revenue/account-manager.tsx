...
const AGENT_TITLE = 'Account Growth AI';
const AGENT_DESC = 'Manages key accounts, tracks health scores, and plans strategic growth for each client.';
const PARENT_NAME = 'Sales & Revenue AI';

const METRICS = [
  { label: 'Tasks Today', value: '65', color: ACCENT },
  { label: 'Success Rate', value: '95%', color: '#00C853' },
  { label: 'Avg Speed', value: '1.2s', color: '#007AFF' },
  { label: 'Accuracy', value: '95.5%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Reviewed Q3 account health",
        "time": "5m ago"
    },
    {
        "action": "Flagged 2 at-risk accounts",
        "time": "15m ago"
    },
    {
        "action": "Scheduled 5 QBRs",
        "time": "30m ago"
    },
    {
    ...
    {
        "action": "Updated success metrics for Acme Corp",
        "time": "2h ago"
    }
];
