...
export default function FacilitiesCoordinatorManagerPage() {
  const agent = {
    id: 'facilities-coordinator-manager',
    name: 'AI Facilities Coordinator Manager',
    title: 'AI Facilities Coordinator Manager',
    description: 'AI Facilities Coordinator Manager provides specialized expertise and executes critical tasks for the Administrative department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'facilities-coordinator-manager',
    infrastructure: {
      status: 'online',
