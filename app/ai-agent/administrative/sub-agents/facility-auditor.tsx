...
export default function FacilityAuditor() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.header, { borderBottomColor: theme.colors.border }]}>
        ...
        <View>
          <Text style={[styles.title, { color: theme.colors.text }]}>Facility Auditor</Text>
          <Text style={[styles.subtitle, { color: theme.colors.textSecondary }]}>Sub-Agent</Text>
        </View>
      </View>
      <View style={[styles.section, { backgroundColor: theme.colors.card }]}>
        <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text>
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>Audits facilities for compliance and maintenance needs.</Text>
      </View>
      <AgentFeatures agentId="facility-auditor" agentName="Facility Auditor" />
    </ScrollView>
  );
}
