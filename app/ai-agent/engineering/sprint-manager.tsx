...
const ACCENT = '#134E4A';
const AGENT_NAME = 'AI Sprint Manager';
const AGENT_TITLE = 'Agile Sprint AI';
const AGENT_DESC = 'Plans sprints, tracks velocity, detects blockers, and runs retrospectives automatically.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '91.9%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Planned Sprint 24 — 42 story points",
        "time": "5m ago"
    },
    {
        "action": "Updated velocity: 38 pts avg",
        "time": "20m ago"
    },
    {
    ...
    {
        "action": "Generated burndown chart",
        "time": "1h ago"
    },
    {
        "action": "Ran automated retrospective",
        "time": "2h ago"
    }
];
