...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'229',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'2.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.7%',icon:Target,color:'#1565C0'}];
  const capabilities = ['Sprint Management','Progress Tracking','Velocity Optimization'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Sprint Manager</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Manages agile sprints, tracks progress, and optimizes team velocity.</Text></View>
      ...
      <AgentFeatures agentId="sprint-manager" agentName="AI Sprint Manager" />
    </ScrollView>
  );
}
