...
const ACCENT = '#0D9488';
const AGENT_NAME = 'AI CI/CD Agent';
const AGENT_TITLE = 'Pipeline Automation AI';
const AGENT_DESC = 'Optimizes build pipelines, monitors deployments, and automates release management end-to-end.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '98.4%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Optimized pipeline — 40% faster builds",
        "time": "2h ago"
    },
    {
        "action": "Monitored 3 deployment jobs",
        "time": "4h ago"
    },
    {
        "action": "Generated release notes v2.5",
        "time": "6h ago"
    },
    {
        "action": "Synced environments dev/staging",
        "time": "8h ago"
    },
    {
        "action": "Managed rollback for hotfix release",
        "time": "10h ago"
    }
];
