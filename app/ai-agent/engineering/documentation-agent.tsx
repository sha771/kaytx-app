...
const ACCENT = '#115E59';
const AGENT_NAME = 'AI Documentation Agent';
const AGENT_TITLE = 'Technical Docs AI';
const AGENT_DESC = 'Auto-generates API docs, READMEs, changelogs, and architecture diagrams from code.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '94.2%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Generated API docs for v3.2",
        "time": "8m ago"
    },
    {
        "action": "Updated README with setup guide",
        "time": "25m ago"
    },
    {
        "action": "Created architecture diagram",
        "time": "45m ago"
    },
    {
        "action": "Published release notes v2.5",
        "time": "1h ago"
    },
    {
        "action": "Synced docs to Confluence",
        "time": "2h ago"
    }
];
