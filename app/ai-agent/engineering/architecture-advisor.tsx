...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'234',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.2s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.0%',icon:Target,color:'#1565C0'}];
  const capabilities = ['Architecture Guidance','Design Patterns','Best Practices'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Architecture Advisor</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Provides software architecture guidance, design patterns, and best practices.</Text></View>
      ...
      <AgentFeatures agentId="architecture-advisor" agentName="AI Architecture Advisor" />
    </ScrollView>
  );
}
