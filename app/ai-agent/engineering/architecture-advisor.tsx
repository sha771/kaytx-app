...
const ACCENT = '#0F766E';
const AGENT_NAME = 'AI Architecture Advisor';
const AGENT_TITLE = 'System Design AI';
const AGENT_DESC = 'Reviews system designs, recommends patterns, and analyzes scalability bottlenecks.';
...
const RECENT_TASKS = [
    {
        "action": "Reviewed microservices design",
        "time": "10m ago"
    },
    {
        "action": "Proposed Redis caching strategy",
        "time": "35m ago"
    },
    {
        "action": "Evaluated event-driven vs REST",
        "time": "1h ago"
    },
    {
        "action": "API design review for v3",
        "time": "2h ago"
    },
    {
        "action": "Migration strategy for monolith",
        "time": "3h ago"
    }
];
