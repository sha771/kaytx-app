...
import { Cpu, Activity, Star, Users, CircleCheckBig, Clock, Target, ArrowRight, ChartBar, MessageSquare, Calendar, Shield, Code, GitBranch, Server, Database, Cloud, Terminal } from 'lucide-react-native';
