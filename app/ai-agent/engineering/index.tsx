...
import { Cpu, Activity, Star, Users, CircleCheckBig, Clock, Target, ArrowRight, ChartBar, MessageSquare, Calendar, Shield, Code, GitBranch, Server, Database, Cloud, Terminal, ChartBar } from 'lucide-react-native';
