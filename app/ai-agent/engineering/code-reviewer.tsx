...
const ACCENT = '#14B8A6';
const AGENT_NAME = 'AI Code Reviewer';
const AGENT_TITLE = 'Code Quality AI';
const AGENT_DESC = 'Reviews pull requests, enforces standards, and catches security vulnerabilities before production.';
const PARENT_NAME = 'Engineering & Development AI';

const METRICS = [
  { label: 'Tasks Today', value: '156', color: ACCENT },
  { label: 'Success Rate', value: '95%', color: '#00C853' },
  { label: 'Avg Speed', value: '1.2s', color: '#007AFF' },
  { label: 'Accuracy', value: '95.4%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Reviewed PR #842 — approved with notes",
        "time": "1m ago"
    },
    {
        "action": "Flagged SQL injection in auth module",
        "time": "8m ago"
    },
    {
        "action": "Suggested 12 performance optimizations",
        "time": "20m ago"
    },
    {
        "action": "Enforced naming conventions",
        "time": "35m ago"
    },
    {
        "action": "Blocked PR with critical XSS bug",
        "time": "50m ago"
    }
];
