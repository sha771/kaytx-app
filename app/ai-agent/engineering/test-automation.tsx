...
const ACCENT = '#0D9488';
const AGENT_NAME = 'AI Test Automation';
const AGENT_TITLE = 'QA Automation AI';
const AGENT_DESC = 'Generates and runs automated test suites with 92%+ coverage and instant regression detection.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '97.1%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Generated 45 new test cases",
        "time": "2m ago"
    },
    {
        "action": "Achieved 92% test coverage",
        "time": "15m ago"
    },
    {
        "action": "Detected 3 regressions in v2.5",
        "time": "30m ago"
    },
    {
