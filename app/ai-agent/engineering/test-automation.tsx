...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'231',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'2.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.6%',icon:Target,color:'#1565C0'}];
  const capabilities = ['Test Automation','Bug Detection','Quality Assurance'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Test Automation</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Creates and runs automated tests, identifies bugs, and ensures code quality.</Text></View>
      ...
      <AgentFeatures agentId="test-automation" agentName="AI Test Automation" />
    </ScrollView>
  );
}
