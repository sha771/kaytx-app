...
const ACCENT = '#14B8A6';
const AGENT_NAME = 'AI Bug Triager';
const AGENT_TITLE = 'Bug Management AI';
const AGENT_DESC = 'Prioritizes bug reports, finds duplicates, analyzes root causes, and routes to the right engineer.';
const PARENT_NAME = 'Engineering & Development AI';

const METRICS = [
  { label: 'Tasks Today', value: '34', color: ACCENT },
  { label: 'Success Rate', value: '90%', color: '#00C853' },
  { label: 'Avg Speed', value: '1.8s', color: '#007AFF' },
  { label: 'Accuracy', value: '90.7%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Triaged 23 new bug reports",
        "time": "15m ago"
    },
    {
        "action": "Found 5 duplicate issues",
        "time": "30m ago"
    },
    {
        "action": "Identified root cause for crash",
        "time": "50m ago"
    },
    {
        "action": "Routed P0 to on-call engineer",
        "time": "1h ago"
    },
    {
        "action": "SLA alert: 3 bugs past deadline",
        "time": "2h ago"
    }
];
