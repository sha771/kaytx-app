...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'248',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'2.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.2%',icon:Target,color:'#1565C0'}];
  const capabilities = ['Bug Triage','Fix Prioritization','Resolution Tracking'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Bug Triager</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Triages bugs, prioritizes fixes, and tracks bug resolution progress.</Text></View>
      ...
      <AgentFeatures agentId="bug-triager" agentName="AI Bug Triager" />
    </ScrollView>
  );
}
