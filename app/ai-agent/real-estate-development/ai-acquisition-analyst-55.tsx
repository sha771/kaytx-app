...
export default function AgentPage() {
  const agent = {
    ...
    description: 'AI Acquisition Analyst - Acquisition Analyst level AI agent in the real estate-development department. Part of the Kaytx AI Workforce hierarchy providing specialized real estate-development capabilities.',
