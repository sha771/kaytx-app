...
const ACCENT = '#10B981';
const AGENT_NAME = 'AI Invoice Processor';
const AGENT_TITLE = 'AP/AR Automation AI';
const AGENT_DESC = 'Captures invoices via OCR, matches POs, and schedules payments automatically.';
...
const RECENT_TASKS = [
    {
        "action": "Processed 67 vendor invoices",
        "time": "3m ago"
    },
    {
        "action": "Matched 45 purchase orders",
        "time": "10m ago"
    },
    {
        "action": "Scheduled 12 payments",
        "time": "25m ago"
    },
    {
        "action": "Resolved 2 invoice disputes",
        "time": "40m ago"
    },
    {
        "action": "Sent payment confirmations",
        "time": "1h ago"
    }
];
