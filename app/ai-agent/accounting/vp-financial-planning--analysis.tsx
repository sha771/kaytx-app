...
export default function VPFinancialPlanningAndAnalysisPage() {
  const agent = {
    id: 'vp-financial-planning--analysis',
    name: 'AI VP Financial Planning & Analysis',
    title: 'AI VP Financial Planning & Analysis',
    description: 'AI VP Financial Planning & Analysis provides specialized expertise and executes critical tasks for the Finance & Accounting department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'vp-financial-planning--analysis',
    infrastructure: {
      status: 'online',
