...
const ACCENT = '#34D399';
const AGENT_NAME = 'AI Financial Planner';
const AGENT_TITLE = 'Financial Strategy AI';
const AGENT_DESC = 'Builds budget forecasts, models financial scenarios, and aligns spending with strategic goals.';
const PARENT_NAME = 'Accounting & Finance AI';

const METRICS = [
  { label: 'Tasks Today', value: '34', color: ACCENT },
  { label: 'Success Rate', value: '94%', color: '#00C853' },
  { label: 'Avg Speed', value: '2.5s', color: '#007AFF' },
  { label: 'Accuracy', value: '95.2%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Updated annual budget forecast",
        "time": "8m ago"
    },
    {
        "action": "Modeled 3 growth scenarios",
        "time": "22m ago"
    },
    {
        "action": "Analyzed investment returns",
        "time": "45m ago"
    },
    {
        "action": "Reviewed cash flow projections",
        "time": "1h ago"
    },
    {
        "action": "Generated financial dashboard",
        "time": "2h ago"
    }
];
