...
export default function FinancialModelingAnalystPage() {
  const agent = {
    id: 'financial-modeling-analyst',
    name: 'AI Financial Modeling Analyst',
    title: 'AI Financial Modeling Analyst',
    description: 'AI Financial Modeling Analyst provides specialized expertise and executes critical tasks for the Finance & Accounting department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'financial-modeling-analyst',
    infrastructure: {
      status: 'online',
