...
const ACCENT = '#059669';
const AGENT_NAME = 'AI Payroll Manager';
const AGENT_TITLE = 'Payroll Processing AI';
const AGENT_DESC = 'Automates payroll runs, tax withholding, and benefits administration for any team size.';
...
const RECENT_TASKS = [
    {
        "action": "Processed monthly payroll run",
        "time": "3d ago"
    },
    {
        "action": "Filed payroll tax deposits",
        "time": "4d ago"
    },
    {
        "action": "Updated benefit deductions",
        "time": "5d ago"
    },
    {
        "action": "Generated pay stubs",
        "time": "1w ago"
    },
    {
        "action": "Reconciled payroll accounts",
        "time": "1w ago"
    }
];
