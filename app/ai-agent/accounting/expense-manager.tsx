...
const ACCENT = '#A7F3D0';
const AGENT_NAME = 'AI Expense Manager';
const AGENT_TITLE = 'Expense Tracking AI';
const AGENT_DESC = 'Automates expense tracking, enforces policies, and processes reimbursements in real-time.';
...
const RECENT_TASKS = [
    {
        "action": "Processed 45 expense reports",
        "time": "2m ago"
    },
    {
        "action": "Flagged 3 policy violations",
        "time": "8m ago"
    },
    {
        "action": "Generated weekly spend report",
        "time": "20m ago"
    },
    {
        "action": "Approved 23 reimbursements",
        "time": "35m ago"
    },
    {
        "action": "Synced with corporate cards",
        "time": "1h ago"
    }
];
