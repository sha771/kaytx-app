...
const ACCENT = '#6EE7B7';
const AGENT_NAME = 'AI Auditor';
const AGENT_TITLE = 'Internal Audit AI';
const AGENT_DESC = 'Performs continuous internal audits, flags anomalies, and ensures SOX compliance.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '98.1%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Completed SOX compliance review",
        "time": "15m ago"
    },
    {
        "action": "Tested 45 internal controls",
        "time": "30m ago"
    },
    {
        "action": "Flagged anomaly in travel expenses",
        "time": "1h ago"
    },
    {
        "action": "Generated audit report v2",
        "time": "2h ago"
    },
    {
        "action": "Reviewed AP disbursements",
        "time": "3h ago"
    }
];
