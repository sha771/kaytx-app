...
const agent = {
  ...
  title: 'Financial Control AI',
  description: 'Oversees financial reporting, ensures compliance, and manages financial controls.',
  icon: Bot,
  color: '#00695C',
  type: 'subagent' as const,
  category: 'accounting',
  parentCategory: 'Finance & Accounting',
  capabilities: ['Financial Reporting', 'Compliance Management', 'Internal Controls', 'Audit Coordination', 'Account Reconciliation'],
