...
export default function AgentPage() {
  const agent = {
    ...
    description: 'The credit-manager AI provides specialized services and automation within its department.',
