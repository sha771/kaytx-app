...
const ACCENT = '#10B981';
const AGENT_NAME = 'AI Bookkeeper';
const AGENT_TITLE = 'Automated Bookkeeping AI';
const AGENT_DESC = 'Records transactions, reconciles accounts, and maintains accurate financial ledgers 24/7.';
...
const RECENT_TASKS = [
    {
        "action": "Reconciled 150 bank transactions",
        "time": "2m ago"
    },
    {
        "action": "Categorized 89 expenses",
        "time": "5m ago"
    },
    {
        "action": "Generated trial balance",
        "time": "12m ago"
    },
    {
        "action": "Posted journal entries",
        "time": "18m ago"
    },
    {
        "action": "Detected duplicate entry #4821",
        "time": "25m ago"
    }
];
