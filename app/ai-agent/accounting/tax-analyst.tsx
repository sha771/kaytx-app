...
const ACCENT = '#059669';
const AGENT_NAME = 'AI Tax Analyst';
const AGENT_TITLE = 'Tax Planning & Compliance AI';
const AGENT_DESC = 'Monitors tax obligations, identifies deductions, and ensures full compliance across jurisdictions.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '97.6%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Reviewed Q3 tax provisions",
        "time": "5m ago"
    },
    {
        "action": "Identified $42K savings opportunity",
        "time": "15m ago"
    },
    {
    ...
    {
        "action": "Prepared estimated tax filing",
        "time": "1h ago"
    },
    {
        "action": "Analyzed multi-state tax impact",
        "time": "2h ago"
    }
];
