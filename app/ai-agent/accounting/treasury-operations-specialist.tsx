...
export default function TreasuryOperationsSpecialistPage() {
  const agent = {
    id: 'treasury-operations-specialist',
    name: 'AI Treasury Operations Specialist',
    title: 'AI Treasury Operations Specialist',
    description: 'AI Treasury Operations Specialist provides specialized expertise and executes critical tasks for the Finance & Accounting department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'treasury-operations-specialist',
    infrastructure: {
      status: 'online',
