...
const ACCENT = '#F59E0B';
const AGENT_NAME = 'AI Contract Reviewer';
const AGENT_TITLE = 'Contract Analysis AI';
const AGENT_DESC = 'Analyzes contracts, identifies risky clauses, and suggests redlines in seconds.';
...
const RECENT_TASKS = [
    {
        "action": "Reviewed 8 vendor MSAs",
        "time": "3m ago"
    },
    {
        "action": "Flagged liability clause in Section 4",
        "time": "15m ago"
    },
    {
        "action": "Generated contract summary",
        "time": "30m ago"
    },
    {
        "action": "Identified missing SLA terms",
        "time": "1h ago"
    },
    {
        "action": "Compared contract vs template",
        "time": "2h ago"
    }
];
