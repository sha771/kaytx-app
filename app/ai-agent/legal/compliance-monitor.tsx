...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'247',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'2.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.9%',icon:Target,color:'#3E2723'}];
  const capabilities = ['Regulatory Monitoring','Compliance Assurance','Risk Management'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Compliance Monitor</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Monitors regulatory changes, ensures compliance, and manages risk.</Text></View>
      ...
      <AgentFeatures agentId="compliance-monitor" agentName="AI Compliance Monitor" />
    </ScrollView>
  );
}
