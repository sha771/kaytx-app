...
const AGENT_TITLE = 'Regulatory Compliance AI';
const AGENT_DESC = 'Tracks regulatory changes, enforces policies, and prepares audit-ready compliance evidence.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '99.2%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Updated GDPR compliance status",
        "time": "1m ago"
    },
    {
        "action": "Monitored 23 regulatory changes",
        "time": "10m ago"
    },
    {
        "action": "Prepared audit documentation",
        "time": "25m ago"
    },
    {
        "action": "Flagged CCPA requirement gap",
        "time": "45m ago"
    },
    {
        "action": "Updated compliance matrix",
        "time": "1h ago"
    }
];
