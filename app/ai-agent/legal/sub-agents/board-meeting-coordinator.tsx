...
export default function BoardMeetingCoordinatorPage() {
  const agent = {
    ...
    title: 'Legal Agent',
    description: 'Automated Board Meeting Coordinator agent specializing in legal operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
