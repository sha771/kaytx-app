...
export default function GovernanceAuditorPage() {
  const agent = {
    ...
    title: 'Legal Agent',
    description: 'Automated Governance Auditor agent specializing in legal operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Governance Auditor',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
