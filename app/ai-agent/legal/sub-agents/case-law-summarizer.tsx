...
export default function CaseLawSummarizerPage() {
  const agent = {
    ...
    title: 'Legal Agent',
    description: 'Automated Case Law Summarizer agent specializing in legal operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Case Law Summarizer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
