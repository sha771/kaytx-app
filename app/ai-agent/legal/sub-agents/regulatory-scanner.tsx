...
export default function RegulatoryScannerPage() {
  const agent = {
    ...
    title: 'Legal Agent',
    description: 'Automated Regulatory Scanner agent specializing in legal operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Regulatory Scanner',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
