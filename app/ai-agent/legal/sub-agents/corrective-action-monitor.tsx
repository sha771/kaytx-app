...
export default function CorrectiveActionMonitorPage() {
  const agent = {
    ...
    title: 'Legal Agent',
    description: 'Automated Corrective Action Monitor agent specializing in legal operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
