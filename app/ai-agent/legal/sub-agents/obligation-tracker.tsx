...
export default function ObligationTrackerPage() {
  const agent = {
    ...
    title: 'Legal Agent',
    description: 'Automated Obligation Tracker agent specializing in legal operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Obligation Tracker',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
