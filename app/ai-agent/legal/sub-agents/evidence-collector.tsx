...
export default function EvidenceCollectorPage() {
  const agent = {
    ...
    title: 'Legal Agent',
    description: 'Automated Evidence Collector agent specializing in legal operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
