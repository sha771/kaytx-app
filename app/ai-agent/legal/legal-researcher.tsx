...
const ACCENT = '#78350F';
const AGENT_NAME = 'AI Legal Researcher';
const AGENT_TITLE = 'Legal Research AI';
const AGENT_DESC = 'Performs deep legal research, finds case precedents, and synthesizes statute changes rapidly.';
...
const RECENT_TASKS = [
    {
        "action": "Researched 3 case precedents",
        "time": "20m ago"
    },
    {
        "action": "Summarized recent statute changes",
        "time": "45m ago"
    },
    {
        "action": "Prepared legal brief for CFO",
        "time": "1h ago"
    },
    {
        "action": "Identified case law for IP dispute",
        "time": "2h ago"
    },
    {
        "action": "Updated regulatory change log",
        "time": "3h ago"
    }
];
