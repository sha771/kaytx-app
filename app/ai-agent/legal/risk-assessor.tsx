...
const ACCENT = '#B45309';
const AGENT_NAME = 'AI Risk Assessor';
const AGENT_TITLE = 'Enterprise Risk AI';
const AGENT_DESC = 'Identifies, quantifies, and mitigates enterprise risks across legal, operational, and financial domains.';
const PARENT_NAME = 'Legal & Compliance AI';

const METRICS = [
  { label: 'Tasks Today', value: '34', color: ACCENT },
  { label: 'Success Rate', value: '94%', color: '#00C853' },
  { label: 'Avg Speed', value: '2.0s', color: '#007AFF' },
  { label: 'Accuracy', value: '94.5%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Updated enterprise risk register",
        "time": "8m ago"
    },
    {
        "action": "Assessed 5 vendor risk scores",
        "time": "22m ago"
    },
    {
        "action": "Created mitigation plans for 3 risks",
        "time": "45m ago"
    },
    {
        "action": "Generated risk heat map",
        "time": "1h ago"
    },
    {
        "action": "Reviewed M&A risk factors",
        "time": "2h ago"
    }
];
