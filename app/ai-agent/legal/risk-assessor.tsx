...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'228',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.5%',icon:Target,color:'#3E2723'}];
  const capabilities = ['Risk Assessment','Mitigation Strategies','Compliance Monitoring'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Assesses legal risks, provides risk mitigation strategies, and monitors compliance.</Text></View>
