...
const ACCENT = '#92400E';
const AGENT_NAME = 'AI Policy Analyst';
const AGENT_TITLE = 'Policy Management AI';
const AGENT_DESC = 'Drafts, reviews, and distributes corporate policies with automated acknowledgment tracking.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '95.3%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Drafted updated privacy policy",
        "time": "12m ago"
    },
    {
        "action": "Distributed 5 policy changes",
        "time": "30m ago"
    },
    {
        "action": "Tracked 89% acknowledgment rate",
        "time": "45m ago"
    },
    {
        "action": "Assessed policy impact on ops",
        "time": "1h ago"
    },
    {
        "action": "Archived deprecated policy v1",
        "time": "2h ago"
    }
];
