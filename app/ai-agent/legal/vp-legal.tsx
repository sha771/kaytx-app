...
export default function VPLegalPage() {
  ...
  const capabilities = [
    'Contract Review', 'Compliance Monitoring', 'IP Management', 'Litigation Support',
    'Policy Drafting', 'Risk Assessment', 'Regulatory Tracking', 'Legal Research'
  ];
  ...
  const responsibilities = [
    ...
    'Board & Executive Legal Advisory'
  ];

  const activities = [
    { time: '2 min ago', text: 'Reviewed and redlined enterprise SLA', icon: BookOpen },
    { time: '18 min ago', text: 'Updated compliance tracking dashboard', icon: Shield },
    { time: '1 hour ago', text: 'Flagged 7 regulatory changes', icon: Gavel },
    { time: '3 hours ago', text: 'Completed IP portfolio audit', icon: Star },
    { time: '6 hours ago', text: 'Published policy update for data privacy', icon: Zap },
  ];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { backgroundColor: theme.colors.primary + '18' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: theme.colors.primary + '25' }]}>
          <Scale size={48} color={theme.colors.primary} />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>VP Legal</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Legal & Compliance Department</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The VP Legal AI oversees all legal operations, contract management, and compliance frameworks. This agent ensures regulatory adherence, mitigates legal risks, and provides strategic legal counsel across the organization.
        </Text>
      </View>
    ...
    <AgentFeatures agentId="vp-legal" agentName="VP Legal" />
