...
const ACCENT = '#44403C';
const AGENT_NAME = 'AI Regulatory Agent';
const AGENT_TITLE = 'Regulatory Filing AI';
const AGENT_DESC = 'Manages regulatory filings, tracks deadlines, and submits compliance reports automatically.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '99.0%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Filed quarterly regulatory report",
        "time": "2d ago"
    },
    {
        "action": "Tracked 5 upcoming deadlines",
        "time": "3d ago"
    },
    {
        "action": "Submitted SEC compliance form",
        "time": "1w ago"
    },
    {
        "action": "Updated regulatory calendar",
        "time": "1w ago"
    },
    {
        "action": "Monitored cross-jurisdiction rules",
        "time": "2w ago"
    }
];
