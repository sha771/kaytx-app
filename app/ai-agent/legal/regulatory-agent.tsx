...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'156',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.7s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.7%',icon:Target,color:'#3E2723'}];
