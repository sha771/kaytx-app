...
const agent = {
  id: 'cto',
  name: 'AI CTO',
  title: 'Chief Technology Officer AI',
  description: 'Provides technology leadership, manages IT strategy, and drives digital transformation initiatives.',
  icon: User,
  color: '#0D47A1',
  type: 'subagent' as const,
  category: 'executive',
  parentCategory: 'Executive Leadership',
  capabilities: ['Technology Strategy', 'IT Leadership', 'Digital Transformation', 'Architecture Planning', 'Innovation Oversight'],
