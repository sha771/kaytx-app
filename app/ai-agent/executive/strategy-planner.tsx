...
const ACCENT = '#92400E';
const AGENT_NAME = 'AI Strategy Planner';
const AGENT_TITLE = 'Strategic Intelligence AI';
const AGENT_DESC = 'Develops long-term strategic plans, competitive positioning, and market opportunity assessments.';
const PARENT_NAME = 'Executive & Leadership AI';

const METRICS = [
  { label: 'Tasks Today', value: '23', color: ACCENT },
  { label: 'Success Rate', value: '91%', color: '#00C853' },
  { label: 'Avg Speed', value: '2.8s', color: '#007AFF' },
  { label: 'Accuracy', value: '91.7%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Updated 5-year strategic roadmap",
        "time": "8m ago"
    },
    {
        "action": "Identified new market opportunity",
        "time": "30m ago"
    },
    {
        "action": "Analyzed competitor landscape",
        "time": "1h ago"
    },
    {
        "action": "Drafted OKR framework Q4",
        "time": "2h ago"
    },
    {
        "action": "Scenario planned market entry",
        "time": "3h ago"
    }
];
