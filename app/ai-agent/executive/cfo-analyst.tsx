...
const ACCENT = '#FBBF24';
const AGENT_NAME = 'AI CFO Analyst';
const AGENT_TITLE = 'Financial Leadership AI';
const AGENT_DESC = 'Delivers financial strategy, investor reporting, and fiscal decision intelligence at CFO level.';
...
const RECENT_TASKS = [
    {
        "action": "Generated P&L report for board",
        "time": "1m ago"
    },
    {
    ...
    {
        "action": "Analyzed investment ROI",
        "time": "30m ago"
    },
    {
        "action": "Prepared investor update",
        "time": "1h ago"
    },
    {
        "action": "Modeled 3 financial scenarios",
        "time": "2h ago"
    }
];
