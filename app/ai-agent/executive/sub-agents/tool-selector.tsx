...
export default function ToolSelectorPage() {
  const agent = {
    ...
    description: 'Automated Tool Selector agent specializing in executive operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
