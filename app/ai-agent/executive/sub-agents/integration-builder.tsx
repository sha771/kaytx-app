...
export default function IntegrationBuilderPage() {
  const agent = {
    ...
    description: 'Automated Integration Builder agent specializing in executive operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Integration Builder',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
