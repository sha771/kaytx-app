...
import { Activity, AlertTriangle, Clock, Target, Zap, ArrowRight, Briefcase } from 'lucide-react-native';
...
export default function ExceptionHandlerPage() {
  ...
  const capabilities = [
    'Error Detection', 'Classification', 'Routing Logic', 'Escalation Rules',
    'Resolution Tracking', 'Pattern Analysis', 'Prevention Planning', 'Reporting'
  ];

  const endpoints = [
    '/consult/exception-handler',
    '/exception-handler/execute',
    '/exception-handler/analyze',
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <View style={styles.badgesRow}>
          ...
          <View style={[styles.badge, { backgroundColor: '#DC262622' }]}>
            ...
            <Text style={[styles.badgeText, { color: '#DC2626' }]}>Exceptions</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.statsContainer}>
        {[
          ...
          { label: 'Level', value: 'Exceptions', icon: AlertTriangle, color: '#DC2626' },
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Exception Handler specializes in aod lead operations, providing automated capabilities to support the AI Aod Lead in achieving operational excellence.
        </Text>
      </View>
