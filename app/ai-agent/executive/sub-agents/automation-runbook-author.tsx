...
import { Activity, BookOpen, Clock, Target, Zap, ArrowRight, Briefcase } from 'lucide-react-native';
...
export default function AutomationRunbookAuthorPage() {
  ...
  const capabilities = [
    'Step Documentation', 'Screenshot Capture', 'Video Recording', 'Decision Mapping',
    'Exception Handling', 'Troubleshooting Guide', 'FAQ Creation', 'Version Control'
  ];

  const endpoints = [
    '/consult/automation-runbook-author',
    '/automation-runbook-author/execute',
    '/automation-runbook-author/analyze',
    '/automation-runbook-author/report'
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <View style={styles.badgesRow}>
          ...
          <View style={[styles.badge, { backgroundColor: '#A855F722' }]}>
            ...
            <Text style={[styles.badgeText, { color: '#A855F7' }]}>Documentation</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.statsContainer}>
        {[
          ...
          { label: 'Level', value: 'Documentation', icon: BookOpen, color: '#A855F7' },
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Automation Runbook Author specializes in aod lead operations, providing automated capabilities to support the AI Aod Lead in achieving operational excellence.
        </Text>
      </View>
