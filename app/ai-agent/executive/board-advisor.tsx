...
const ACCENT = '#D97706';
const AGENT_NAME = 'AI Board Advisor';
const AGENT_TITLE = 'Corporate Governance AI';
const AGENT_DESC = 'Handles board prep, governance compliance, ESG reporting, and shareholder communications.';
...
const RECENT_TASKS = [
    {
        "action": "Prepared AGM presentation",
        "time": "15m ago"
    },
    {
        "action": "Reviewed governance policies",
        "time": "45m ago"
    },
    {
        "action": "Compiled ESG report Q3",
        "time": "2h ago"
    },
    {
        "action": "Analyzed shareholder proposals",
        "time": "3h ago"
    },
    {
        "action": "Updated board committee charters",
        "time": "4h ago"
    }
];
