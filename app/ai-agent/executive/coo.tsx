...
const agent = {
  ...
  description: 'Oversees daily operations, optimizes business processes, and ensures operational efficiency across all departments.',
  icon: User,
  color: '#1E3A5F',
  type: 'subagent' as const,
  category: 'executive',
  parentCategory: 'Executive Leadership',
  capabilities: ['Operations Management', 'Process Optimization', 'Resource Allocation', 'Performance Monitoring', 'Department Coordination'],
