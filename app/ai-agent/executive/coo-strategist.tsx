...
const ACCENT = '#F59E0B';
const AGENT_NAME = 'AI COO Strategist';
const AGENT_TITLE = 'Operations Leadership AI';
const AGENT_DESC = 'Drives operational excellence and cross-department coordination at COO scale.';
...
const RECENT_TASKS = [
    {
        "action": "Optimized supply chain process",
        "time": "5m ago"
    },
    {
        "action": "Coordinated Q4 cross-dept initiatives",
        "time": "20m ago"
    },
    {
        "action": "Reviewed department KPIs",
        "time": "45m ago"
    },
    {
        "action": "Identified operational bottleneck",
        "time": "1h ago"
    },
    {
        "action": "Streamlined approval workflow",
        "time": "2h ago"
    }
];
