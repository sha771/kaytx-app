...
const ACCENT = '#FFD700';
const AGENT_NAME = 'AI CEO Advisor';
const AGENT_TITLE = 'Strategic Executive Intelligence';
const AGENT_DESC = 'Provides strategic decision support, vision alignment, and executive-level intelligence for CEOs.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '96.5%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Prepared board briefing deck",
        "time": "2m ago"
    },
    {
        "action": "Analyzed M&A opportunity $50M",
        "time": "15m ago"
    },
    {
        "action": "Updated strategic roadmap Q3",
        "time": "35m ago"
    },
    {
        "action": "Competitive intelligence report",
        "time": "1h ago"
    },
    {
        "action": "Risk assessment for expansion",
        "time": "2h ago"
    }
];
