...
const ACCENT = '#78350F';
const AGENT_NAME = 'AI Decision Engine';
const AGENT_TITLE = 'Data-Driven Decision AI';
const AGENT_DESC = 'Powers executive decisions with scenario modeling, impact analysis, and probability mapping.';
const PARENT_NAME = 'Executive & Leadership AI';

const METRICS = [
  { label: 'Tasks Today', value: '0', color: ACCENT },
  { label: 'Success Rate', value: '95%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.9s', color: '#007AFF' },
  { label: 'Accuracy', value: '95.4%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Modeled 4 expansion scenarios",
        "time": "2h ago"
    },
    {
        "action": "Quantified risk of market entry",
        "time": "3h ago"
    },
    {
        "action": "Decision tree for acquisition",
        "time": "4h ago"
    },
    {
        "action": "Impact analysis for price change",
        "time": "6h ago"
    },
    {
        "action": "Probability mapping Q3 forecast",
        "time": "8h ago"
    }
];
