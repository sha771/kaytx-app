...
const ACCENT = '#DB2777';
const AGENT_NAME = 'AI Onboarding Agent';
const AGENT_TITLE = 'New Hire Experience AI';
const AGENT_DESC = 'Personalizes onboarding journeys with automated workflows, training paths, and buddy matching.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '97.3%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Onboarded 5 new hires today",
        "time": "5m ago"
    },
    {
        "action": "Assigned 8 training modules",
        "time": "15m ago"
    },
    {
        "action": "Set up buddy program matching",
        "time": "30m ago"
    },
    {
        "action": "Collected documents from 3 hires",
        "time": "1h ago"
    },
    {
        "action": "Sent day-1 welcome kits",
        "time": "2h ago"
    }
];
