...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'165',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.8s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.4%',icon:Target,color:'#880E4F'}];
  const capabilities = ['Onboarding Automation','Process Management','Employee Integration'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Onboarding Agent</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Automates and manages the complete employee onboarding process.</Text></View>
      ...
      <AgentFeatures agentId="onboarding-agent" agentName="AI Onboarding Agent" />
    </ScrollView>
  );
}
