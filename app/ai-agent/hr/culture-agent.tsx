...
const ACCENT = '#500724';
const AGENT_NAME = 'AI Culture Agent';
const AGENT_TITLE = 'Employee Engagement AI';
const AGENT_DESC = 'Measures engagement, runs pulse surveys, plans team events, and monitors culture health.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '91.4%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Launched monthly pulse survey",
        "time": "8m ago"
    },
    {
        "action": "Analyzed engagement scores",
        "time": "25m ago"
    },
    {
        "action": "Planned Q4 team offsite event",
        "time": "40m ago"
    },
    {
        "action": "Recognized 5 top performers",
        "time": "1h ago"
    },
    {
        "action": "Generated culture health report",
        "time": "2h ago"
    }
];
