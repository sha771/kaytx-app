...
export default function TrainingEffectivenessEvaluatorPage() {
  const agent = {
    id: 'training-effectiveness-evaluator',
    name: 'AI Training Effectiveness Evaluator',
    title: 'Hr Agent',
    description: 'Automated Training Effectiveness Evaluator agent specializing in hr operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Training Effectiveness Evaluator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
