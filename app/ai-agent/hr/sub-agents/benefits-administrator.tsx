...
export default function BenefitsAdministratorPage() {
  const agent = {
    ...
    title: 'Hr Agent',
    description: 'Automated Benefits Administrator agent specializing in hr operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
