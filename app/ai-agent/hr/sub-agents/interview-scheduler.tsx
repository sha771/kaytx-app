...
export default function InterviewSchedulerPage() {
  const agent = {
    ...
    title: 'Hr Agent',
    description: 'Automated Interview Scheduler agent specializing in hr operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
