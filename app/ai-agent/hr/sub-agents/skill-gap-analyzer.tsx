...
export default function SkillGapAnalyzerPage() {
  const agent = {
    ...
    title: 'Hr Agent',
    description: 'Automated Skill Gap Analyzer agent specializing in hr operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Skill Gap Analyzer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
