...
export default function MarketCompensationResearcherPage() {
  const agent = {
    id: 'market-compensation-researcher',
    name: 'AI Market Compensation Researcher',
    title: 'Hr Agent',
    description: 'Automated Market Compensation Researcher agent specializing in hr operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Market Compensation Researcher',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
