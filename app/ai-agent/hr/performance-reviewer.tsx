...
const ACCENT = '#BE185D';
const AGENT_NAME = 'AI Performance Reviewer';
const AGENT_TITLE = 'Performance Intelligence AI';
const AGENT_DESC = 'Runs continuous performance cycles with 360 feedback, goal tracking, and development plans.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '92.8%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Generated 15 performance reports",
        "time": "10m ago"
    },
    {
        "action": "Tracked 89 OKR updates",
        "time": "25m ago"
    },
    {
        "action": "Collected 360 feedback responses",
        "time": "45m ago"
    },
    {
        "action": "Created development plans",
        "time": "1h ago"
    },
    {
        "action": "Flagged underperformance alert",
        "time": "2h ago"
    }
];
