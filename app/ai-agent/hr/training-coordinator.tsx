...
const ACCENT = '#831843';
const AGENT_NAME = 'AI Training Coordinator';
const AGENT_TITLE = 'L&D Management AI';
const AGENT_DESC = 'Designs personalized learning paths, tracks certifications, and analyzes skill development ROI.';
const PARENT_NAME = 'Human Resources AI';

const METRICS = [
  { label: 'Tasks Today', value: '15', color: ACCENT },
  { label: 'Success Rate', value: '90%', color: '#00C853' },
  { label: 'Avg Speed', value: '2.8s', color: '#007AFF' },
  { label: 'Accuracy', value: '90.6%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Created 3 personalized learning paths",
        "time": "20m ago"
    },
    {
        "action": "Identified skill gaps in Tech team",
        "time": "40m ago"
    },
    {
        "action": "Assigned 5 new certifications",
        "time": "1h ago"
    },
    {
        "action": "Calculated L&D ROI report",
        "time": "2h ago"
    },
    {
        "action": "Enrolled team in leadership course",
        "time": "3h ago"
    }
];
