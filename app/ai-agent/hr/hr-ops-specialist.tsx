...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'4354',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.5s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.8%',icon:Target,color:'#880E4F'}];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#880E4F20' }]}><Settings size={48} color="#880E4F" /></View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>HR Operations Specialist</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>The HR Operations Specialist AI executes specialized tasks, automates workflows, and delivers consistent high-quality performance within the Human Resources department.</Text></View>
      ...
      <AgentFeatures agentId="hr-ops-specialist" agentName="HR Operations Specialist" />
    </ScrollView>
  );
}
