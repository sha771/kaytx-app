...
const ACCENT = '#9D174D';
const AGENT_NAME = 'AI Benefits Manager';
const AGENT_TITLE = 'Benefits & Wellness AI';
const AGENT_DESC = 'Manages benefits enrollment, plan comparison, wellness programs, and claims processing.';
...
const RECENT_TASKS = [
    {
        "action": "Processed 12 benefit enrollments",
        "time": "15m ago"
    },
    {
        "action": "Updated health plan options",
        "time": "40m ago"
    },
    {
        "action": "Launched Q4 wellness challenge",
        "time": "1h ago"
    },
    {
        "action": "Processed 8 FSA claims",
        "time": "2h ago"
    },
    {
        "action": "Generated benefits utilization report",
        "time": "3h ago"
    }
];
