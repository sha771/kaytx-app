...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'243',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.7s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.5%',icon:Target,color:'#880E4F'}];
  const capabilities = ['Labor Law Compliance','Policy Enforcement','Risk Mitigation'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI HR Compliance</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Ensures HR practices comply with labor laws and company policies.</Text></View>
      ...
      <AgentFeatures agentId="hr-compliance" agentName="AI HR Compliance" />
    </ScrollView>
  );
}
