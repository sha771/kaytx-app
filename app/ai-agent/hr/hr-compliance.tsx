...
const ACCENT = '#EC4899';
const AGENT_NAME = 'AI HR Compliance';
const AGENT_TITLE = 'Labor Law Compliance AI';
const AGENT_DESC = 'Monitors labor laws, manages policy updates, and prepares audit-ready HR documentation.';
...
const RECENT_TASKS = [
    {
        "action": "Updated FMLA compliance tracking",
        "time": "1h ago"
    },
    {
        "action": "Distributed new handbook policy",
        "time": "3h ago"
    },
    {
        "action": "Prepared HR audit documentation",
        "time": "5h ago"
    },
    {
        "action": "Monitored ADA compliance",
        "time": "6h ago"
    },
    {
        "action": "Reviewed termination checklist",
        "time": "8h ago"
    }
];
