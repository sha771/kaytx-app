...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'205',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.3%',icon:Target,color:'#880E4F'}];
  const capabilities = ['Recruitment Automation','Candidate Screening','Hiring Workflow Management'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Automates recruitment processes, screens candidates, and manages hiring workflows.</Text></View>
      ...
      <AgentFeatures agentId="recruiter" agentName="AI Recruiter" />
    </ScrollView>
  );
}
