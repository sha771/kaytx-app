...
const AGENT_TITLE = 'Talent Acquisition AI';
const AGENT_DESC = 'Sources, screens, and manages candidates end-to-end from job posting to offer letter.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '94.7%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Screened 45 resumes for Eng role",
        "time": "2m ago"
    },
    {
        "action": "Scheduled 12 technical interviews",
        "time": "15m ago"
    },
    {
        "action": "Sourced 30 candidates via LinkedIn",
        "time": "30m ago"
    },
    {
        "action": "Sent offer letter to candidate",
        "time": "1h ago"
    },
    {
        "action": "Updated ATS pipeline status",
        "time": "2h ago"
    }
];
