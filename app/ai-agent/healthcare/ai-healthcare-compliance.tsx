...
export default function AiHealthcareCompliancePage() {
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={styles.statsContainer}>
        {[
          ...
          {label:'Dept',value:'Ai Healthcare Compliance',icon: Users, color: '#007AFF'}
        ].map((stat,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Healthcare Compliance - Healthcare Compliance level AI agent in the ai healthcare compliance department. Part of the Kaytx AI Workforce hierarchy providing automated healthcare compliance capabilities.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['Healthcare Compliance','Automation','AI-Powered','Real-time','Analytics','Integration'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/ai-healthcare-compliance', '/ai/execute', '/ai/analyze'].map((endpoint,index)=>(
      ...
      <AgentFeatures agentId="ai-healthcare-compliance" agentName="AI Healthcare Compliance" />
