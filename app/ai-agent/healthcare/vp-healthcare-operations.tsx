...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'1,389',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.9s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.4%',icon:Target,color:'#B71C1C'}];
  ...
  const activities = [{time:'3 min ago',text:'Approved Q3 operational budget',icon:CheckCircle2},{time:'6 min ago',text:'Reviewed facility compliance reports',icon:Clock},{time:'9 min ago',text:'Led performance improvement initiative',icon:Zap}];
  return (
