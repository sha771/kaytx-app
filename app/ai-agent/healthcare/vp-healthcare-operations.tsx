...
import {
  Settings, Activity, Star, Users, CircleCheckBig, Clock, Target, ArrowRight, ChartBarBig, TrendingUp, ChevronRight, MessageSquare, AlertTriangle, FileText, ShieldCheck, Zap, Calendar
...
const SUB_AGENTS = [
  {
    ...
    "icon": Zap,
    "desc": "Optimizes clinical and administrative workflows for efficiency"
  },
  {
    "id": "staff-scheduler",
    "name": "AI Staff Scheduler",
    "icon": Calendar,
    "desc": "Manages staff scheduling, shifts, and resource allocation"
  },
  {
    "id": "regulatory-compliance-monitor",
    "name": "AI Regulatory Compliance Monitor",
    "icon": ShieldCheck,
    "desc": "Monitors regulatory compliance and audit readiness"
  }
];
...
export default function VpHealthcareOperationsPage() {
  ...
  "Healthcare operations strategy development and execution oversight",
  "Workflow optimization and process improvement across clinical operations",
  "Staff scheduling, resource allocation, and capacity planning management",
  "Regulatory compliance monitoring and audit readiness coordination",
  "Performance management and operational KPI tracking and reporting",
  "Budget oversight and financial performance management for operations",
  "Vendor management and service level agreement enforcement",
  "Data analytics and operational intelligence for decision support",
  "Cross-departmental coordination and operational alignment"
];

  const activities = [
  {
    "time": "3 min ago",
    "text": "Optimized emergency department workflow",
    "icon": Settings
  },
  {
    "time": "6 min ago",
    "text": "Reviewed staff scheduling for next quarter",
    "icon": Calendar
  },
  {
    "time": "9 min ago",
    "text": "Completed regulatory compliance audit",
    "icon": ShieldCheck
  },
  {
    "time": "15 min ago",
    "text": "Allocated resources for new outpatient clinic",
    "icon": Users
  },
  {
    "time": "32 min ago",
    "text": "Presented operational efficiency report",
    "icon": ChartBarBig
  }
];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#B71C1C20' }]}>
          <Settings size={48} color="#B71C1C" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI VP Healthcare Operations</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Operational Excellence & Workflow Optimization</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI VP Healthcare Operations leads operational strategy, workflow optimization, and performance management across the Healthcare division. It orchestrates sub-agents for workflow optimization, staff scheduling, and regulatory compliance monitoring.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Direct reports and specialized sub-agents executing vp healthcare operations functions.
        </Text>
      ...
      <AgentFeatures agentId="vp-healthcare-operations" agentName="AI VP Healthcare Operations" />
