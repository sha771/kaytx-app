...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'1,205',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'100.0%',icon:Target,color:'#B71C1C'}];
  ...
  const activities = [{time:'3 min ago',text:'Scheduled 75 appointments',icon:CheckCircle2},{time:'6 min ago',text:'Registered 34 new patients',icon:Clock},{time:'9 min ago',text:'Followed up with 45 patients',icon:Zap}];
  return (
