...
export default function StaffSchedulerPage() {
  const agent = {
    ...
    description: 'Automated Staff Scheduler agent specializing in healthcare operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
