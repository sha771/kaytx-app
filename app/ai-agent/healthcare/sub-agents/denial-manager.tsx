...
export default function DenialManagerPage() {
  const agent = {
    ...
    description: 'Automated Denial Manager agent specializing in healthcare operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
