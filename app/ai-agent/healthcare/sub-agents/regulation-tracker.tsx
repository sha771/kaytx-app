...
export default function RegulationTrackerPage() {
  const agent = {
    ...
    description: 'Automated Regulation Tracker agent specializing in healthcare operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Regulation Tracker',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
