...
export default function ChargeCaptureAgentPage() {
  const agent = {
    ...
    description: 'Automated Charge Capture Agent agent specializing in healthcare operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Charge Capture Agent',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
