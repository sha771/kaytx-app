...
export default function ReferralProcessorPage() {
  const agent = {
    ...
    description: 'Automated Referral Processor agent specializing in healthcare operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Referral Processor',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
