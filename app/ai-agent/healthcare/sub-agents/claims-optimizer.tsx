...
export default function ClaimsOptimizerPage() {
  const agent = {
    ...
    description: 'Automated Claims Optimizer agent specializing in healthcare operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
