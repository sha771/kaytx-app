...
export default function BalanceCollectorPage() {
  const agent = {
    ...
    description: 'Automated Balance Collector agent specializing in healthcare operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Balance Collector',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
