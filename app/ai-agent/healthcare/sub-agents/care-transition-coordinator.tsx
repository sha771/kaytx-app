...
import {
  GitMerge, Activity, Briefcase, Heart, ArrowRight, Zap, Target, Clock
} from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

export default function CareTransitionCoordinatorPage() {
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#EF444420' }]}>
          <GitMerge size={56} color="#EF4444" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Care Transition Coordinator"}</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Care Transition Coordinator - Sub-agent supporting AI Patient Coordinator. Coordinates care transitions across settings and providers for continuity of care
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {["Care Transitions","Continuity Coordination","AI-Powered","Real-time","Analytics","Automation"].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {["/consult/care-transition-coordinator","/care-transition-coordinator/execute","/care-transition-coordinator/coordinate"].map((endpoint,index)=>(
      ...
      <AgentFeatures agentId="care-transition-coordinator" agentName="AI Care Transition Coordinator" />
