...
export default function PreAuthorizationAgentPage() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Pre-Authorization Agent"}</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Pre-Authorization Agent - Sub-agent supporting AI Patient Coordinator. Manages insurance pre-authorizations and approval tracking for procedure coverage
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {["Pre-Authorization","Insurance Tracking","AI-Powered","Real-time","Analytics","Automation"].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {["/consult/pre-authorization-agent","/pre-authorization-agent/execute","/pre-authorization-agent/authorize"].map((endpoint,index)=>(
      ...
      <AgentFeatures agentId="pre-authorization-agent" agentName="AI Pre-Authorization Agent" />
