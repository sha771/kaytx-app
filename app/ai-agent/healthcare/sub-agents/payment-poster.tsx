...
export default function PaymentPosterPage() {
  const agent = {
    ...
    description: 'Automated Payment Poster agent specializing in healthcare operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
