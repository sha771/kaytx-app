...
export default function ComplianceTrainingCoordinatorPage() {
  const agent = {
    id: 'compliance-training-coordinator',
    name: 'AI Compliance Training Coordinator',
    title: 'Healthcare Agent',
    description: 'Automated Compliance Training Coordinator agent specializing in healthcare operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Compliance Training Coordinator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
