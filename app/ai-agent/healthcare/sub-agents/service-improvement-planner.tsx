...
export default function ServiceImprovementPlannerPage() {
  const agent = {
    ...
    description: 'Automated Service Improvement Planner agent specializing in healthcare operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Service Improvement Planner',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
