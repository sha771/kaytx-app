...
export default function AiBillingSpecialistPage() {
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={styles.statsContainer}>
        {[
          ...
          {label:'Dept',value:'Ai Billing Specialist',icon: Users, color: '#007AFF'}
        ].map((stat,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Billing Specialist - Billing Specialist level AI agent in the ai billing specialist department. Part of the Kaytx AI Workforce hierarchy providing automated billing specialist capabilities.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['Billing Specialist','Automation','AI-Powered','Real-time','Analytics','Integration'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/ai-billing-specialist', '/ai/execute', '/ai/analyze'].map((endpoint,index)=>(
      ...
      <AgentFeatures agentId="ai-billing-specialist" agentName="AI Billing Specialist" />
