...
export default function AiCareCoordinatorPage() {
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={styles.statsContainer}>
        {[
          ...
          {label:'Dept',value:'Ai Care Coordinator',icon: Users, color: '#007AFF'}
        ].map((stat,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Care Coordinator - Care Coordinator level AI agent in the ai care coordinator department. Part of the Kaytx AI Workforce hierarchy providing automated care coordinator capabilities.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['Care Coordinator','Automation','AI-Powered','Real-time','Analytics','Integration'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/ai-care-coordinator', '/ai/execute', '/ai/analyze'].map((endpoint,index)=>(
      ...
      <AgentFeatures agentId="ai-care-coordinator" agentName="AI Care Coordinator" />
