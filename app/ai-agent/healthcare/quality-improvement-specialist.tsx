...
import {
  TrendingUp, Activity, Star, Users, CircleCheckBig, Clock, Target, ArrowRight, ChartBarBig, ChevronRight, MessageSquare, AlertTriangle, FileText, ShieldCheck, Zap, BarChart3, Search
...
const SUB_AGENTS = [
  {
    ...
    "icon": BarChart3,
    "desc": "Analyzes quality metrics and performance indicators"
  },
  {
    "id": "improvement-planner",
    "name": "AI Improvement Planner",
    "icon": Zap,
    "desc": "Plans and implements quality improvement initiatives"
  },
  {
    "id": "benchmark-reporter",
    "name": "AI Benchmark Reporter",
    "icon": TrendingUp,
    "desc": "Reports benchmark comparisons against industry standards"
  }
];
...
export default function QualityImprovementSpecialistPage() {
  ...
  "Quality metric analysis and performance indicator monitoring and reporting",
  "Improvement planning and quality initiative development and implementation",
  "Benchmark reporting and industry standard comparison analysis",
  "Quality indicator development and organizational performance tracking",
  "PDSA cycle management and improvement project execution oversight",
  "Root cause analysis and systemic quality issue identification and resolution",
  "Data analytics and quality intelligence for decision support",
  "Performance tracking and trend analysis for quality outcomes",
  "Best practice identification, Lean methodology, and Six Sigma application"
];

  const activities = [
  {
    "time": "3 min ago",
    "text": "Analyzed quality metrics for surgical department",
    "icon": TrendingUp
  },
  {
    "time": "6 min ago",
    "text": "Developed improvement plan for ED wait times",
    "icon": ChartBarBig
  },
  {
    "time": "9 min ago",
    "text": "Published benchmark report against national standards",
    "icon": FileText
  },
  {
    "time": "15 min ago",
    "text": "Completed root cause analysis for medication error",
    "icon": Search
  },
  {
    "time": "32 min ago",
    "text": "Launched PDSA cycle for infection rate reduction",
    "icon": Zap
  }
];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#B71C1C20' }]}>
          <TrendingUp size={48} color="#B71C1C" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Quality Improvement Specialist</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Metric Analysis & Benchmark Reporting</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Quality Improvement Specialist manages metric analysis, improvement planning, and benchmark reporting across the Healthcare division. It orchestrates sub-agents for metric analysis, improvement planning, and benchmark reporting.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Direct reports and specialized sub-agents executing quality improvement specialist functions.
        </Text>
      ...
      <AgentFeatures agentId="quality-improvement-specialist" agentName="AI Quality Improvement Specialist" />
