...
import {
  Code, Activity, Star, Users, CircleCheckBig, Clock, Target, ArrowRight, ChartBarBig, TrendingUp, ChevronRight, MessageSquare, AlertTriangle, FileText, ShieldCheck, Zap, RefreshCw
...
const SUB_AGENTS = [
  {
    ...
    "icon": Code,
    "desc": "Assigns accurate ICD-10, CPT, and HCPCS codes to clinical encounters"
  },
  {
    "id": "coding-compliance-auditor",
    "name": "AI Coding Compliance Auditor",
    "icon": ShieldCheck,
    "desc": "Audits coding compliance and identifies regulatory adherence issues"
  },
  {
    "id": "coding-update-tracker",
    "name": "AI Coding Update Tracker",
    "icon": RefreshCw,
    "desc": "Tracks coding regulatory updates and implements changes"
  }
];
...
export default function MedicalCoderPage() {
  ...
  "ICD-10, CPT, and HCPCS code assignment and accuracy assurance",
  "Coding compliance auditing and regulatory adherence monitoring",
  "Coding update tracking and regulatory change implementation",
  "DRG assignment optimization and accuracy verification",
  "Modifier management and coding specificity improvement",
  "Coding analytics and performance benchmarking",
  "Clinical documentation review and query management",
  "Coding team training and education program coordination",
  "Revenue impact analysis and coding optimization strategies"
];

  const activities = [
  {
    "time": "3 min ago",
    "text": "Assigned ICD-10 codes for 42 encounters",
    "icon": Code
  },
  {
    "time": "6 min ago",
    "text": "Completed coding compliance audit for cardiology",
    "icon": ShieldCheck
  },
  {
    "time": "9 min ago",
    "text": "Tracked new ICD-10 updates for Q4 implementation",
    "icon": FileText
  },
  {
    "time": "15 min ago",
    "text": "Resolved 8 coding queries from physicians",
    "icon": MessageSquare
  },
  {
    "time": "32 min ago",
    "text": "Optimized DRG assignment accuracy by 2%",
    "icon": TrendingUp
  }
];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#B71C1C20' }]}>
          <Code size={48} color="#B71C1C" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Medical Coder</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Code Assignment & Coding Compliance</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Medical Coder manages code assignment, coding compliance auditing, and coding update tracking across the Healthcare division. It orchestrates sub-agents for code assignment, coding compliance auditing, and coding update tracking.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Direct reports and specialized sub-agents executing medical coder functions.
        </Text>
      ...
      <AgentFeatures agentId="medical-coder" agentName="AI Medical Coder" />
