...
import {
  Monitor, Activity, Star, Users, CircleCheckBig, Clock, Target, ArrowRight, ChartBarBig, TrendingUp, ChevronRight, MessageSquare, AlertTriangle, FileText, ShieldCheck, Zap, Video, Wrench
} from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

const SUB_AGENTS = [
  {
    "id": "virtual-visit-facilitator",
    "name": "AI Virtual Visit Facilitator",
    "icon": Video,
    "desc": "Facilitates and manages virtual visit sessions end-to-end"
  },
  {
    "id": "tech-troubleshooter",
    "name": "AI Tech Troubleshooter",
    "icon": Wrench,
    "desc": "Troubleshoots technical issues for telehealth participants"
  },
  {
    "id": "remote-monitor",
    "name": "AI Remote Monitor",
    "icon": Activity,
    "desc": "Monitors remote patient data and manages clinical alerts"
  }
];
...
export default function TelehealthSupportPage() {
  ...
  "Virtual visit facilitation and telehealth session management",
  "Technical troubleshooting for patients and providers during virtual visits",
  "Remote patient monitoring data collection and alert management",
  "Video integration and telehealth platform optimization",
  "Patient onboarding and digital literacy support for telehealth",
  "Connected device management and data streaming coordination",
  "Clinical alert management and escalation for remote monitoring",
  "Telehealth security, privacy, and compliance oversight",
  "Telehealth analytics and performance reporting"
];

  const activities = [
  {
    "time": "3 min ago",
    "text": "Facilitated 24 virtual visit sessions",
    "icon": Monitor
  },
  {
    "time": "6 min ago",
    "text": "Resolved 8 technical issues for patients",
    "icon": Wrench
  },
  {
    "time": "9 min ago",
    "text": "Monitored remote vitals for 142 patients",
    "icon": Activity
  },
  {
    "time": "15 min ago",
    "text": "Escalated 2 clinical alerts from remote monitoring",
    "icon": AlertTriangle
  },
  {
    "time": "32 min ago",
    "text": "Onboarded 12 new patients to telehealth platform",
    "icon": Users
  }
];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#B71C1C20' }]}>
          <Monitor size={48} color="#B71C1C" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Telehealth Support</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Virtual Visits & Remote Monitoring</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Telehealth Support manages virtual visit facilitation, technical troubleshooting, and remote patient monitoring across the Healthcare division. It orchestrates sub-agents for virtual visit facilitation, tech troubleshooting, and remote monitoring.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Direct reports and specialized sub-agents executing telehealth support functions.
        </Text>
      ...
      <AgentFeatures agentId="telehealth-support" agentName="AI Telehealth Support" />
