...
import { HeartPulse, Activity, CircleCheckBig, Clock, Target, ChartBar, MessageSquare, Calendar, Shield, ArrowRight, Users, Zap, Star, ChartBar } from 'lucide-react-native';
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={styles.statsContainer}>
        {[{label:'Patients',value:'12,847',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.98%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.8s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.9%',icon:Target,color:'#AF52DE'}].map((stat,index)=>(
