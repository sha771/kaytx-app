...
import {
  FolderOpen, Activity, Star, Users, CircleCheckBig, Clock, Target, ArrowRight, ChartBarBig, TrendingUp, ChevronRight, MessageSquare, AlertTriangle, FileText, ShieldCheck, Zap, Lock
...
const SUB_AGENTS = [
  {
    ...
    "icon": FolderOpen,
    "desc": "Organizes and maintains health record systems and filing"
  },
  {
    "id": "release-manager",
    "name": "AI Release Manager",
    "icon": FileText,
    "desc": "Manages release of information and HIPAA compliance"
  },
  {
    "id": "data-integrity-checker",
    "name": "AI Data Integrity Checker",
    "icon": ShieldCheck,
    "desc": "Checks and ensures data integrity across health information systems"
  }
];
...
export default function HealthRecordsSpecialistPage() {
  ...
  "Health record organization, maintenance, and lifecycle management",
  "Release of information management and HIPAA compliance oversight",
  "Data integrity checking and quality assurance across health information systems",
  "EHR management and electronic health record system optimization",
  "Document scanning, indexing, and digital records management",
  "Record retrieval and timely information access for clinical teams",
  "Patient authentication and identity verification for record access",
  "Record retention policy management and compliance monitoring",
  ...
  {
    "time": "3 min ago",
    "text": "Organized 124 patient records for cardiology",
    "icon": FolderOpen
  },
  {
    "time": "6 min ago",
    "text": "Processed 18 release of information requests",
    "icon": FileText
  },
  {
    "time": "9 min ago",
    "text": "Completed data integrity check for radiology",
    "icon": ShieldCheck
  },
  {
    "time": "15 min ago",
    "text": "Updated record retention policies for 2024",
    "icon": Clock
  },
  {
    "time": "32 min ago",
    "text": "Resolved 4 record access authentication issues",
    "icon": Lock
  }
];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#B71C1C20' }]}>
          <FolderOpen size={48} color="#B71C1C" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Health Records Specialist</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Record Management & Data Integrity</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Health Records Specialist manages health record organization, release management, and data integrity checking across the Healthcare division. It orchestrates sub-agents for record organization, release management, and data integrity checking.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Direct reports and specialized sub-agents executing health records specialist functions.
        </Text>
      ...
      <AgentFeatures agentId="health-records-specialist" agentName="AI Health Records Specialist" />
