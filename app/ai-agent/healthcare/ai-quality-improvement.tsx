...
export default function AiQualityImprovementPage() {
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#EF444420' }]}>
          <Briefcase size={56} color="#EF4444" />
        </View>
      ...
      <View style={styles.statsContainer}>
        {[
          ...
          {label:'Dept',value:'Ai Quality Improvement',icon: Users, color: '#007AFF'}
        ].map((stat,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Quality Improvement Specialist - Quality Improvement level AI agent in the ai quality improvement department. Part of the Kaytx AI Workforce hierarchy providing automated quality improvement capabilities.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['Quality Improvement','Automation','AI-Powered','Real-time','Analytics','Integration'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/ai-quality-improvement', '/ai/execute', '/ai/analyze'].map((endpoint,index)=>(
      ...
      <AgentFeatures agentId="ai-quality-improvement" agentName="AI Quality Improvement Specialist" />
