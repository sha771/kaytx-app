...
export default function MarketingManagerPage() {
  const agent = {
    ...
    description: 'The AI Marketing Manager executes marketing campaigns, coordinates marketing activities, and manages marketing performance for fashion and luxury brands.',
    capabilities: ["Marketing Management","Campaign Execution","Marketing Coordination","Performance Tracking","Budget Management","Marketing Analytics","Team Coordination","Campaign Reporting","Marketing Strategy","Brand Marketing"],
    icon: Megaphone,
    color: '#FF5722',
    ...
    intelligenceFeatures: [
      { id: 'marketing', enabled: true, name: 'Marketing Manager', description: 'Manages marketing activities' },
      { id: 'campaign', enabled: true, name: 'Campaign Coordinator', description: 'Coordinates campaigns' },
      { id: 'performance', enabled: true, name: 'Performance Tracker', description: 'Tracks marketing performance' }
    ],
    agentType: 'learning',
    skills: [
