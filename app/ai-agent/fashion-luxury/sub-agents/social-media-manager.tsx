...
export default function SocialMediaManagerPage() {
  const agent = {
    ...
    description: 'The AI Social Media Manager manages social media presence, creates social content, and engages with audiences across social platforms for fashion and luxury brands.',
    ...
    agentType: 'learning',
    skills: [
      { id: 'social_1', name: 'Social Media Management', category: 'Social', description: 'Manage social media', level: 'expert' },
      { id: 'social_2', name: 'Content Creation', category: 'Content', description: 'Create social content', level: 'expert' },
      { id: 'social_3', name: 'Community Management', category: 'Community', description: 'Manage community', level: 'expert' },
      { id: 'social_4', name: 'Social Analytics', category: 'Analytics', description: 'Analyze social performance', level: 'expert' },
      { id: 'social_5', name: 'Social Strategy', category: 'Strategy', description: 'Develop social strategy', level: 'expert' }
    ],
    personality: [
