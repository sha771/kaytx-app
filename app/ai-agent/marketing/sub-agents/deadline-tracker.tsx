...
export default function DeadlineTrackerPage() {
  const agent = {
    ...
    description: 'Automated Deadline Tracker agent specializing in marketing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
