...
export default function BrandHealthSurveyorPage() {
  const agent = {
    id: 'brand-health-surveyor',
    name: 'AI Brand Health Surveyor',
    title: 'Marketing Agent',
    description: 'Automated Brand Health Surveyor agent specializing in marketing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Brand Health Surveyor',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
