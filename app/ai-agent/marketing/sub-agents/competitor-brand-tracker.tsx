...
export default function CompetitorBrandTrackerPage() {
  const agent = {
    id: 'competitor-brand-tracker',
    name: 'AI Competitor Brand Tracker',
    title: 'Marketing Agent',
    description: 'Automated Competitor Brand Tracker agent specializing in marketing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Competitor Brand Tracker',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
