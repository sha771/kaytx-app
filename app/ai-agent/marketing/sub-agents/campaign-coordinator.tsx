...
export default function CampaignCoordinatorPage() {
  const agent = {
    ...
    description: 'Automated Campaign Coordinator agent specializing in marketing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Campaign Coordinator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
