...
export default function CreativeTesterPage() {
  const agent = {
    ...
    description: 'Automated Creative Tester agent specializing in marketing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
