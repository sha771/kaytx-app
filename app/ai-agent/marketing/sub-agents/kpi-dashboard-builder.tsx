...
export default function KpiDashboardBuilderPage() {
  const agent = {
    ...
    description: 'Automated Kpi Dashboard Builder agent specializing in marketing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
