...
export default function CampaignRoiEvaluatorPage() {
  const agent = {
    id: 'campaign-roi-evaluator',
    name: 'AI Campaign Roi Evaluator',
    title: 'Marketing Agent',
    description: 'Automated Campaign Roi Evaluator agent specializing in marketing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Campaign Roi Evaluator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
