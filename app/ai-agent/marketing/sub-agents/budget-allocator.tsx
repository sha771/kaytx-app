...
export default function BudgetAllocatorPage() {
  const agent = {
    ...
    description: 'Automated Budget Allocator agent specializing in marketing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
