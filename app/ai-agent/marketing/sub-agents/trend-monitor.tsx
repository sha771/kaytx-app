...
export default function TrendMonitorPage() {
  const agent = {
    ...
    description: 'Automated Trend Monitor agent specializing in marketing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
