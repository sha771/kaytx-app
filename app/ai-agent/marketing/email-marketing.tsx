...
const ACCENT = '#FF375F';
const AGENT_NAME = 'AI Email Marketing';
const AGENT_TITLE = 'Email Nurture AI';
const AGENT_DESC = 'Builds logic-driven email sequences, personalizes content, and optimizes send times for maximum open rates.';
const PARENT_NAME = 'Marketing & Growth AI';

const METRICS = [
  { label: 'Tasks Today', value: '1.2M', color: ACCENT },
  { label: 'Success Rate', value: '99%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.1s', color: '#007AFF' },
  { label: 'Accuracy', value: '99.5%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Sent 50k personalized newsletters",
        "time": "1m ago"
    },
    {
        "action": "Optimized send time for cohort B",
        "time": "15m ago"
    },
    {
        "action": "Triggered cart abandonment series",
        "time": "30m ago"
    },
    {
        "action": "A/B tested subject lines",
        "time": "1h ago"
    },
    {
        "action": "Cleaned 2,500 bounced emails",
        "time": "4h ago"
    }
];
