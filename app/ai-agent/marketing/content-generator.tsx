...
const ACCENT = '#FF3B30';
const AGENT_NAME = 'AI Content Generator';
const AGENT_TITLE = 'Content Creation AI';
const AGENT_DESC = 'Produces blog posts, whitepapers, social copy, and ad creatives tailored to your brand voice.';
const PARENT_NAME = 'Marketing & Growth AI';

const METRICS = [
  { label: 'Tasks Today', value: '134', color: ACCENT },
  { label: 'Success Rate', value: '94%', color: '#00C853' },
  { label: 'Avg Speed', value: '2.8s', color: '#007AFF' },
  { label: 'Accuracy', value: '94.6%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Drafted 3 SEO-optimized blog posts",
        "time": "12m ago"
    },
    {
        "action": "Generated 15 ad copy variations",
        "time": "30m ago"
    },
    {
        "action": "Created webinar promotional sequence",
        "time": "1h ago"
    },
    {
        "action": "Wrote newsletter for 50k subscribers",
        "time": "2h ago"
    },
    {
        "action": "Repurposed video into 5 social posts",
        "time": "4h ago"
    }
];
