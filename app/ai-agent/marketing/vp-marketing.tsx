...
export default function VPMarketingPage() {
  ...
  const capabilities = [
    'Brand Strategy', 'Campaign Planning', 'Content Strategy', 'SEO/SEM',
    'Social Media', 'Email Automation', 'Analytics', 'Growth Hacking'
  ];
  ...
  const responsibilities = [
    ...
    'SEO, SEM & Paid Media Optimization',
    'Social Media Strategy & Community',
    'Marketing Analytics & Attribution',
    'Growth Experiments & CRO',
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { backgroundColor: theme.colors.primary + '18' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: theme.colors.primary + '25' }]}>
          <Megaphone size={48} color={theme.colors.primary} />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>VP Marketing</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The VP Marketing AI leads marketing strategy, brand positioning, and growth initiatives across all channels. This agent orchestrates campaigns, optimizes spend, and drives demand generation to fuel revenue growth.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="vp-marketing" agentName="VP Marketing" />
    </ScrollView>
  );
}
