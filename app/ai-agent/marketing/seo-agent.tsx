...
const ACCENT = '#FF6482';
const AGENT_NAME = 'AI SEO Agent';
const AGENT_TITLE = 'Search Optimization AI';
const AGENT_DESC = 'Monitors rankings, conducts keyword research, audits technical SEO, and suggests content gaps.';
const PARENT_NAME = 'Marketing & Growth AI';

const METRICS = [
  { label: 'Tasks Today', value: '78', color: ACCENT },
  { label: 'Success Rate', value: '95%', color: '#00C853' },
  { label: 'Avg Speed', value: '3.2s', color: '#007AFF' },
  { label: 'Accuracy', value: '96.1%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Crawled 500 pages for 404 errors",
        "time": "10m ago"
    },
    {
        "action": "Identified 12 new keyword opportunities",
        "time": "45m ago"
    },
    {
        "action": "Updated meta tags across 50 posts",
        "time": "2h ago"
    },
    {
        "action": "Analyzed competitor backlink profile",
        "time": "3h ago"
    },
    {
        "action": "Generated weekly search visibility report",
        "time": "6h ago"
    }
];
