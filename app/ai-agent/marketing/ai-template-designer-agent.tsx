...
export default function AgentPage() {
  const agent = {
    id: 'ai-template-designer-agent',
    name: 'ai-template-designer-agent',
    title: 'ai-template-designer-agent',
    description: 'The ai-template-designer-agent AI provides specialized services and automation within its department.',
    ...
    replacesRole: 'ai-template-designer-agent',
    infrastructure: {
      status: 'online',
      health: 97,
      uptime: '99.9%',
