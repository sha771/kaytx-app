...
const ACCENT = '#FF453A';
const AGENT_NAME = 'AI Digital Marketer';
const AGENT_TITLE = 'Campaign Execution AI';
const AGENT_DESC = 'Executes and optimizes digital campaigns across Search, Social, and Display networks continuously.';
const PARENT_NAME = 'Marketing & Growth AI';

const METRICS = [
  { label: 'Tasks Today', value: '215', color: ACCENT },
  { label: 'Success Rate', value: '91%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.6s', color: '#007AFF' },
  { label: 'Accuracy', value: '92.4%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Adjusted bids for 150 keywords",
        "time": "3m ago"
    },
    {
        "action": "Paused 3 underperforming ad sets",
        "time": "18m ago"
    },
    {
        "action": "Launched holiday promo campaign",
        "time": "1h ago"
    },
    {
        "action": "Reallocated budget to top performer",
        "time": "2h ago"
    },
    {
        "action": "Generated weekly ROAS report",
        "time": "5h ago"
    }
];
