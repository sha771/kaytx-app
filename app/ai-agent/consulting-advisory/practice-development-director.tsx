...
export default function PracticeDevelopmentDirectorPage() {
  const agent = {
    id: 'practice-development-director',
    name: 'AI Practice Development Director',
    title: 'AI Practice Development Director',
    description: 'AI Practice Development Director provides specialized expertise and executes critical tasks for the Professional Services department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'practice-development-director',
    infrastructure: {
      status: 'online',
