...
export default function SolutionArchitectPage() {
  const agent = {
    ...
    description: 'Automated Solution Architect agent specializing in consulting operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
