...
export default function CustomerSuccessDirectorPage() {
  const agent = {
    id: 'customer-success-director',
    name: 'AI Customer Success Director',
    title: 'AI Customer Success Director',
    description: 'AI Customer Success Director provides specialized expertise and executes critical tasks for the Professional Services department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'customer-success-director',
    infrastructure: {
      status: 'online',
