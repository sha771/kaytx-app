...
export default function AgentPage() {
  const agent = {
    ...
    description: 'AI Integration Consultant - Integration Consultant level AI agent in the consulting advisory department. Part of the Kaytx AI Workforce hierarchy providing specialized consulting advisory capabilities.',
