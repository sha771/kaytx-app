...
export default function VPPracticeDevelopmentPage() {
  const agent = {
    id: 'vp-practice-development',
    name: 'AI VP Practice Development',
    title: 'AI VP Practice Development',
    description: 'AI VP Practice Development provides specialized expertise and executes critical tasks for the Professional Services department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'vp-practice-development',
    infrastructure: {
      status: 'online',
