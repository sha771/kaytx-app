...
export default function RemoteMonitoringSpecialistPage() {
  const agent = {
    id: 'remote-monitoring-specialist',
    name: 'AI Remote Monitoring Specialist',
    title: 'AI Remote Monitoring Specialist',
    description: 'AI Remote Monitoring Specialist provides specialized expertise and executes critical tasks for the Healthcare & Medical department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'remote-monitoring-specialist',
    infrastructure: {
      status: 'online',
