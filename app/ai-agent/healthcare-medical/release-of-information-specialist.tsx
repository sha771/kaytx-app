...
export default function ReleaseofInformationSpecialistPage() {
  const agent = {
    id: 'release-of-information-specialist',
    name: 'AI Release of Information Specialist',
    title: 'AI Release of Information Specialist',
    description: 'AI Release of Information Specialist provides specialized expertise and executes critical tasks for the Healthcare & Medical department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'release-of-information-specialist',
    infrastructure: {
      status: 'online',
