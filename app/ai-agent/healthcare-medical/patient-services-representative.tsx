...
export default function PatientServicesRepresentativePage() {
  const agent = {
    id: 'patient-services-representative',
    name: 'AI Patient Services Representative',
    title: 'AI Patient Services Representative',
    description: 'AI Patient Services Representative provides specialized expertise and executes critical tasks for the Healthcare & Medical department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'patient-services-representative',
    infrastructure: {
      status: 'online',
