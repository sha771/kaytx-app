...
export default function DenialManagementSpecialistPage() {
  const agent = {
    id: 'denial-management-specialist',
    name: 'AI Denial Management Specialist',
    title: 'AI Denial Management Specialist',
    description: 'AI Denial Management Specialist provides specialized expertise and executes critical tasks for the Healthcare & Medical department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'denial-management-specialist',
    infrastructure: {
      status: 'online',
