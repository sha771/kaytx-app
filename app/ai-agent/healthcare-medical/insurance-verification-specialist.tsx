...
export default function InsuranceVerificationSpecialistPage() {
  const agent = {
    id: 'insurance-verification-specialist',
    name: 'AI Insurance Verification Specialist',
    title: 'AI Insurance Verification Specialist',
    description: 'AI Insurance Verification Specialist provides specialized expertise and executes critical tasks for the Healthcare & Medical department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'insurance-verification-specialist',
    infrastructure: {
      status: 'online',
