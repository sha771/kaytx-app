...
export default function PatientExperienceCoordinatorPage() {
  const agent = {
    id: 'patient-experience-coordinator',
    name: 'AI Patient Experience Coordinator',
    title: 'AI Patient Experience Coordinator',
    description: 'AI Patient Experience Coordinator provides specialized expertise and executes critical tasks for the Healthcare & Medical department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'patient-experience-coordinator',
    infrastructure: {
      status: 'online',
