...
export default function ClinicalOperationsManagerPage() {
  const agent = {
    id: 'clinical-operations-manager',
    name: 'AI Clinical Operations Manager',
    title: 'AI Clinical Operations Manager',
    description: 'AI Clinical Operations Manager provides specialized expertise and executes critical tasks for the Healthcare & Medical department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'clinical-operations-manager',
    infrastructure: {
      status: 'online',
