...
export default function HealthInformationTechnicianPage() {
  const agent = {
    id: 'health-information-technician',
    name: 'AI Health Information Technician',
    title: 'AI Health Information Technician',
    description: 'AI Health Information Technician provides specialized expertise and executes critical tasks for the Healthcare & Medical department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'health-information-technician',
    infrastructure: {
      status: 'online',
