...
export default function ClinicalDocumentationImprovementSpecialistPage() {
  const agent = {
    id: 'clinical-documentation-improvement-specialist',
    name: 'AI Clinical Documentation Improvement Specialist',
    title: 'AI Clinical Documentation Improvement Specialist',
    ...
    replacesRole: 'clinical-documentation-improvement-specialist',
    infrastructure: {
      status: 'online',
