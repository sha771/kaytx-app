...
export default function SocialMediaManagementAIPage() {
  const agent = {
    id: 'social-media-management',
    name: 'AI Social Media Management',
    title: 'Social Media Management AI',
    description: 'The Social Media Management AI provides specialized services and automation within its department with full support for chat, analytics, performance tracking, capabilities, history, counseling, live monitoring, and comprehensive settings.',
    ...
    replacesRole: 'Social Media Management',
    ...
    hierarchy: { department: 'Marketing' },
