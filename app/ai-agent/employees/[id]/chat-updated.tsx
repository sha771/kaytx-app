...
// Custom Three-Line Icon Component with dots
const ThreeLineIcon = ({ size = 24, color = '#000' }: { size?: number; color?: string }) => (
  <View style={{ width: size, height: size, justifyContent: 'center', alignItems: 'center' }}>
    <View style={{ flexDirection: 'column', gap: 4 }}>
      {/* Line 1 with dot at end */}
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <View style={{ width: size * 0.6, height: 2, backgroundColor: color, borderRadius: 1 }} />
        <View style={{ width: 4, height: 4, backgroundColor: color, borderRadius: 2, marginLeft: 2 }} />
      </View>
      {/* Line 2 with dot at start */}
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <View style={{ width: 4, height: 4, backgroundColor: color, borderRadius: 2, marginRight: 2 }} />
        <View style={{ width: size * 0.6, height: 2, backgroundColor: color, borderRadius: 1 }} />
      </View>
      {/* Line 3 with dot at end */}
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <View style={{ width: size * 0.6, height: 2, backgroundColor: color, borderRadius: 1 }} />
        <View style={{ width: 4, height: 4, backgroundColor: color, borderRadius: 2, marginLeft: 2 }} />
      </View>
...
export default function AgentChatScreen() {
  ...
  const [showThreeLineMenu, setShowThreeLineMenu] = useState(false);
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={[styles.inputContainer, { backgroundColor: colors.card }]}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              setShowThreeLineMenu(false);
              setShowCodeMenu(false);
            }}
          >
            <View style={[styles.circularIconButton, { backgroundColor: '#3B82F6' }]}>
          ...
          <TouchableOpacity
            style={styles.iconButton}
            onPress={() => {
              setShowThreeLineMenu(!showThreeLineMenu);
              setShowPlusMenu(false);
              setShowCodeMenu(false);
            }}
          >
            <ThreeLineIcon size={24} color={colors.icon} />
          </TouchableOpacity>
          ...
          >
            <Code size={22} color={colors.icon} />
          </TouchableOpacity>
      ...
      >
        ...
        >
          <View style={[styles.popupMenu, { backgroundColor: '#1E1E1E', bottom: 80, left: 12 }]}>
            <Text style={[styles.popupTitle, { color: '#FFFFFF' }]}>Attachments</Text>
            <TouchableOpacity style={styles.popupItem}>
              <File size={20} color="#3B82F6" />
              <Text style={[styles.popupItemText, { color: '#FFFFFF' }]}>Files</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.popupItem}>
              <FileText size={20} color="#8B5CF6" />
              <Text style={[styles.popupItemText, { color: '#FFFFFF' }]}>Documents</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.popupItem}>
              <Camera size={20} color="#F59E0B" />
              <Text style={[styles.popupItemText, { color: '#FFFFFF' }]}>Camera</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.popupItem}>
              <Gallery size={20} color="#10B981" />
              <Text style={[styles.popupItemText, { color: '#FFFFFF' }]}>Gallery</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.popupItem}>
              <MoreHorizontal size={20} color="#6B7280" />
              <Text style={[styles.popupItemText, { color: '#FFFFFF' }]}>More</Text>
            </TouchableOpacity>
          </View>
        </TouchableOpacity>
      </Modal>

      {/* Three-Line Menu Popup */}
      <Modal
        visible={showThreeLineMenu}
        transparent
        animationType="fade"
        onRequestClose={() => setShowThreeLineMenu(false)}
      >
        <TouchableOpacity
          style={styles.modalOverlay}
          activeOpacity={1}
          onPress={() => setShowThreeLineMenu(false)}
        >
          <View style={[styles.popupMenu, { backgroundColor: '#1E1E1E', bottom: 80, left: 80 }]}>
            <Text style={[styles.popupTitle, { color: '#FFFFFF' }]}>Agent Modes</Text>
            <TouchableOpacity style={styles.popupItem}>
              <Network size={20} color="#3B82F6" />
              <Text style={[styles.popupItemText, { color: '#FFFFFF' }]}>Enterprise Agents</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.popupItem}>
              <Bot size={20} color="#8B5CF6" />
              <Text style={[styles.popupItemText, { color: '#FFFFFF' }]}>Single Agents</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.popupItem}>
              <Cpu size={20} color="#F59E0B" />
              <Text style={[styles.popupItemText, { color: '#FFFFFF' }]}>Simulation</Text>
            </TouchableOpacity>
          </View>
        </TouchableOpacity>
      </Modal>
      ...
      {/* Code Menu Popup */}
      <Modal
        visible={showCodeMenu}
        transparent
        animationType="fade"
        onRequestClose={() => setShowCodeMenu(false)}
      >
        <TouchableOpacity
          style={styles.modalOverlay}
          activeOpacity={1}
          onPress={() => setShowCodeMenu(false)}
        >
          <View style={[styles.popupMenu, { backgroundColor: '#1E1E1E', bottom: 80, left: 140 }]}>
            <Text style={[styles.popupTitle, { color: '#FFFFFF' }]}>Task Modes</Text>
            <TouchableOpacity style={styles.popupItem}>
              <Workflow size={20} color="#3B82F6" />
              <Text style={[styles.popupItemText, { color: '#FFFFFF' }]}>Complex Task</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.popupItem}>
              <Layers size={20} color="#8B5CF6" />
              <Text style={[styles.popupItemText, { color: '#FFFFFF' }]}>Sample Task</Text>
            </TouchableOpacity>
          </View>
        </TouchableOpacity>
      </Modal>
