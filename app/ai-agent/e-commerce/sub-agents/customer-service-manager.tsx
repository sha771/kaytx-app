...
export default function CustomerServiceManagerPage() {
  const agent = {
    ...
    description: 'The AI Customer Service Manager manages customer service operations, handles escalations, trains service teams, and ensures high customer satisfaction levels.',
    ...
    agentType: 'learning',
    skills: [
      { id: 'csm_1', name: 'Customer Service', category: 'Service', description: 'Manage customer service', level: 'expert' },
      { id: 'csm_2', name: 'Escalation Management', category: 'Resolution', description: 'Handle escalations', level: 'expert' },
      { id: 'csm_3', name: 'Team Training', category: 'Training', description: 'Train service teams', level: 'advanced' },
      { id: 'csm_4', name: 'Quality Assurance', category: 'Quality', description: 'Ensure service quality', level: 'expert' },
      { id: 'csm_5', name: 'Issue Resolution', category: 'Resolution', description: 'Resolve customer issues', level: 'expert' }
    ],
    personality: [
