...
const agents = [
  ...
  { id: 'api-developer', uid: 'ktx-06-api-developer', title: 'AI API Developer', route: '/ai-agent/technologynology/api-developer', color: '#1565C0', level: 'team_lead', efficiency: '82%' },
