...
export default function AiAccountExecutiveScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Strategic Negotiation","Deal Closing","Contract Structuring","Competitor Analysis","ROI Presentation","Relationship Building","Pipeline Forecasting","Enterprise Strategy","Legal Compliance","Closing Techniques"],
