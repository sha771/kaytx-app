...
export default function AiSalesCoachScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Interaction Analysis","Feedback Generation","Skill Assessment","Best Practice Mapping","Training Automation","Performance Tracking","Objection Library","Playbook Optimization","Soft Skill Coaching","Gamification Support"],
