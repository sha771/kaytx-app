...
export default function AgentPage() {
  const agent = {
    ...
    name: 'vp-sales',
    title: 'AI VP Sales',
    description: 'The AI VP Sales leads sales strategy, oversees revenue generation, manages sales operations, and drives sales team performance across all channels.',
    capabilities: ["Task Automation","Data Processing","Workflow Management","Sales Strategy","Revenue Management","Pipeline Oversight","Team Leadership","Forecasting","Deal Intelligence","Market Analysis"],
    icon: Briefcase,
    color: '#4CAF50',
    ...
    hierarchy: {
      ...
      level: 'executive',
      reportsTo: 'cro',
      manages: ['sales-ops-manager', 'sales-rep', 'sales-executive', 'crm-assistant', 'proposal-generator'],
    },
    ...
    intelligenceFeatures: [
      { id: 'predictive', enabled: true, name: 'Predictive Engine', description: 'Forecasts sales performance and revenue' },
      { id: 'anomaly', enabled: true, name: 'Anomaly Detector', description: 'Detects unusual sales patterns and risks' }
    ],
    agentType: 'learning',
    skills: [
      { id: 'sales_1', name: 'Lead Qualification', category: 'Operations', description: 'Qualify potential customers', level: 'expert' },
      { id: 'sales_3', name: 'CRM Management', category: 'Technical', description: 'Manage customer relationships', level: 'expert' },
      { id: 'sales_4', name: 'Proposal Generation', category: 'Content', description: 'Create sales proposals', level: 'expert' },
      { id: 'sales_5', name: 'Pipeline Analysis', category: 'Analytics', description: 'Analyze sales pipeline', level: 'expert' },
