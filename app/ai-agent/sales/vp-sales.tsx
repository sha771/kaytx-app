...
export default function VPSalesPage() {
  ...
  const responsibilities = [
    ...
    'Revenue Target Setting & Tracking',
    'Territory & Quota Design',
    'Competitive Intelligence & Positioning',
    'Pricing Strategy & Discount Approval',
    'Win-Loss Analysis & Deal Review'
  ];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { backgroundColor: theme.colors.primary + '18' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>VP Sales</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Sales & Revenue Department</Text>
        <View style={styles.badgesRow}>
          ...
          <View style={[styles.badge, { backgroundColor: '#FF950022' }]}>
            ...
            <Text style={[styles.badgeText, { color: '#FF9500' }]}>9 Reports</Text>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The VP Sales AI oversees all sales operations, strategy execution, and team performance to drive sustainable revenue growth. This agent optimizes pipeline velocity, improves win rates, and ensures accurate forecasting.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="vp-sales" agentName="VP Sales" />
    </ScrollView>
  );
}
