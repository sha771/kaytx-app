...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'5,423',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.3s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.0%',icon:Target,color:'#E65100'}];
  ...
  const activities = [{time:'3 min ago',text:'Published Q3 revenue forecast',icon:CheckCircle2},{time:'6 min ago',text:'Analyzed pipeline conversion rates',icon:Clock},{time:'9 min ago',text:'Improved forecast accuracy to 92%',icon:Zap}];
  return (
