  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#E6510020' }]}><Database size={48} color="#E65100" /></View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>Sales CRM</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Sales Operations</Text>
      ...
      <AgentFeatures agentId="sales-crm" agentName="Sales CRM" />
    </ScrollView>
  );
}
