...
export default function TrendAnalyzerPage() {
  const agent = {
    ...
    title: 'Sales Agent',
    description: 'Automated Trend Analyzer agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
