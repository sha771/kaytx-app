...
export default function DiscountApproverPage() {
  const agent = {
    ...
    title: 'Sales Agent',
    description: 'Automated Discount Approver agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Discount Approver',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
