...
export default function ObjectionHandlerPage() {
  const agent = {
    ...
    title: 'Sales Agent',
    description: 'Automated Objection Handler agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Objection Handler',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
