...
export default function CrmDataCleanerPage() {
  const agent = {
    ...
    title: 'Sales Agent',
    description: 'Automated Crm Data Cleaner agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
