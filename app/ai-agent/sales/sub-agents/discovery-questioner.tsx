...
export default function AIDiscoveryQuestionerPage() {
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#FF950020' }]}>
          <Target size={56} color="#FF9500" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI DiscoveryQuestioner</Text>
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={[styles.statCard, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
          ...
          <Text style={[styles.statValue, { color: theme.colors.text }]}>discovery</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          Automated discovery & qualification question flows for sales prospects. Sub-agent supporting AI Sales Rep. Part of the Kaytx AI Workforce hierarchy providing automated enterprise capabilities.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.endpointRow}>
          ...
          <Text style={[styles.endpointText, { color: theme.colors.textSecondary }]}>/consult/discovery-questioner</Text>
        </View>
        <View style={styles.endpointRow}>
          <Zap size={14} color="#8B5CF6" />
          <Text style={[styles.endpointText, { color: theme.colors.textSecondary }]}>/discovery-questioner/execute</Text>
        </View>
        <View style={styles.endpointRow}>
          <Zap size={14} color="#8B5CF6" />
          <Text style={[styles.endpointText, { color: theme.colors.textSecondary }]}>/discovery-questioner/analyze</Text>
        </View>
      </View>
      ...
      <AgentFeatures agentId="discovery-questioner" agentName="AI DiscoveryQuestioner" />
