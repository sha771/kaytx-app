...
export default function ClosingStrategistPage() {
  const agent = {
    id: 'closing-strategist',
    name: 'AI Closing Strategist',
    title: 'Sales Agent',
    description: 'Automated Closing Strategist agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Closing Strategist',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
