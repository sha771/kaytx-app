...
export default function PlaybookUpdaterPage() {
  const agent = {
    ...
    title: 'Sales Agent',
    description: 'Automated Playbook Updater agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
