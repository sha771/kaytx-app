...
export default function DemoCoordinatorPage() {
  const agent = {
    ...
    title: 'Sales Agent',
    description: 'Automated Demo Coordinator agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
