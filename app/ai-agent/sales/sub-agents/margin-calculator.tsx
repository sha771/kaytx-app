...
export default function MarginCalculatorPage() {
  const agent = {
    ...
    title: 'Sales Agent',
    description: 'Automated Margin Calculator agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Margin Calculator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
