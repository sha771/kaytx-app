...
export default function PartnershipScoutPage() {
  const agent = {
    ...
    title: 'Sales Agent',
    description: 'Automated Partnership Scout agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Partnership Scout',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
