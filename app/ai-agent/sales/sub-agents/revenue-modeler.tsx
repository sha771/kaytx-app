...
export default function RevenueModelerPage() {
  const agent = {
    ...
    title: 'Sales Agent',
    description: 'Automated Revenue Modeler agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
