...
export default function ForecastValidatorPage() {
  const agent = {
    ...
    title: 'Sales Agent',
    description: 'Automated Forecast Validator agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
