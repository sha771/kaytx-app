...
export default function TerritoryPlannerPage() {
  const agent = {
    ...
    title: 'Sales Agent',
    description: 'Automated Territory Planner agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Territory Planner',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
