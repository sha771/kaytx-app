...
import { Activity, TrendingUp, Target, Zap, ArrowRight, Briefcase, Settings, Users } from 'lucide-react-native';
import { useTheme } from '@/providers/ThemeProvider';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';
import { useRouter } from 'expo-router';

export default function AIStakeholderMapperPage() {
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#FF950020' }]}>
          <Users size={56} color="#FF9500" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI StakeholderMapper</Text>
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={[styles.statCard, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
          ...
          <Text style={[styles.statValue, { color: theme.colors.text }]}>stakeholder</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          Map decision-makers, influencers and champions in target accounts. Sub-agent supporting AI Sales Executive. Part of the Kaytx AI Workforce hierarchy providing automated enterprise capabilities.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.endpointRow}>
          ...
          <Text style={[styles.endpointText, { color: theme.colors.textSecondary }]}>/consult/stakeholder-mapper</Text>
        </View>
        <View style={styles.endpointRow}>
          <Zap size={14} color="#8B5CF6" />
          <Text style={[styles.endpointText, { color: theme.colors.textSecondary }]}>/stakeholder-mapper/execute</Text>
        </View>
        <View style={styles.endpointRow}>
          <Zap size={14} color="#8B5CF6" />
          <Text style={[styles.endpointText, { color: theme.colors.textSecondary }]}>/stakeholder-mapper/analyze</Text>
        </View>
      </View>
      ...
      <AgentFeatures agentId="stakeholder-mapper" agentName="AI StakeholderMapper" />
