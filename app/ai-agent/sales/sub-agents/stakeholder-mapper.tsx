...
export default function StakeholderMapperPage() {
  const agent = {
    ...
    title: 'Sales Agent',
    description: 'Automated Stakeholder Mapper agent specializing in sales operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
