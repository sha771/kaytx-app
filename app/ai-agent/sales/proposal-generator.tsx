...
export default function AiProposalGeneratorScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["RFP Automation","Proposal Customization","Pricing Table Generation","Template Management","Multi-format Export","Legal Clause Library","Collaboration Tools","Brand Consistency","Version Control","Asset Library"],
