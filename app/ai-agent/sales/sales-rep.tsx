...
export default function AiSalesRepScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Automated Outreach","Lead Identification","Initial Engagement","CRM Integration","Meeting Scheduling","Follow-up Management","Sentiment Tracking","Objection Handling","Territory Awareness","Pipeline Building"],
