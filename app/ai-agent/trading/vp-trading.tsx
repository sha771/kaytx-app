...
export default function VPTradingPage() {
  ...
  const capabilities = ['Algo Trading', 'Risk Management', 'Portfolio Optimization', 'Market Analysis', 'Derivatives', 'Forex', 'Crypto', 'Quant Modeling'];
  const responsibilities = [
    'Trading Strategy & Algorithm Development',
    'Real-time Market Analysis & Execution',
    'Portfolio Risk Management & Hedging',
    'Derivatives, Forex & Crypto Trading',
    'Quantitative Modeling & Backtesting',
    'Compliance & Regulatory Adherence',
    'Trade Settlement & Reconciliation',
    'Trading Desk Operations & Oversight'
  ];
  const activities = [
    { time: '1 min ago', text: 'Executed 234 algo trades across equities' },
    { time: '5 min ago', text: 'Updated risk exposure dashboard' },
    { time: '15 min ago', text: 'Completed derivatives portfolio rebalancing' },
    { time: '1 hour ago', text: 'Published daily P&L and risk report' },
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { backgroundColor: theme.colors.primary + '18' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>VP Trading</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Trading & Investments Department</Text>
        <View style={styles.badgesRow}>
          ...
          <View style={[styles.badge, { backgroundColor: '#FF950022' }]}><Users size={12} color="#FF9500" /><Text style={[styles.badgeText, { color: '#FF9500' }]}>12+ Reports</Text></View>
        </View>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The VP Trading AI leads trading operations, algorithmic strategies, and portfolio management across equities, derivatives, forex, and crypto markets. This agent ensures optimal execution, risk-adjusted returns, and regulatory compliance.
        </Text>
      </View>
    ...
    <AgentFeatures agentId="vp-trading" agentName="VP Trading" />
