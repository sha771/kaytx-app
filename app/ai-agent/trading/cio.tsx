...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'3,857',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.6%',icon:Target,color:'#0277BD'}];
  ...
  const activities = [{time:'3 min ago',text:'Approved Q3 investment strategy',icon:CheckCircle2},{time:'6 min ago',text:'Reviewed portfolio risk exposure',icon:Clock},{time:'9 min ago',text:'Met with regulatory compliance team',icon:Zap}];
  return (
