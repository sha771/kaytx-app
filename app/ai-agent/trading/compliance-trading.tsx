...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'3,700',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.1s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.8%',icon:Target,color:'#0277BD'}];
  ...
  const activities = [{time:'3 min ago',text:'Cleared 500 trade surveillance alerts',icon:CheckCircle2},{time:'6 min ago',text:'Updated AML screening rules',icon:Clock},{time:'9 min ago',text:'Filed monthly regulatory report',icon:Zap}];
  return (
