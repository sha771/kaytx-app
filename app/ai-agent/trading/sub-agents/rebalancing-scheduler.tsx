...
export default function RebalancingSchedulerPage() {
  const agent = {
    id: 'rebalancing-scheduler',
    name: 'AI Rebalancing Scheduler',
    title: 'Trading Agent',
    description: 'Automated Rebalancing Scheduler agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Rebalancing Scheduler',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
