...
export default function FailManagerPage() {
  const agent = {
    ...
    title: 'Trading Agent',
    description: 'Automated Fail Manager agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
