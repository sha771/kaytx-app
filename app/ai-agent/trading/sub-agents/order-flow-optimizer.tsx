...
export default function OrderFlowOptimizerPage() {
  const agent = {
    id: 'order-flow-optimizer',
    name: 'AI Order Flow Optimizer',
    title: 'Trading Agent',
    description: 'Automated Order Flow Optimizer agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Order Flow Optimizer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
