...
export default function GreeksCalculatorPage() {
  const agent = {
    ...
    title: 'Trading Agent',
    description: 'Automated Greeks Calculator agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Greeks Calculator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
