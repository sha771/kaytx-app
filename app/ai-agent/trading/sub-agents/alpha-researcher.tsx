...
export default function AlphaResearcherPage() {
  const agent = {
    ...
    title: 'Trading Agent',
    description: 'Automated Alpha Researcher agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
