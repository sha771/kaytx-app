...
export default function LiquidityPoolMonitorPage() {
  const agent = {
    ...
    name: 'AI Liquidity Pool Monitor',
    title: 'Trading Agent',
    description: 'Automated Liquidity Pool Monitor agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Liquidity Pool Monitor',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
