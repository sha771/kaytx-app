...
export default function ImpactReporterPage() {
  const agent = {
    ...
    title: 'Trading Agent',
    description: 'Automated Impact Reporter agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
