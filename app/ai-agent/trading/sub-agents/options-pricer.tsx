...
export default function OptionsPricerPage() {
  const agent = {
    ...
    title: 'Trading Agent',
    description: 'Automated Options Pricer agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
