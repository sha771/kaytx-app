...
export default function PerformanceAttributionAnalystPage() {
  const agent = {
    ...
    title: 'Trading Agent',
    description: 'Automated Performance Attribution Analyst agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Performance Attribution Analyst',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
