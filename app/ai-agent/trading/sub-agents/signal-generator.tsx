...
export default function SignalGeneratorPage() {
  const agent = {
    ...
    title: 'Trading Agent',
    description: 'Automated Signal Generator agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
