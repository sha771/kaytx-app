...
export default function SustainabilityScorerPage() {
  const agent = {
    id: 'sustainability-scorer',
    name: 'AI Sustainability Scorer',
    title: 'Trading Agent',
    description: 'Automated Sustainability Scorer agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Sustainability Scorer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
