...
export default function FactorModelerPage() {
  const agent = {
    id: 'factor-modeler',
    name: 'AI Factor Modeler',
    title: 'Trading Agent',
    description: 'Automated Factor Modeler agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
