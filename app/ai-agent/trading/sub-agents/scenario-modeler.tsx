...
export default function ScenarioModelerPage() {
  const agent = {
    ...
    title: 'Trading Agent',
    description: 'Automated Scenario Modeler agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
