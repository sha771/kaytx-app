...
const METRICS = [{"label":"Risk Index","value":"62","change":"+8","trend":"up"},{"label":"Event Track","value":"847","change":"+42","trend":"up"},{"label":"Alert Speed","value":"0.4s","change":"-0.1s","trend":"up"},{"label":"Coverage","value":"42 regions","change":"+2","trend":"up"}];

export default function GeopoliticalRiskAssessorPage() {
  const { theme } = useTheme();
  const router = useRouter();
  const stats = [{label:'Regions',value:'42',icon:Globe,color:'#34C759'},{label:'Risk Index',value:'62',icon:AlertTriangle,color:'#007AFF'},{label:'Events',value:'847',icon:Activity,color:'#FF9500'},{label:'Alerts',value:'12',icon:Zap,color:'#AF52DE'}];
  const capabilities = ["Event Monitoring","Risk Scoring","Scenario Analysis","Conflict Tracking","Sanctions Monitor","Trade Policy","Election Analysis","Supply Chain Impact"];
  const responsibilities = ["Monitor geopolitical events and escalation patterns","Score geopolitical risk by region and severity","Analyze scenario impacts on financial markets","Track armed conflicts and territorial disputes","Monitor sanctions and trade policy changes","Assess election outcomes and political transitions"];
  const activities = [{time:'2 min ago',text:'Raised risk score for MENA region',icon:Globe},{time:'6 min ago',text:'Tracked new sanctions announcement',icon:Shield},{time:'14 min ago',text:'Analyzed election impact on FX',icon:TrendingUp},{time:'28 min ago',text:'Updated supply chain disruption map',icon:Activity},{time:'1 hr ago',text:'Published geopolitical risk report',icon:FileText}];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Geopolitical Risk Assessor</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Event Monitoring & Scenario Impact Analysis</Text>
      ...
      <View style={[styles.section,{backgroundColor:theme.colors.card||'#F2F2F7'}]}>
        ...
        <Text style={[styles.description,{color:theme.colors.textSecondary}]}>The AI Geopolitical Risk Assessor operates as a specialized sub-agent under AI Macro Analyst, delivering enterprise-grade capabilities in event monitoring & scenario impact analysis within the Trading & Investments department.</Text>
      </View>
      <View style={[styles.section,{backgroundColor:theme.colors.card||'#F2F2F7'}]}>
      ...
      <AgentFeatures agentId="geopolitical-risk-assessor" agentName="AI Geopolitical Risk Assessor"/>
