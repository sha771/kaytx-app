...
export default function CorrelationTrackerPage() {
  const agent = {
    ...
    title: 'Trading Agent',
    description: 'Automated Correlation Tracker agent specializing in trading operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Correlation Tracker',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
