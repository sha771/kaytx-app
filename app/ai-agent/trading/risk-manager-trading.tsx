...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'1,542',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.5s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.0%',icon:Target,color:'#0277BD'}];
  ...
  const activities = [{time:'3 min ago',text:'Updated risk policy for Q3',icon:CheckCircle2},{time:'6 min ago',text:'Reviewed counterparty exposures',icon:Clock},{time:'9 min ago',text:'Approved new limit framework',icon:Zap}];
  return (
