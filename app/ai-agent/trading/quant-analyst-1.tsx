...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'4,396',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.3s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.4%',icon:Target,color:'#0277BD'}];
  ...
  const activities = [{time:'3 min ago',text:'Deployed new ML alpha model',icon:CheckCircle2},{time:'6 min ago',text:'Validated factor return predictions',icon:Clock},{time:'9 min ago',text:'Updated risk model parameters',icon:Zap}];
  return (
