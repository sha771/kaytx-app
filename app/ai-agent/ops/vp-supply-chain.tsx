...
export default function AgentPage() {
  const agent = {
    ...
    description: 'Manages end-to-end supply chain, logistics, procurement, and vendor relationships. Optimizes supply chain efficiency and ensures seamless operations.',
