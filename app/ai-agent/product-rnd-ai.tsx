...
export default function ProductRndAIPage() {
  const agent = {
    id: 'product-rnd',
    name: 'AI Product Rnd',
    title: 'Product Rnd AI',
    description: 'The Product Rnd AI provides specialized services and automation within its department with full support for chat, analytics, performance tracking, capabilities, history, counseling, live monitoring, and comprehensive settings.',
