...
export default function AiPerformanceMonitoringScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Real-time Monitoring","Performance Analytics","Bottleneck Detection","Capacity Planning","Optimization Recommendations","SLA Monitoring","Alert Management","Trend Analysis"],
