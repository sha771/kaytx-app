...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'139',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.3s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.9%',icon:Target,color:'#1B5E20'}];
  const capabilities = ['Executive Intelligence','Strategic Insights','Board Reporting'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>Executive Intelligence AI</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Provides executive-level intelligence, strategic insights, and board-ready reports.</Text></View>
      ...
      <AgentFeatures agentId="executive-intelligence" agentName="Executive Intelligence AI" />
    </ScrollView>
  );
}
