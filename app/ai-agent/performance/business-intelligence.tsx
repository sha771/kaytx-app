...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'190',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.3s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.4%',icon:Target,color:'#1B5E20'}];
  const capabilities = ['Business Intelligence','Dashboard Creation','Strategic Insights'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>Business Intelligence AI</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Provides comprehensive business intelligence, dashboards, and strategic insights.</Text></View>
      ...
      <AgentFeatures agentId="business-intelligence" agentName="Business Intelligence AI" />
    </ScrollView>
  );
}
