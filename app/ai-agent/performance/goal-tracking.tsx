...
export default function AgentPage() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Tracks goals, OKRs, KPIs, and provides progress reporting and recommendations.</Text></View>
      ...
      <AgentFeatures agentId="goal-tracking" agentName="Goal & OKR Tracking AI" />
    </ScrollView>
  );
}
