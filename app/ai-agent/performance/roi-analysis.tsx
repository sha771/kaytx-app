...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'157',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.1%',icon:Target,color:'#1B5E20'}];
  const capabilities = ['ROI Analysis','Profitability Tracking','Financial Performance'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>ROI & Profitability Analysis AI</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Analyzes ROI, profitability margins, and financial performance across all initiatives.</Text></View>
      ...
      <AgentFeatures agentId="roi-analysis" agentName="ROI & Profitability Analysis AI" />
    </ScrollView>
  );
}
