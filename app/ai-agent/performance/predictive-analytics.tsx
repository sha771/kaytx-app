...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'84',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.5s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.4%',icon:Target,color:'#1B5E20'}];
  const capabilities = ['Machine Learning','Predictive Analysis','Trend Forecasting'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>Predictive Analytics AI</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Uses machine learning for predictive analysis and future trend forecasting.</Text></View>
      ...
      <AgentFeatures agentId="predictive-analytics" agentName="Predictive Analytics AI" />
    </ScrollView>
  );
}
