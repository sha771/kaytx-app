...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'156',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.5s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.3%',icon:Target,color:'#1B5E20'}];
  const capabilities = ['Behavior Analysis','Journey Mapping','Engagement Optimization'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>Customer Behavior Analysis AI</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Analyzes customer behavior patterns, journey mapping, and engagement optimization.</Text></View>
      ...
      <AgentFeatures agentId="customer-behavior-analysis" agentName="Customer Behavior Analysis AI" />
    </ScrollView>
  );
}
