...
export default function PropertyInvestmentAnalystPage() {
  const agent = {
    id: 'property-investment-analyst',
    name: 'AI Property Investment Analyst',
    title: 'AI Property Investment Analyst',
    description: 'AI Property Investment Analyst provides specialized expertise and executes critical tasks for the Real Estate & Property department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'property-investment-analyst',
    infrastructure: {
      status: 'online',
