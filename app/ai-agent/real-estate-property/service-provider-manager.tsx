...
export default function ServiceProviderManagerPage() {
  const agent = {
    id: 'service-provider-manager',
    name: 'AI Service Provider Manager',
    title: 'AI Service Provider Manager',
    description: 'AI Service Provider Manager provides specialized expertise and executes critical tasks for the Real Estate & Property department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'service-provider-manager',
    infrastructure: {
      status: 'online',
