...
export default function ChiefRealEstateOfficerPage() {
  const agent = {
    ...
    replacesRole: 'chief-real-estate-officer',
    infrastructure: {
      status: 'online',
