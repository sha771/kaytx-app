...
export default function RealEstateFundManagerPage() {
  const agent = {
    id: 'real-estate-fund-manager',
    name: 'AI Real Estate Fund Manager',
    title: 'AI Real Estate Fund Manager',
    description: 'AI Real Estate Fund Manager provides specialized expertise and executes critical tasks for the Real Estate & Property department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'real-estate-fund-manager',
    infrastructure: {
      status: 'online',
