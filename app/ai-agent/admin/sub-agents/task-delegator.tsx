...
export default function TaskDelegatorPage() {
  const agent = {
    ...
    title: 'Admin Agent',
    description: 'Automated Task Delegator agent specializing in admin operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
