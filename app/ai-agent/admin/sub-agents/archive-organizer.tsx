...
export default function ArchiveOrganizerPage() {
  const agent = {
    ...
    title: 'Admin Agent',
    description: 'Automated Archive Organizer agent specializing in admin operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
