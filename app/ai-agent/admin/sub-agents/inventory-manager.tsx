...
export default function InventoryManagerPage() {
  const agent = {
    ...
    title: 'Admin Agent',
    description: 'Automated Inventory Manager agent specializing in admin operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
