...
export default function VisaDocumenterPage() {
  const agent = {
    ...
    title: 'Admin Agent',
    description: 'Automated Visa Documenter agent specializing in admin operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
