...
export default function ScheduleCoordinatorPage() {
  const agent = {
    ...
    title: 'Admin Agent',
    description: 'Automated Schedule Coordinator agent specializing in admin operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
