...
export default function TravelBookerPage() {
  const agent = {
    ...
    title: 'Admin Agent',
    description: 'Automated Travel Booker agent specializing in admin operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
