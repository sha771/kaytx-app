...
export default function AiReceptionistScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Call Routing & Transfer","Appointment Scheduling","Visitor Check-in Management","FAQ Response","Lead Qualification","Multi-language Support","Voice Recognition","Call Transcription","Hold Management","Emergency Escalation"],
