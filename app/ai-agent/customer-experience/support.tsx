...
export default function AiCustomerSupportScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Multi-channel Support (Chat, Email, Voice)","Technical Troubleshooting","Product Guidance","Knowledge Base Access","Sentiment Analysis","Proactive Issue Detection","Solution Recommendation","Follow-up Automation","Customer History Access","Escalation Management"],
