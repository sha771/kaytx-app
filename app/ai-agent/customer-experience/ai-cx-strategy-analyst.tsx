...
import { Target, ChevronLeft, Settings, Zap, BarChart3, Brain, Workflow, Link, Users, Play, TrendingUp, Award, Clock, CheckCircle2, Activity, Database, MoreVertical, Gauge, PieChart, Shield, Lightbulb, Compass } from 'lucide-react-native';
import { aiCXStrategyAnalyst, getCustomerExperienceAgentById } from '@/constants/customerExperienceAgents';

export default function AICXStrategyAnalystPage() {
  const router = useRouter();
  const { theme } = useTheme();
  const agent = aiCXStrategyAnalyst;
  ...
  const renderOverview = () => (
    <View style={styles.tabContent}>
      ...
      <View style={styles.metricsGrid}>
        <MetricCard title="Strategies Built" value="156" trend="15%" trendUp={true} icon={Target} color="#9C27B0" />
        <MetricCard title="Avg Response" value="2.1m" trend="12%" trendUp={true} icon={Clock} color="#2196F3" />
        <MetricCard title="Success Rate" value={`${agent.metrics.successRate}%`} trend="8%" trendUp={true} icon={TrendingUp} color="#4CAF50" />
        <MetricCard title="CSAT Score" value={agent.metrics.customerSatisfaction.toString()} trend="0.4" trendUp={true} icon={Award} color="#FF9800" />
      </View>
    ...
    <View style={styles.tabContent}>
      <View style={styles.analyticsGrid}>
        ...
        <View style={[styles.analyticsCard, { backgroundColor: theme.colors.cardBackground }]}>
          ...
          <Text style={[styles.analyticsValue, { color: theme.colors.text }]}>156</Text>
          <Text style={[styles.analyticsLabel, { color: theme.colors.secondaryText }]}>Strategies</Text>
        </View>
        <View style={[styles.analyticsCard, { backgroundColor: theme.colors.cardBackground }]}>
