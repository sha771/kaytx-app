...
export default function AiRetentionSpecialistScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Churn Prediction","Loyalty Program Management","Personalized Retention Offers","Customer Success Advocacy","Feedback Collection","Re-engagement Campaigns","LTV Analysis","Proactive Outreach","Cancellation Prevention","Success Metrics Tracking"],
