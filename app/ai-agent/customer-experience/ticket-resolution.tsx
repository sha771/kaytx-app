...
const ACCENT = '#FF9500';
const AGENT_NAME = 'AI Ticket Resolver';
const AGENT_TITLE = 'Tech Support AI';
const AGENT_DESC = 'Diagnoses technical issues, provides step-by-step troubleshooting, and resolves common helpdesk tickets instantly.';
const PARENT_NAME = 'Customer Experience AI';

const METRICS = [
  { label: 'Tasks Today', value: '890', color: ACCENT },
  { label: 'Success Rate', value: '94%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.5s', color: '#007AFF' },
  { label: 'Accuracy', value: '95.1%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Resolved password reset ticket",
        "time": "1m ago"
    },
    {
        "action": "Diagnosed API connection error",
        "time": "15m ago"
    },
    {
        "action": "Provided setup instructions for iOS",
        "time": "22m ago"
    },
    {
        "action": "Escalated P1 outage ticket",
        "time": "30m ago"
    },
    {
        "action": "Updated knowledge base article flow",
        "time": "2h ago"
    }
];
