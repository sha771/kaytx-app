...
const ACCENT = '#5AC8FA';
const AGENT_NAME = 'AI Complaint Handler';
const AGENT_TITLE = 'De-escalation AI';
const AGENT_DESC = 'Manages incoming complaints with high emotional intelligence, de-escalates anger, and offers resolutions.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '92.5%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "De-escalated frustrated customer",
        "time": "5m ago"
    },
    {
        "action": "Issued 20% apology discount",
        "time": "18m ago"
    },
    {
        "action": "Routed severe complaint to supervisor",
        "time": "35m ago"
    },
    {
        "action": "Logged product safety issue",
        "time": "1h ago"
    },
    {
        "action": "Followed up on resolved complaint",
        "time": "3h ago"
    }
];
