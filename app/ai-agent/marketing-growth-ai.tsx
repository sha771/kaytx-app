...
export default function MarketingGrowthAIPage() {
  const agent = {
    id: 'marketing-growth',
    name: 'AI Marketing Growth',
    title: 'Marketing Growth AI',
    description: 'The Marketing Growth AI provides specialized services and automation within its department with full support for chat, analytics, performance tracking, capabilities, history, counseling, live monitoring, and comprehensive settings.',
