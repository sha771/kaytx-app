...
export default function BankRelationshipCoordinatorPage() {
  const agent = {
    id: 'bank-relationship-coordinator',
    name: 'AI Bank Relationship Coordinator',
    title: 'Finance Agent',
    description: 'Automated Bank Relationship Coordinator agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Bank Relationship Coordinator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
