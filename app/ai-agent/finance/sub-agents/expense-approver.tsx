...
export default function ExpenseApproverPage() {
  const agent = {
    ...
    title: 'Finance Agent',
    description: 'Automated Expense Approver agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
