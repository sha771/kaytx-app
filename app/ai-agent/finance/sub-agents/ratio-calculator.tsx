...
export default function RatioCalculatorPage() {
  const agent = {
    ...
    title: 'Finance Agent',
    description: 'Automated Ratio Calculator agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
