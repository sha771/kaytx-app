...
import { Activity, TrendingUp, Clock, Target, Zap, ArrowRight, Briefcase, DollarSign, BarChart3 } from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';
import { useRouter } from 'expo-router';

export default function RiskRewardAnalystPage() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Risk-Reward Analyst</Text>
      ...
      <View style={styles.statsContainer}>
        {[
          ...
          {label:'Accuracy',value:'97.8%',icon: Activity, color: '#FF9500'}
        ].map((stat,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Risk-Reward Analyst evaluates every financial decision through a risk-reward lens, quantifying
          potential upside and downside scenarios. It provides probabilistic assessments, stress-test simulations,
          and risk-adjusted return calculations to ensure the enterprise pursues optimal risk-calibrated strategies.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {[
          'Risk-Reward Ratio Calculation & Scoring',
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['Risk Scoring','Reward Modeling','Scenario Analysis','Stress Testing','Monte Carlo','VaR Calculation','Downside Protection','Risk Calibration'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {[
          { label: 'Prediction Accuracy', value: '97.8% correct' },
          { label: 'Avg Risk Score', value: '2.1/10 (Low)' },
          { label: 'Stress Tests', value: '500+/day' },
          { label: 'VaR Coverage', value: '99.5% confidence' }
        ].map((metric,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/risk-reward-analyst', '/risk-reward-analyst/evaluate', '/risk-reward-analyst/stress-test'].map((endpoint,index)=>(
      ...
      <AgentFeatures agentId="risk-reward-analyst" agentName="AI Risk-Reward Analyst" />
