...
export default function FinancialReportCompilerPage() {
  const agent = {
    id: 'financial-report-compiler',
    name: 'AI Financial Report Compiler',
    title: 'Finance Agent',
    description: 'Automated Financial Report Compiler agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Financial Report Compiler',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
