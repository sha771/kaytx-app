...
import { Activity, DollarSign, Clock, Target, Zap, ArrowRight, Briefcase, Calculator, TrendingUp, ChartBarBig } from 'lucide-react-native';
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#007AFF20' }]}>
          <DollarSign size={56} color="#007AFF" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Cash Flow Forecaster</Text>
      ...
      <View style={styles.statsContainer}>
        {[
          {label:'Cost Equiv',value:'$60K/yr',icon: DollarSign, color: '#34C759'},
          {label:'AI Cost',value:'$3K/yr',icon: Clock, color: '#007AFF'},
          {label:'Efficiency',value:'20x',icon: Target, color: '#FF9500'},
          {label:'Accuracy',value:'96.8%',icon: Activity, color: '#007AFF'}
        ].map((stat,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Cash Flow Forecaster predicts enterprise cash inflows and outflows across multiple time horizons.
          It monitors working capital, identifies liquidity gaps before they occur, and recommends optimal
          cash management strategies to maintain healthy cash positions at all times.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {[
          'Cash Inflow & Outflow Prediction',
          'Working Capital Optimization',
          'Liquidity Gap Detection & Alerting',
          'Short & Long-Term Cash Projections',
          'Treasury Operations Support',
          'Cash Management Strategy Recommendations'
        ].map((item,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['Cash Prediction','Working Capital','Liquidity Monitoring','Gap Detection','Treasury Support','Multi-Horizon','Scenario Planning','Alert System'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {[
          { label: 'Forecast Accuracy', value: '96.8% on target' },
          { label: 'Liquidity Alerts', value: '< 1 hour notice' },
          { label: 'Coverage', value: 'All cash streams' },
          { label: 'Horizon Range', value: '1 day to 5 years' }
        ].map((metric,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/cash-flow-forecaster', '/cash-flow-forecaster/forecast', '/cash-flow-forecaster/liquidity'].map((endpoint,index)=>(
      ...
      <AgentFeatures agentId="cash-flow-forecaster" agentName="AI Cash Flow Forecaster" />
