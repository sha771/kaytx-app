...
export default function ReturnPreparerPage() {
  const agent = {
    ...
    title: 'Finance Agent',
    description: 'Automated Return Preparer agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
