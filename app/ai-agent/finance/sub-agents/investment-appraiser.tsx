...
import { Activity, TrendingUp, Clock, Target, Zap, ArrowRight, Briefcase, DollarSign, Calculator, ChartBarBig } from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';
import { useRouter } from 'expo-router';

export default function InvestmentAppraiserPage() {
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#FF950020' }]}>
          <TrendingUp size={56} color="#FF9500" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Investment Appraiser</Text>
      ...
      <View style={styles.statsContainer}>
        {[
          ...
          {label:'Accuracy',value:'95.4%',icon: Activity, color: '#FF9500'}
        ].map((stat,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Investment Appraiser evaluates potential investments using NPV, IRR, payback period, and
          profitability index methodologies. It performs comprehensive due diligence, benchmarks against
          industry standards, and provides risk-adjusted investment recommendations.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {[
          ...
          'Payback Period & Profitability Index Analysis',
          'Investment Due Diligence & Scoring',
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['NPV Analysis','IRR Calculation','Due Diligence','Benchmarking','Risk Adjustment','Payback Analysis','Portfolio Impact','Investment Scoring'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {[
          { label: 'Appraisal Accuracy', value: '95.4% validated' },
          { label: 'Avg NPV Deviation', value: '< 3.2% from actual' },
          { label: 'Evaluations', value: '280+/month' },
          { label: 'Due Diligence Time', value: '< 2 hours (vs 2 weeks)' }
        ].map((metric,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/investment-appraiser', '/investment-appraiser/evaluate', '/investment-appraiser/benchmark'].map((endpoint,index)=>(
      ...
      <AgentFeatures agentId="investment-appraiser" agentName="AI Investment Appraiser" />
