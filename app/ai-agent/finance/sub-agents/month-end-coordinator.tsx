...
export default function MonthEndCoordinatorPage() {
  const agent = {
    id: 'month-end-coordinator',
    name: 'AI Month End Coordinator',
    title: 'Finance Agent',
    description: 'Automated Month End Coordinator agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Month End Coordinator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
