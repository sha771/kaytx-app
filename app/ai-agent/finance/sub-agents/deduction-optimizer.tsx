...
export default function DeductionOptimizerPage() {
  const agent = {
    ...
    title: 'Finance Agent',
    description: 'Automated Deduction Optimizer agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Deduction Optimizer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
