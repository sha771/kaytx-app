...
export default function JournalEntryReviewerPage() {
  const agent = {
    id: 'journal-entry-reviewer',
    name: 'AI Journal Entry Reviewer',
    title: 'Finance Agent',
    description: 'Automated Journal Entry Reviewer agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Journal Entry Reviewer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
