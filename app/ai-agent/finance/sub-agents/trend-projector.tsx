...
export default function TrendProjectorPage() {
  const agent = {
    ...
    title: 'Finance Agent',
    description: 'Automated Trend Projector agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
