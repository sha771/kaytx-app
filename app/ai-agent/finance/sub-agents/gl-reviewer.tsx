...
export default function GlReviewerPage() {
  const agent = {
    ...
    name: 'AI Gl Reviewer',
    title: 'Finance Agent',
    description: 'Automated Gl Reviewer agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
