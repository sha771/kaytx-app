...
export default function BudgetTrackerPage() {
  const agent = {
    ...
    title: 'Finance Agent',
    description: 'Automated Budget Tracker agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
