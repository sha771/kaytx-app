...
export default function EarningsReportDrafterPage() {
  const agent = {
    id: 'earnings-report-drafter',
    name: 'AI Earnings Report Drafter',
    title: 'Finance Agent',
    description: 'Automated Earnings Report Drafter agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Earnings Report Drafter',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
