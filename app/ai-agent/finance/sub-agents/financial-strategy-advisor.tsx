...
export default function FinancialStrategyAdvisorPage() {
  const agent = {
    ...
    title: 'Finance Agent',
    description: 'Automated Financial Strategy Advisor agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Financial Strategy Advisor',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
