...
export default function AuditPlannerPage() {
  const agent = {
    ...
    title: 'Finance Agent',
    description: 'Automated Audit Planner agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
