...
export default function VarianceAnalyzerPage() {
  const agent = {
    ...
    title: 'Finance Agent',
    description: 'Automated Variance Analyzer agent specializing in finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Variance Analyzer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
