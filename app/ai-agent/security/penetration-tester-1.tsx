  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#581C8420' }]}><Crosshair size={48} color="#581C84" /></View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>Penetration Tester</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Offensive Security</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>The Penetration Tester AI performs automated offensive security testing, identifying vulnerabilities before attackers can exploit them.</Text></View>
      ...
      <AgentFeatures agentId="penetration-tester-1" agentName="Penetration Tester" />
    </ScrollView>
  );
}
