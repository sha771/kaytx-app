...
export default function BoardReporterPage() {
  const agent = {
    ...
    description: 'Automated Board Reporter agent specializing in security operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
