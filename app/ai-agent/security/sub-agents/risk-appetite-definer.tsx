...
export default function RiskAppetiteDefinerPage() {
  const agent = {
    ...
    description: 'Automated Risk Appetite Definer agent specializing in security operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
