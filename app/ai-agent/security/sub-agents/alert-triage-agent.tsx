...
export default function AlertTriageAgentPage() {
  const agent = {
    ...
    description: 'Automated Alert Triage Agent agent specializing in security operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Alert Triage Agent',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
