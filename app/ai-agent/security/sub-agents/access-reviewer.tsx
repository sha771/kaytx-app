...
export default function AccessReviewerPage() {
  const agent = {
    ...
    description: 'Automated Access Reviewer agent specializing in security operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
