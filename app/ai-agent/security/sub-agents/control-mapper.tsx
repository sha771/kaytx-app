...
export default function ControlMapperPage() {
  const agent = {
    ...
    description: 'Automated Control Mapper agent specializing in security operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
