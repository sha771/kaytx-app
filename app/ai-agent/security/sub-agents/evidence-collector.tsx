...
export default function EvidenceCollectorPage() {
  const agent = {
    ...
    description: 'Automated Evidence Collector agent specializing in security operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Evidence Collector',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
