...
export default function RiskAppetiteMonitorPage() {
  const agent = {
    id: 'risk-appetite-monitor',
    name: 'AI Risk Appetite Monitor',
    title: 'Security Agent',
    description: 'Automated Risk Appetite Monitor agent specializing in security operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Risk Appetite Monitor',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
