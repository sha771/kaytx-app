...
export default function EscalationPathDefinerFixedPage() {
  const agent = {
    id: 'escalation-path-definer-fixed',
    name: 'AI Escalation Path Definer Fixed',
    title: 'Security Agent',
    description: 'Automated Escalation Path Definer Fixed agent specializing in security operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Escalation Path Definer Fixed',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
