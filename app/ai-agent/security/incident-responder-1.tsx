...
export default function AgentPage() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>The Incident Responder AI provides 24/7 automated incident detection, triage, containment, and recovery. It ensures rapid response to security threats with minimal human intervention.</Text></View>
      ...
      <AgentFeatures agentId="incident-responder-1" agentName="Incident Responder" />
    </ScrollView>
  );
}
