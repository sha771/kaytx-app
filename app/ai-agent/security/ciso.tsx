...
export default function AgentPage() {
  ...
  const capabilities = [
    'Security Strategy', 'Threat Intelligence', 'Risk Management', 'Compliance',
    'Incident Response', 'Security Architecture', 'Governance', 'Audit'
  ];
  ...
  const responsibilities = [
    ...
    'Security Compliance & Regulatory Adherence',
    'Incident Response & Crisis Management',
    'Security Architecture & Design Review',
    'Governance Framework & Policy Development',
    'Security Audit & Continuous Improvement'
  ];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>CISO</Text>
        ...
        <View style={styles.badgesRow}>
          ...
          <View style={[styles.badge, { backgroundColor: '#581C8422' }]}><Star size={12} color="#581C84" /><Text style={[styles.badgeText, { color: '#581C84' }]}>C-Suite</Text></View>
          <View style={[styles.badge, { backgroundColor: '#FF950022' }]}><Users size={12} color="#FF9500" /><Text style={[styles.badgeText, { color: '#FF9500' }]}>Leadership</Text></View>
        </View>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>The CISO AI oversees enterprise-wide security strategy, threat intelligence, risk management, and compliance. It ensures continuous protection against cyber threats and regulatory adherence.</Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {capabilities.map((cap, i) => (
            <View key={i} style={[styles.tag, { backgroundColor: '#581C8418' }]}><Text style={[styles.tagText, { color: '#581C84' }]}>{cap}</Text></View>
          ))}
        </View>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {responsibilities.map((item, i) => (
          <View key={i} style={styles.responsibilityRow}>
            <ArrowRight size={14} color="#581C84" />
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {activities.map((act, i) => (
          <View key={i} style={styles.activityRow}>
            <View style={[styles.activityIcon, { backgroundColor: '#581C8415' }]}><act.icon size={14} color="#581C84" /></View>
      ...
      <AgentFeatures agentId="ciso" agentName="CISO" />
    </ScrollView>
  );
}
