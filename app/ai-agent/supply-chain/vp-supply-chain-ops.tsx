...
import { Package, Activity, CheckCircle2, Clock, Target, BarChart3, MessageSquare, Calendar, Shield, ArrowRight, Users, Zap, Star } from 'lucide-react-native';
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={styles.statsContainer}>
        {[{label:'Orders',value:'34,521',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.96%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.5s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.2%',icon:Target,color:'#AF52DE'}].map((stat,index)=>(
