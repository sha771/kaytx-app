...
export default function StrategicSourcingManagerPage() {
  const agent = {
    id: 'strategic-sourcing-manager',
    name: 'AI Strategic Sourcing Manager',
    title: 'AI Strategic Sourcing Manager',
    description: 'AI Strategic Sourcing Manager provides specialized expertise and executes critical tasks for the Supply Chain & Logistics department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'strategic-sourcing-manager',
    infrastructure: {
      status: 'online',
