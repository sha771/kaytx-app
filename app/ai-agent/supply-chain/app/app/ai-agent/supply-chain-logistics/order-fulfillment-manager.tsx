...
export default function OrderFulfillmentManagerPage() {
  const agent = {
    id: 'order-fulfillment-manager',
    name: 'AI Order Fulfillment Manager',
    title: 'AI Order Fulfillment Manager',
    description: 'AI Order Fulfillment Manager provides specialized expertise and executes critical tasks for the Supply Chain & Logistics department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'order-fulfillment-manager',
    infrastructure: {
      status: 'online',
