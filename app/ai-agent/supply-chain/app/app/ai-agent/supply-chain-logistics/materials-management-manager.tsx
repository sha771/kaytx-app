...
export default function MaterialsManagementManagerPage() {
  const agent = {
    id: 'materials-management-manager',
    name: 'AI Materials Management Manager',
    title: 'AI Materials Management Manager',
    description: 'AI Materials Management Manager provides specialized expertise and executes critical tasks for the Supply Chain & Logistics department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'materials-management-manager',
    infrastructure: {
      status: 'online',
