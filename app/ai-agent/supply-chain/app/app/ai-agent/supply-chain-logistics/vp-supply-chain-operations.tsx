...
export default function VPSupplyChainOperationsPage() {
  const agent = {
    ...
    replacesRole: 'vp-supply-chain-operations',
    infrastructure: {
      status: 'online',
