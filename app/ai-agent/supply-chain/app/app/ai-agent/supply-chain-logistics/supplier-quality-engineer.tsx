...
export default function SupplierQualityEngineerPage() {
  const agent = {
    id: 'supplier-quality-engineer',
    name: 'AI Supplier Quality Engineer',
    title: 'AI Supplier Quality Engineer',
    description: 'AI Supplier Quality Engineer provides specialized expertise and executes critical tasks for the Supply Chain & Logistics department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'supplier-quality-engineer',
    infrastructure: {
      status: 'online',
