...
export default function SupplyChainOptimizationAnalystPage() {
  const agent = {
    id: 'supply-chain-optimization-analyst',
    name: 'AI Supply Chain Optimization Analyst',
    title: 'AI Supply Chain Optimization Analyst',
    description: 'AI Supply Chain Optimization Analyst provides specialized expertise and executes critical tasks for the Supply Chain & Logistics department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'supply-chain-optimization-analyst',
    infrastructure: {
      status: 'online',
