...
export default function SupplierDevelopmentManagerPage() {
  const agent = {
    id: 'supplier-development-manager',
    name: 'AI Supplier Development Manager',
    title: 'AI Supplier Development Manager',
    description: 'AI Supplier Development Manager provides specialized expertise and executes critical tasks for the Supply Chain & Logistics department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'supplier-development-manager',
    infrastructure: {
      status: 'online',
