...
export default function SupplierPerformanceManagerPage() {
  const agent = {
    id: 'supplier-performance-manager',
    name: 'AI Supplier Performance Manager',
    title: 'AI Supplier Performance Manager',
    description: 'AI Supplier Performance Manager provides specialized expertise and executes critical tasks for the Supply Chain & Logistics department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'supplier-performance-manager',
    infrastructure: {
      status: 'online',
