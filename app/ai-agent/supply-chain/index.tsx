...
import { Link, Activity, Star, Users, CheckCircle2, Clock, Target, ArrowRight, BarChart3, MessageSquare, Calendar, Shield, TrendingUp } from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';
import { useRouter } from 'expo-router';

const DEPARTMENT_AGENTS = [
  { id: 'vp-supply-chain-ops', name: 'VP Supply Chain Operations', description: 'VP Supply Chain Operations AI Agent', icon: Bot, color: '#581C84' }
];;
