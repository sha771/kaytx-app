...
export default function BiasCorrectorPage() {
  const agent = {
    ...
    description: 'Automated Bias Corrector agent specializing in supply-chain operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
