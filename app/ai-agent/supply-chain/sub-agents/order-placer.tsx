...
export default function OrderPlacerPage() {
  const agent = {
    ...
    description: 'Automated Order Placer agent specializing in supply-chain operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
