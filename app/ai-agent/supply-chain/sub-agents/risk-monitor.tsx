...
export default function RiskMonitorPage() {
  const agent = {
    ...
    description: 'Automated Risk Monitor agent specializing in supply-chain operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
