...
export default function ContractNegotiatorPage() {
  const agent = {
    ...
    description: 'Automated Contract Negotiator agent specializing in supply-chain operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Contract Negotiator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
