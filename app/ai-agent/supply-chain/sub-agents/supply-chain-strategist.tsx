...
export default function SupplyChainStrategistPage() {
  const agent = {
    id: 'supply-chain-strategist',
    name: 'AI Supply Chain Strategist',
    title: 'Supply-chain Agent',
    description: 'Automated Supply Chain Strategist agent specializing in supply-chain operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Supply Chain Strategist',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
