...
import { Activity, Package, Clock, Target, Zap, ArrowRight, Briefcase, PackageCheck, TrendingDown, BarChart3 } from 'lucide-react-native';
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#EC489920' }]}>
          <PackageCheck size={56} color="#EC4899" />
        </View>
        ...
        <View style={styles.badgesRow}>
          ...
          <View style={[styles.badge, { backgroundColor: '#EC489922' }]}><Briefcase size={12} color="#EC4899" /><Text style={[styles.badgeText, { color: '#EC4899' }]}>Optimizer</Text></View>
      ...
      <View style={styles.statsContainer}>
        {[
          ...
          {label:'Level',value:'Optimizer',icon: Briefcase, color: '#EC4899'},
          {label:'Reduction',value:'30%',icon: TrendingDown, color: '#FF9500'},
          {label:'SKUs',value:'50K+',icon: BarChart3, color: '#007AFF'}
        ].map((stat,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Stock Optimizer calculates optimal inventory levels, reorder points, and safety stock quantities. This enterprise-level sub-agent minimizes carrying costs while ensuring product availability and preventing stockouts.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['Reorder Points','Safety Stock','EOQ Calculation','Lead Time Analysis','Service Level Targets','Inventory Policies'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/stock-optimizer','/stock-optimizer/execute','/stock-optimizer/analyze'].map((endpoint,index)=>(
      ...
      <AgentFeatures agentId="stock-optimizer" agentName="AI Stock Optimizer" />
