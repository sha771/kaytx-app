...
import { Activity, Package, Clock, Target, Zap, ArrowRight, Briefcase, DollarSign, TrendingDown, PieChart } from 'lucide-react-native';
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <View style={styles.badgesRow}>
          ...
          <View style={[styles.badge, { backgroundColor: '#10B98122' }]}><Briefcase size={12} color="#10B981" /><Text style={[styles.badgeText, { color: '#10B981' }]}>Analyzer</Text></View>
      ...
      <View style={styles.statsContainer}>
        {[
          ...
          {label:'Level',value:'Analyzer',icon: Briefcase, color: '#10B981'},
          {label:'Savings',value:'28%',icon: TrendingDown, color: '#FF9500'},
          {label:'Analyzed',value:'1000+',icon: PieChart, color: '#007AFF'}
        ].map((stat,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Cost Analyzer provides detailed cost analysis for logistics operations including freight, warehousing, and distribution. This enterprise-level sub-agent identifies cost-saving opportunities and provides actionable insights for the Logistics Manager.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['Freight Analysis','Rate Comparison','Cost Breakdown','Budget Tracking','Trend Analysis','Benchmarking'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/cost-analyzer','/cost-analyzer/execute','/cost-analyzer/analyze'].map((endpoint,index)=>(
      ...
      <AgentFeatures agentId="cost-analyzer" agentName="AI Cost Analyzer" />
