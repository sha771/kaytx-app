...
export default function PackagingOptimizerPage() {
  const agent = {
    ...
    description: 'Automated Packaging Optimizer agent specializing in supply-chain operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Packaging Optimizer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
