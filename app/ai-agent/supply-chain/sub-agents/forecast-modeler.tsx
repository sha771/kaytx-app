...
export default function ForecastModelerPage() {
  const agent = {
    ...
    description: 'Automated Forecast Modeler agent specializing in supply-chain operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
