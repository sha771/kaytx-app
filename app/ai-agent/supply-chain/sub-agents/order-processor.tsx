...
export default function OrderProcessorPage() {
  const agent = {
    ...
    description: 'Automated Order Processor agent specializing in supply-chain operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
