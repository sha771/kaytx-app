...
import { Activity, Package, Clock, Target, Zap, ArrowRight, Briefcase, Star, CheckCircle, Users } from 'lucide-react-native';
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <View style={styles.badgesRow}>
          ...
          <View style={[styles.badge, { backgroundColor: '#0EA5E922' }]}><Briefcase size={12} color="#0EA5E9" /><Text style={[styles.badgeText, { color: '#0EA5E9' }]}>Evaluator</Text></View>
      ...
      <View style={styles.statsContainer}>
        {[
          ...
          {label:'Level',value:'Evaluator',icon: Briefcase, color: '#0EA5E9'},
          {label:'Rated',value:'800+',icon: Star, color: '#FF9500'},
          {label:'Approved',value:'650+',icon: CheckCircle, color: '#007AFF'}
        ].map((stat,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Supplier Evaluator assesses supplier performance, conducts quality audits, and provides comprehensive supplier ratings. This enterprise-level sub-agent helps the Procurement Manager make data-driven supplier selection and retention decisions.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['Performance Scoring','Quality Audits','Financial Assessment','Risk Rating','Capability Analysis','Benchmarking'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/supplier-evaluator','/supplier-evaluator/execute','/supplier-evaluator/analyze'].map((endpoint,index)=>(
      ...
      <AgentFeatures agentId="supplier-evaluator" agentName="AI Supplier Evaluator" />
