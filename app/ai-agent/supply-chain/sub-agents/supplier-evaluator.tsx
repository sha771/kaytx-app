...
export default function SupplierEvaluatorPage() {
  const agent = {
    ...
    description: 'Automated Supplier Evaluator agent specializing in supply-chain operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Supplier Evaluator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
