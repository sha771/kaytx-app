...
const ACCENT = '#F56040';
const AGENT_NAME = 'AI Engagement Optimizer';
const AGENT_TITLE = 'Algorithm Optimization AI';
const AGENT_DESC = 'Analyzes past performance to determine the exact best times to post, formats to use, and lengths for maximum reach.';
...
const RECENT_TASKS = [
    {
        "action": "Adjusted posting schedule for UTC+1",
        "time": "15m ago"
    },
    {
        "action": "Analyzed drop-off in video watch time",
        "time": "45m ago"
    },
    {
        "action": "Recommended shorter captions for IG",
        "time": "2h ago"
    },
    {
        "action": "Cross-referenced engagement vs time",
        "time": "4h ago"
    },
    {
        "action": "Updated content pillar split",
        "time": "6h ago"
    }
];
