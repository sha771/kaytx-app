...
const ACCENT = '#5851DB';
const AGENT_NAME = 'AI Social Analytics';
const AGENT_TITLE = 'Data Reporting AI';
const AGENT_DESC = 'Aggregates data across all platforms into clean, understandable reports highlighting what worked and why.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '98.6%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Compiled end-of-month social report",
        "time": "10m ago"
    },
    {
        "action": "Calculated cross-platform engagement rate",
        "time": "45m ago"
    },
    {
        "action": "Attributed 50 website conversions to Social",
        "time": "2h ago"
    },
    {
        "action": "Analyzed competitor growth rate",
        "time": "4h ago"
    },
    {
        "action": "Presented ROI deck to management",
        "time": "8h ago"
    }
];
