...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'171',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.3s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.7%',icon:Target,color:'#F57F17'}];
  const capabilities = ['Performance Analytics','KPI Tracking','Insight Generation'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Social Analytics Agent</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Analyzes social media performance metrics, tracks KPIs, and provides actionable insights.</Text></View>
      ...
      <AgentFeatures agentId="social-analytics" agentName="AI Social Analytics Agent" />
    </ScrollView>
  );
}
