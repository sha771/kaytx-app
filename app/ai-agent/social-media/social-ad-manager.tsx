...
const ACCENT = '#833AB4';
const AGENT_NAME = 'AI Social Ad Manager';
const AGENT_TITLE = 'Paid Social AI';
const AGENT_DESC = 'Manages budgets, optimizes creatives, and shifts ad spend between Facebook, IG, TikTok, and LinkedIn in real-time.';
const PARENT_NAME = 'Social Media AI';

const METRICS = [
  { label: 'Tasks Today', value: '185', color: ACCENT },
...
const RECENT_TASKS = [
    {
        "action": "Shifted $500 from FB to TikTok ads",
        "time": "12m ago"
    },
    {
        "action": "Paused 5 ad sets with high CPA",
        "time": "40m ago"
    },
    {
        "action": "Duplicated winning ad set to scale",
        "time": "1h ago"
    },
    {
        "action": "Created 3 new lookalike audiences",
        "time": "3h ago"
    },
    {
        "action": "Generated daily ROAS dashboard",
        "time": "4h ago"
    }
];
