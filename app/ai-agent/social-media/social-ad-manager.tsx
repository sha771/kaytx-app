...
export default function AgentPage() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Manages paid social media campaigns, optimizes ad spend, and maximizes ROI.</Text></View>
      ...
      <AgentFeatures agentId="social-ad-manager" agentName="AI Social Ad Manager" />
    </ScrollView>
  );
}
