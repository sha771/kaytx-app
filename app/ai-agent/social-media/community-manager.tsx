...
const ACCENT = '#007AFF';
const AGENT_NAME = 'AI Community Manager';
const AGENT_TITLE = 'Community Engagement AI';
const AGENT_DESC = 'Replies to comments, welcomes new members, moderates discussions, and builds a thriving online community.';
const PARENT_NAME = 'Social Media AI';

const METRICS = [
  { label: 'Tasks Today', value: '850', color: ACCENT },
...
const RECENT_TASKS = [
    {
        "action": "Replied to 45 IG comments",
        "time": "5m ago"
    },
    {
        "action": "Welcomed 12 new Discord members",
        "time": "20m ago"
    },
    {
        "action": "Removed 3 spam links from Facebook",
        "time": "35m ago"
    },
    {
        "action": "Started weekly discussion thread",
        "time": "1h ago"
    },
    {
        "action": "Answered 15 DM product questions",
        "time": "2h ago"
    }
];
