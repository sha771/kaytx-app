...
const ACCENT = '#E1306C';
const AGENT_NAME = 'AI Social Content Creator';
const AGENT_TITLE = 'Social Content AI';
const AGENT_DESC = 'Generates viral tweets, LinkedIn posts, Instagram captions, and short-form video scripts on demand.';
const PARENT_NAME = 'Social Media AI';

const METRICS = [
  { label: 'Tasks Today', value: '124', color: ACCENT },
  { label: 'Success Rate', value: '93%', color: '#00C853' },
  { label: 'Avg Speed', value: '1.5s', color: '#007AFF' },
  { label: 'Accuracy', value: '94.1%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Wrote 5 LinkedIn thought leadership posts",
        "time": "10m ago"
    },
    {
        "action": "Drafted TikTok script for feature launch",
        "time": "30m ago"
    },
    {
        "action": "Generated 10 Twitter thread hooks",
        "time": "1h ago"
    },
    {
        "action": "Created IG carousel copy",
        "time": "2h ago"
    },
    {
        "action": "Researched trending audio tracks",
        "time": "4h ago"
    }
];
