...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'66',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.6s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.2%',icon:Target,color:'#F57F17'}];
  const capabilities = ['Content Generation','Multi-Platform Publishing','Visual Content Creation'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Content Creator</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Creates engaging content for all social media platforms including posts, stories, reels, and graphics.</Text></View>
      ...
      <AgentFeatures agentId="content-creator" agentName="AI Content Creator" />
    </ScrollView>
  );
}
