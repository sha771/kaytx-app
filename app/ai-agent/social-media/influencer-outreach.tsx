...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'248',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'2.1s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.4%',icon:Target,color:'#F57F17'}];
  const capabilities = ['Influencer Discovery','Outreach Automation','Partnership Management'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Influencer Outreach</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Identifies, contacts, and manages influencer partnerships and collaborations.</Text></View>
      ...
      <AgentFeatures agentId="influencer-outreach" agentName="AI Influencer Outreach" />
    </ScrollView>
  );
}
