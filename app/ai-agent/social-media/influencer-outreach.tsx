...
const ACCENT = '#C13584';
const AGENT_NAME = 'AI Influencer Outreach';
const AGENT_TITLE = 'Partnerships AI';
const AGENT_DESC = 'Finds niche influencers, verifies their engagement rates, pitches collaborations, and manages campaigns.';
const PARENT_NAME = 'Social Media AI';

const METRICS = [
  { label: 'Tasks Today', value: '312', color: ACCENT },
  { label: 'Success Rate', value: '90%', color: '#00C853' },
  { label: 'Avg Speed', value: '1.2s', color: '#007AFF' },
  { label: 'Accuracy', value: '91.5%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Scanned 1,000 profiles for brand fit",
        "time": "10m ago"
    },
    {
        "action": "Filtered out 45 fake follower accounts",
        "time": "30m ago"
    },
    {
        "action": "Sent 50 personalized pitch DMs",
        "time": "1h ago"
    },
    {
        "action": "Followed up on 20 pending deals",
        "time": "3h ago"
    },
    {
        "action": "Tracked promo code usage for Campaign X",
        "time": "5h ago"
    }
];
