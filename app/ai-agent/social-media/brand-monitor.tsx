...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'203',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.4s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.2%',icon:Target,color:'#F57F17'}];
  const capabilities = ['Brand Mention Tracking','Sentiment Analysis','Reputation Management'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Brand Monitor</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Monitors brand mentions, sentiment, and reputation across all social platforms.</Text></View>
      ...
      <AgentFeatures agentId="brand-monitor" agentName="AI Brand Monitor" />
    </ScrollView>
  );
}
