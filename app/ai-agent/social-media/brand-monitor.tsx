...
const ACCENT = '#1DA1F2';
const AGENT_NAME = 'AI Brand Monitor';
const AGENT_TITLE = 'Social Listening AI';
const AGENT_DESC = 'Monitors brand mentions 24/7 across the web, tracks sentiment, and alerts you to PR crises before they blow up.';
const PARENT_NAME = 'Social Media AI';

const METRICS = [
  { label: 'Tasks Today', value: '15.4k', color: ACCENT },
...
const RECENT_TASKS = [
    {
        "action": "Analyzed 500 Twitter mentions",
        "time": "2m ago"
    },
    {
        "action": "Flagged negative sentiment spike",
        "time": "15m ago"
    },
    {
        "action": "Tracked competitor campaign hashtag",
        "time": "45m ago"
    },
    {
        "action": "Generated daily brand health score",
        "time": "2h ago"
    },
    {
        "action": "Identified 3 viral user posts",
        "time": "3h ago"
    }
];
