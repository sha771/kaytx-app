...
const ACCENT = '#405DE6';
const AGENT_NAME = 'AI Post Scheduler';
const AGENT_TITLE = 'Content Distribution AI';
const AGENT_DESC = 'Takes approved content and automatically schedules and formats it natively for every specific social platform.';
const PARENT_NAME = 'Social Media AI';

const METRICS = [
  { label: 'Tasks Today', value: '430', color: ACCENT },
...
const RECENT_TASKS = [
    {
        "action": "Scheduled 15 posts for next week",
        "time": "5m ago"
    },
    {
        "action": "Resized images for Pinterest format",
        "time": "25m ago"
    },
    {
        "action": "Cross-posted YouTube short to TikTok",
        "time": "1h ago"
    },
    {
        "action": "Added location tags to IG posts",
        "time": "2h ago"
    },
    {
        "action": "Verified all API connections",
        "time": "6h ago"
    }
];
