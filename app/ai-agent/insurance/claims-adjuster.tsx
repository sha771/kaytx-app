...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'3,469',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.3%',icon:Target,color:'#004D40'}];
  ...
  const activities = [{time:'3 min ago',text:'Processed 25 claims today',icon:CheckCircle2},{time:'6 min ago',text:'Investigated 3 suspicious claims',icon:Clock},{time:'9 min ago',text:'Settled total loss vehicle claim',icon:Zap}];
  return (
