...
import { FolderOpen, Activity, Star, CheckCircle2, Clock, Target, ArrowRight, Zap } from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

export default function AgentPage() {
  const { theme } = useTheme();
  const stats = [{label:'Tasks',value:'4,332',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.2s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.7%',icon:Target,color:'#004D40'}];
  ...
  const activities = [{time:'3 min ago',text:'Managed team processing 200 claims',icon:CheckCircle2},{time:'6 min ago',text:'Reduced average claim cycle by 8 days',icon:Clock},{time:'9 min ago',text:'Published monthly claims report',icon:Zap}];
  return (
