...
import { Layers, Activity, Star, CheckCircle2, Clock, Target, ArrowRight, Zap } from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

export default function AgentPage() {
  const { theme } = useTheme();
  const stats = [{label:'Tasks',value:'3,672',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.4s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.2%',icon:Target,color:'#004D40'}];
  ...
  const activities = [{time:'3 min ago',text:'Placed $50M facultative cover',icon:CheckCircle2},{time:'6 min ago',text:'Recovered $2.3M in reinsurance claims',icon:Clock},{time:'9 min ago',text:'Renewed treaty reinsurance program',icon:Zap}];
  return (
