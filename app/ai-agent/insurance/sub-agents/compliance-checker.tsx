...
export default function ComplianceCheckerPage() {
  const agent = {
    ...
    description: 'Automated Compliance Checker agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
