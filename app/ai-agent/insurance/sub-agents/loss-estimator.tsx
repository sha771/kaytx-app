...
export default function LossEstimatorPage() {
  const agent = {
    ...
    description: 'Automated Loss Estimator agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
