...
const CAPABILITIES = ["Loss Estimation","Occurrence PML","Aggregate PML","Tail VaR Calculation","Reinsurance Loss","Net vs Gross Loss","Uncertainty Quantification","Loss Allocation"];
const RESPONSIBILITIES = ["Estimate catastrophe losses for modeled events and scenarios","Calculate occurrence and aggregate probable maximum losses (PML)","Compute Tail Value-at-Risk and exceedance probability curves","Estimate reinsurance recoveries and net catastrophe losses","Allocate catastrophe losses across business units and lines","Quantify uncertainty in loss estimates and model outputs"];
const METRICS = [{"label":"Loss Estimates","value":"4,821","change":"+247","trend":"up"},{"label":"1-in-100 PML","value":"$412M","change":"-$18M","trend":"up"},{"label":"Reinsurance Recovery","value":"$284M","change":"+$12M","trend":"up"},{"label":"Model Uncertainty","value":"±12%","change":"-2%","trend":"up"}];

export default function LossEstimatorPage() {
  ...
  const activities = [{"time":"4 min ago","text":"Estimated losses for Category 4 hurricane scenario","icon":"Calculator"},{"time":"12 min ago","text":"Calculated 1-in-250 aggregate PML for portfolio","icon":"BarChart3"},{"time":"20 min ago","text":"Estimated reinsurance recovery for M7.2 earthquake","icon":"DollarSign"}];

  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#FF572220' }]}>
          <Calculator size={56} color="#FF5722" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Loss Estimator"}</Text>
      ...
      <AgentFeatures agentId="loss-estimator" agentName="AI Loss Estimator" />
