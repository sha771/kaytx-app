...
export default function LossDevelopmentTrackerPage() {
  const agent = {
    id: 'loss-development-tracker',
    name: 'AI Loss Development Tracker',
    title: 'Insurance Agent',
    description: 'Automated Loss Development Tracker agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Loss Development Tracker',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
