...
export default function SegmentationAnalystPage() {
  const agent = {
    ...
    description: 'Automated Segmentation Analyst agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
