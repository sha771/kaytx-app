...
import {
  Activity, ArrowRight, BarChart3, Briefcase, Calculator, ChevronRight, CircleCheckBig, ClipboardList, Clock, FileText, Shield, Target, TrendingUp, Users, Zap
} from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

const CAPABILITIES = ["Rate Filing Preparation","Regulatory Documentation","Supporting Data Assembly","Actuarial Memoranda","Filing Strategy","Regulatory Communication","Compliance Verification","Filing Tracking"];
const RESPONSIBILITIES = ["Prepare rate filing documentation for regulatory submission","Assemble supporting data and actuarial analyses for filings","Draft actuarial memoranda explaining rate change justifications","Develop filing strategies for optimal regulatory outcomes","Coordinate with regulatory departments on filing requirements","Verify filing compliance with state-specific requirements"];
const METRICS = [{"label":"Filings Prepared","value":"14","change":"+3","trend":"up"},{"label":"Approval Rate","value":"92%","change":"+4%","trend":"up"},{"label":"Avg Prep Time","value":"4.2 days","change":"-18%","trend":"up"},{"label":"Compliance Score","value":"100%","change":"0%","trend":"up"}];

export default function RateFilingPreparerPage() {
  ...
  const activities = [{"time":"3 min ago","text":"Prepared rate filing for CA homeowners rate increase","icon":"FileText"},{"time":"11 min ago","text":"Assembled supporting data for TX auto rate filing","icon":"ClipboardList"},{"time":"19 min ago","text":"Drafted actuarial memorandum for NY commercial filing","icon":"Calculator"}];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Rate Filing Preparer"}</Text>
      ...
      <AgentFeatures agentId="rate-filing-preparer" agentName="AI Rate Filing Preparer" />
