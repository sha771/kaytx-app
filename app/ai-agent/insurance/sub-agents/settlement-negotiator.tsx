...
import {
  Activity, ArrowRight, BarChart3, Briefcase, ChevronRight, CircleCheckBig, Clock, DollarSign, FileText, Handshake, Shield, Target, TrendingUp, Users, Zap
} from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

const CAPABILITIES = ["Settlement Negotiation","Valuation Analysis","Counter-Offer Strategy","Mediation Support","Release Preparation","Payment Processing","Negotiation Analytics","Authority Compliance"];
const RESPONSIBILITIES = ["Negotiate claim settlements with claimants and attorneys","Analyze claim valuations and develop settlement ranges","Develop counter-offer strategies based on claim analysis","Support mediation and alternative dispute resolution processes","Prepare settlement releases and payment authorizations","Process settlement payments within authority limits"];
const METRICS = [{"label":"Settlements","value":"2,847","change":"+142","trend":"up"},{"label":"Avg Settlement","value":"$8,421","change":"-$421","trend":"up"},{"label":"Negotiation Win","value":"72%","change":"+3%","trend":"up"},{"label":"Cycle Time","value":"6.2 days","change":"-14%","trend":"up"}];

export default function SettlementNegotiatorPage() {
  ...
  const activities = [{"time":"5 min ago","text":"Negotiated settlement on $42K bodily injury claim","icon":"Handshake"},{"time":"13 min ago","text":"Prepared counter-offer on disputed property claim","icon":"DollarSign"},{"time":"21 min ago","text":"Processed 8 settlement payments within authority","icon":"CircleCheckBig"}];

  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#FF572220' }]}>
          <Handshake size={56} color="#FF5722" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Settlement Negotiator"}</Text>
      ...
      <AgentFeatures agentId="settlement-negotiator" agentName="AI Settlement Negotiator" />
