...
export default function SettlementNegotiatorPage() {
  const agent = {
    ...
    description: 'Automated Settlement Negotiator agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Settlement Negotiator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
