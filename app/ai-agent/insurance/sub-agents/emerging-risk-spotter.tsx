...
const CAPABILITIES = ["Emerging Risk Identification","Horizon Scanning","Trend Analysis","Early Warning Systems","Scenario Development","Cross-Industry Monitoring","Regulatory Intelligence","Risk Signal Detection"];
const RESPONSIBILITIES = ["Identify emerging risks through horizon scanning and trend analysis","Operate early warning systems for nascent risk signals","Develop emerging risk scenarios and impact assessments","Monitor cross-industry developments for potential insurance impacts","Track regulatory and legislative developments for emerging exposures","Report emerging risk findings to VP Risk Assessment and CRO"];
const METRICS = [{"label":"Risks Identified","value":"34","change":"+7","trend":"up"},{"label":"Early Warnings","value":"12","change":"+3","trend":"up"},{"label":"False Positive","value":"8%","change":"-3%","trend":"up"},{"label":"Horizon Coverage","value":"94%","change":"+2%","trend":"up"}];

export default function EmergingRiskSpotterPage() {
  const { theme } = useTheme();
  const router = useRouter();
  const stats = [
    { label: 'Tasks', value: '34', icon: CircleCheckBig, color: '#34C759' },
  ...
  const activities = [{"time":"4 min ago","text":"Identified emerging AI liability exposure trend","icon":"Eye"},{"time":"11 min ago","text":"Issued early warning on climate regulation changes","icon":"AlertTriangle"},{"time":"19 min ago","text":"Completed quarterly horizon scan report","icon":"FileText"}];

  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#BF360C20' }]}>
          <Eye size={56} color="#BF360C" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Emerging Risk Spotter"}</Text>
      ...
      <AgentFeatures agentId="emerging-risk-spotter" agentName="AI Emerging Risk Spotter" />
