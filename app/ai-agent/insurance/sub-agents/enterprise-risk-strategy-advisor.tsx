...
export default function EnterpriseRiskStrategyAdvisorPage() {
  const agent = {
    id: 'enterprise-risk-strategy-advisor',
    name: 'AI Enterprise Risk Strategy Advisor',
    title: 'Insurance Agent',
    description: 'Automated Enterprise Risk Strategy Advisor agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Enterprise Risk Strategy Advisor',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
