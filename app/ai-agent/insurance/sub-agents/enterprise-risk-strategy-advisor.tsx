...
import {
  Activity, ArrowRight, BarChart3, Briefcase, ChevronRight, CircleCheckBig, Clock, FileText, Shield, Target, TrendingUp, Users, Zap
} from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

const CAPABILITIES = ["Enterprise Risk Strategy","Risk Framework Design","Strategic Risk Planning","Risk Governance Advisory","Cross-Functional Risk Alignment","Board Risk Strategy","Emerging Risk Strategy","Risk Culture Development"];
const RESPONSIBILITIES = ["Develop enterprise-wide risk strategy and strategic risk frameworks","Align risk management with corporate strategy and business objectives","Design risk governance structures and committee frameworks","Advise on emerging risk trends and strategic risk responses","Drive risk culture and awareness across the organization","Coordinate cross-functional risk alignment and escalation protocols"];
const METRICS = [{"label":"Strategies","value":"127","change":"+14","trend":"up"},{"label":"Alignment","value":"96.4%","change":"+2.1%","trend":"up"},{"label":"Board Approvals","value":"43","change":"+5","trend":"up"},{"label":"Risk Score","value":"8.9","change":"+0.4","trend":"up"}];

export default function EnterpriseRiskStrategyAdvisorPage() {
  ...
  const activities = [{"time":"2 min ago","text":"Completed enterprise risk strategy for Q4","icon":"Shield"},{"time":"8 min ago","text":"Aligned risk framework with new regulatory guidance","icon":"FileText"},{"time":"15 min ago","text":"Presented strategic risk outlook to CRO","icon":"BarChart3"}];

  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#FF704320' }]}>
          <Shield size={56} color="#FF7043" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Enterprise Risk Strategy Advisor"}</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>AI Enterprise Risk Strategy Advisor - Sub-agent supporting AI Chief Risk Officer. Part of the Kaytx AI Workforce Insurance hierarchy providing specialized enterprise capabilities for risk management, underwriting, claims, and actuarial operations.</Text></View>
      ...
      <AgentFeatures agentId="enterprise-risk-strategy-advisor" agentName="AI Enterprise Risk Strategy Advisor" />
