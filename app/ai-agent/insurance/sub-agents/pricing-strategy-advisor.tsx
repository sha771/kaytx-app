...
import {
  Activity, ArrowRight, BarChart3, Briefcase, ChevronRight, CircleCheckBig, Clock, DollarSign, FileText, Shield, Target, TrendingUp, Users, Zap
} from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

const CAPABILITIES = ["Pricing Model Development","Rate Indication Analysis","Competitive Benchmarking","Risk-Based Pricing","Technical Pricing","Market Positioning","Profitability Analysis","Regulatory Rate Filing"];
const RESPONSIBILITIES = ["Develop and maintain risk-based pricing models and strategies","Analyze rate indications and recommend pricing adjustments","Benchmark pricing against market competitors and industry data","Ensure technical pricing adequacy and profitability targets","Coordinate rate filing preparation with actuarial team","Advise on market positioning and competitive pricing responses"];
const METRICS = [{"label":"Rate Accuracy","value":"98.7%","change":"+0.5%","trend":"up"},{"label":"Rate Changes","value":"34","change":"+4","trend":"up"},{"label":"Profitability","value":"106.2%","change":"+2.1%","trend":"up"},{"label":"Filings Prepared","value":"8","change":"+2","trend":"up"}];

export default function PricingStrategyAdvisorPage() {
  ...
  const activities = [{"time":"6 min ago","text":"Completed rate indication analysis for homeowners line","icon":"DollarSign"},{"time":"14 min ago","text":"Benchmarked commercial pricing against top 5 competitors","icon":"BarChart3"},{"time":"28 min ago","text":"Prepared rate filing documentation for Q3","icon":"FileText"}];

  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#FF572220' }]}>
          <DollarSign size={56} color="#FF5722" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Pricing Strategy Advisor"}</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>AI Pricing Strategy Advisor - Sub-agent supporting AI VP Underwriting. Part of the Kaytx AI Workforce Insurance hierarchy providing specialized enterprise capabilities for risk management, underwriting, claims, and actuarial operations.</Text></View>
      ...
      <AgentFeatures agentId="pricing-strategy-advisor" agentName="AI Pricing Strategy Advisor" />
