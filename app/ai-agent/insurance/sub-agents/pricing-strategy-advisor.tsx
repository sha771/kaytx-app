...
export default function PricingStrategyAdvisorPage() {
  const agent = {
    ...
    description: 'Automated Pricing Strategy Advisor agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Pricing Strategy Advisor',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
