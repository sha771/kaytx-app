...
import {
  Activity, ArrowRight, BarChart3, Briefcase, Calculator, ChevronRight, CircleCheckBig, Clock, DollarSign, FileText, Shield, Target, TrendingUp, Users, Zap
} from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

const CAPABILITIES = ["Premium Calculation","Rating Engine Operation","Discount Application","Surcharge Management","Tax & Fee Calculation","Payment Scheduling","Quote Generation","Comparative Analysis"];
const RESPONSIBILITIES = ["Calculate insurance premiums using company rating algorithms","Operate rating engines for accurate premium determination","Apply discounts, surcharges, and rating modifications","Calculate taxes, fees, and regulatory assessments","Set up payment schedules and installment plans","Generate quotes and comparative premium analyses"];
const METRICS = [{"label":"Premiums Calculated","value":"12,847","change":"+621","trend":"up"},{"label":"Calculation Accuracy","value":"99.9%","change":"+0.1%","trend":"up"},{"label":"Avg Calc Time","value":"0.8s","change":"-34%","trend":"up"},{"label":"Quotes Generated","value":"8,421","change":"+412","trend":"up"}];
...
export default function PremiumCalculatorPage() {
  ...
  const activities = [{"time":"2 min ago","text":"Calculated premiums for 42 new business quotes","icon":"Calculator"},{"time":"9 min ago","text":"Applied loyalty discounts to 18 renewal quotes","icon":"DollarSign"},{"time":"16 min ago","text":"Generated comparative analysis for 3 competing quotes","icon":"BarChart3"}];

  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#FF704320' }]}>
          <Calculator size={56} color="#FF7043" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Premium Calculator"}</Text>
      ...
      <AgentFeatures agentId="premium-calculator" agentName="AI Premium Calculator" />
