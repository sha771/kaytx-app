...
import {
  Activity, ArrowRight, BarChart3, Briefcase, ChevronRight, CircleCheckBig, Clock, FileText, GitBranch, Shield, Target, TrendingUp, Users, Zap
} from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

const CAPABILITIES = ["Scenario Construction","Stress Testing","What-If Analysis","Monte Carlo Simulation","Scenario Comparison","Parameter Variation","Historical Scenario Replay","Forward-Looking Scenarios"];
const RESPONSIBILITIES = ["Construct risk scenarios for stress testing and capital planning","Design what-if analyses for risk management decision support","Run Monte Carlo simulations for probabilistic risk assessment","Compare scenario outcomes and rank risk management strategies","Vary model parameters to test sensitivity and robustness","Replay historical scenarios and develop forward-looking projections"];
const METRICS = [{"label":"Scenarios Built","value":"47","change":"+8","trend":"up"},{"label":"Simulations Run","value":"2.4M","change":"+400K","trend":"up"},{"label":"Scenario Coverage","value":"94%","change":"+3%","trend":"up"},{"label":"Calibration Fit","value":"0.96","change":"+0.02","trend":"up"}];
...
export default function ScenarioBuilderPage() {
  ...
  const activities = [{"time":"4 min ago","text":"Built pandemic scenario for enterprise stress test","icon":"GitBranch"},{"time":"12 min ago","text":"Ran 800K Monte Carlo iterations for capital model","icon":"Zap"},{"time":"20 min ago","text":"Compared 3 reinsurance strategies under hurricane scenario","icon":"BarChart3"}];

  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#FF572220' }]}>
          <GitBranch size={56} color="#FF5722" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Scenario Builder"}</Text>
      ...
      <AgentFeatures agentId="scenario-builder" agentName="AI Scenario Builder" />
