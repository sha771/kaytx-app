...
export default function ScenarioBuilderPage() {
  const agent = {
    ...
    description: 'Automated Scenario Builder agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
