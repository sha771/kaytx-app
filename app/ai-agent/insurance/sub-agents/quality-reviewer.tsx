...
const CAPABILITIES = ["Quality Assurance","Decision Review","Compliance Checking","Documentation Audit","Best Practice Enforcement","Error Detection","Feedback Generation","Training Identification"];
const RESPONSIBILITIES = ["Review underwriting decisions for quality and compliance","Audit underwriting documentation for completeness and accuracy","Enforce underwriting best practices and decision consistency","Detect errors and inconsistencies in underwriting outputs","Generate quality feedback for underwriting team improvement","Identify training needs based on quality review findings"];
const METRICS = [{"label":"Reviews Completed","value":"2,847","change":"+142","trend":"up"},{"label":"Quality Score","value":"96.4%","change":"+1.1%","trend":"up"},{"label":"Errors Caught","value":"34","change":"-12","trend":"up"},{"label":"Documentation Rate","value":"99.2%","change":"+0.4%","trend":"up"}];
...
export default function QualityReviewerPage() {
  ...
  const activities = [{"time":"5 min ago","text":"Completed quality review of 18 commercial policies","icon":"SquareCheck"},{"time":"12 min ago","text":"Identified documentation gap in 3 submissions","icon":"AlertTriangle"},{"time":"20 min ago","text":"Generated quality feedback report for team","icon":"FileText"}];

  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#FF704320' }]}>
          <SquareCheck size={56} color="#FF7043" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Quality Reviewer"}</Text>
      ...
      <AgentFeatures agentId="quality-reviewer" agentName="AI Quality Reviewer" />
