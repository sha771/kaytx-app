...
export default function ExceptionApproverPage() {
  const agent = {
    ...
    description: 'Automated Exception Approver agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Exception Approver',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
