...
import {
  Activity, ArrowRight, BarChart3, Briefcase, ChevronRight, CircleCheckBig, ClipboardList, Clock, DollarSign, FileText, Shield, Target, TrendingUp, Users, Zap
} from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

const CAPABILITIES = ["Endorsement Processing","Change Management","Premium Adjustment","Documentation Generation","Compliance Verification","Agent Coordination","Audit Trail","Batch Processing"];
const RESPONSIBILITIES = ["Process policy endorsements and modifications accurately","Manage policy change requests from agents and policyholders","Adjust premiums for endorsement changes and coverage modifications","Generate endorsement documentation and policy forms","Verify endorsement compliance with underwriting guidelines","Maintain complete audit trails for all endorsement transactions"];
const METRICS = [{"label":"Endorsements Processed","value":"6,847","change":"+321","trend":"up"},{"label":"Processing Time","value":"4.2 min","change":"-18%","trend":"up"},{"label":"Accuracy Rate","value":"99.4%","change":"+0.2%","trend":"up"},{"label":"Compliance Rate","value":"100%","change":"0%","trend":"up"}];

export default function EndorsementProcessorPage() {
  ...
  const activities = [{"time":"3 min ago","text":"Processed 28 endorsement requests in batch","icon":"FileText"},{"time":"10 min ago","text":"Adjusted premiums for 12 coverage change endorsements","icon":"DollarSign"},{"time":"17 min ago","text":"Generated endorsement documentation for 8 policies","icon":"ClipboardList"}];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Endorsement Processor"}</Text>
      ...
      <AgentFeatures agentId="endorsement-processor" agentName="AI Endorsement Processor" />
