...
export default function DocumentGeneratorPage() {
  const agent = {
    ...
    description: 'Automated Document Generator agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Document Generator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
