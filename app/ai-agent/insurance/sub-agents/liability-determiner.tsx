...
import {
  Activity, ArrowRight, BarChart3, Briefcase, ChevronRight, CircleCheckBig, Clock, DollarSign, FileText, Scale, Shield, Target, TrendingUp, Users, Zap
} from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

const CAPABILITIES = ["Liability Determination","Negligence Analysis","Comparative Fault","Coverage Verification","Subrogation Assessment","Legal Research","Witness Analysis","Statute Compliance"];
const RESPONSIBILITIES = ["Determine liability for claims based on facts and policy coverage","Analyze negligence and comparative fault in accident claims","Verify coverage applicability and policy conditions","Assess subrogation potential and recovery opportunities","Research legal precedents and statutory requirements","Evaluate witness statements and evidence for liability decisions"];
const METRICS = [{"label":"Determinations","value":"4,821","change":"+247","trend":"up"},{"label":"Accuracy","value":"98.2%","change":"+0.6%","trend":"up"},{"label":"Subrogation Found","value":"$1.2M","change":"+$142K","trend":"up"},{"label":"Avg Time","value":"3.8 hrs","change":"-22%","trend":"up"}];

export default function LiabilityDeterminerPage() {
  ...
  const activities = [{"time":"4 min ago","text":"Determined liability on 14 auto accident claims","icon":"Scale"},{"time":"12 min ago","text":"Identified subrogation opportunity on 3 claims","icon":"DollarSign"},{"time":"20 min ago","text":"Verified coverage on 8 disputed liability claims","icon":"Shield"}];

  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#FF572220' }]}>
          <Scale size={56} color="#FF5722" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Liability Determiner"}</Text>
      ...
      <AgentFeatures agentId="liability-determiner" agentName="AI Liability Determiner" />
