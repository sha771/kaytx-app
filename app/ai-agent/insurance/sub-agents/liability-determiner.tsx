...
export default function LiabilityDeterminerPage() {
  const agent = {
    id: 'liability-determiner',
    name: 'AI Liability Determiner',
    title: 'Insurance Agent',
    description: 'Automated Liability Determiner agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Liability Determiner',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
