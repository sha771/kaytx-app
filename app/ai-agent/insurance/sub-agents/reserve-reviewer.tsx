...
const CAPABILITIES = ["Reserve Adequacy Review","IBNR Estimation","Development Factor Analysis","Reserve Adjustment","Financial Impact Assessment","Actuarial Coordination","Regulatory Compliance","Trend Monitoring"];
const RESPONSIBILITIES = ["Review claim reserves for adequacy and consistency","Estimate incurred but not reported (IBNR) reserves","Analyze development factors and reserve trending patterns","Recommend reserve adjustments based on claim progression","Assess financial impact of reserve changes on company results","Coordinate with actuarial team on reserve methodology"];
const METRICS = [{"label":"Reserves Reviewed","value":"3,421","change":"+187","trend":"up"},{"label":"Adequacy Score","value":"97.2%","change":"+0.8%","trend":"up"},{"label":"Adjustments Made","value":"142","change":"-23","trend":"up"},{"label":"IBNR Accuracy","value":"94.8%","change":"+1.4%","trend":"up"}];

export default function ReserveReviewerPage() {
  ...
  const activities = [{"time":"5 min ago","text":"Reviewed reserves on 28 open commercial claims","icon":"DollarSign"},{"time":"13 min ago","text":"Adjusted reserves on 4 claims with new development","icon":"TrendingUp"},{"time":"21 min ago","text":"Coordinated IBNR estimate with actuarial team","icon":"Calculator"}];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Reserve Reviewer"}</Text>
      ...
      <AgentFeatures agentId="reserve-reviewer" agentName="AI Reserve Reviewer" />
