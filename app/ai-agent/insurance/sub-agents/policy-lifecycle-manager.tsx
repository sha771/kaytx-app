...
export default function PolicyLifecycleManagerPage() {
  const agent = {
    ...
    description: 'Automated Policy Lifecycle Manager agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Policy Lifecycle Manager',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
