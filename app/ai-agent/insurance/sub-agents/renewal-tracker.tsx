...
export default function RenewalTrackerPage() {
  const agent = {
    ...
    description: 'Automated Renewal Tracker agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
