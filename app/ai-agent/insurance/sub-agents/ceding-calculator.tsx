...
export default function CedingCalculatorPage() {
  const agent = {
    id: 'ceding-calculator',
    name: 'AI Ceding Calculator',
    title: 'Insurance Agent',
    description: 'Automated Ceding Calculator agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Ceding Calculator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
