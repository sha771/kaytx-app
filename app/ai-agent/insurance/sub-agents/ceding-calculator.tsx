...
const CAPABILITIES = ["Ceding Calculation","Premium Ceding","Commission Calculation","Bordereaux Preparation","Retention Analysis","Treaty Allocation","Proportional Computation","Non-Proportional Rating"];
const RESPONSIBILITIES = ["Calculate ceding amounts for proportional and non-proportional treaties","Compute premium ceding and reinsurance commission amounts","Prepare bordereaux reports for reinsurance counterparties","Analyze retention levels and ceding optimization opportunities","Allocate risks to appropriate treaty programs automatically","Compute reinstatement premiums and aggregate deductible tracking"];
const METRICS = [{"label":"Calculations","value":"24,847","change":"+1,247","trend":"up"},{"label":"Ceding Accuracy","value":"99.8%","change":"+0.1%","trend":"up"},{"label":"Bordereaux On-Time","value":"100%","change":"0%","trend":"up"},{"label":"Retention Optimal","value":"94%","change":"+2%","trend":"up"}];

export default function CedingCalculatorPage() {
  ...
  const activities = [{"time":"3 min ago","text":"Calculated ceding for 847 risks under quota share treaty","icon":"DollarSign"},{"time":"10 min ago","text":"Prepared monthly bordereaux for 3 treaty counterparties","icon":"ClipboardList"},{"time":"18 min ago","text":"Analyzed retention optimization for property cat treaty","icon":"BarChart3"}];

  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#E64A1920' }]}>
          <DollarSign size={56} color="#E64A19" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Ceding Calculator"}</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>AI Ceding Calculator - Sub-agent supporting AI Reinsurance Specialist. Part of the Kaytx AI Workforce Insurance hierarchy providing specialized enterprise capabilities for risk management, underwriting, claims, and actuarial operations.</Text></View>
      ...
      <AgentFeatures agentId="ceding-calculator" agentName="AI Ceding Calculator" />
