...
export default function AnomalyScorerPage() {
  const agent = {
    ...
    description: 'Automated Anomaly Scorer agent specializing in insurance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
