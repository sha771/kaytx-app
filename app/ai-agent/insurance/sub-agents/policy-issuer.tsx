...
import {
  Activity, ArrowRight, BarChart3, Briefcase, ChevronRight, CircleCheckBig, Clock, FileText, Shield, SquareCheck, Target, TrendingUp, Users, Zap
} from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

const CAPABILITIES = ["Policy Issuance","Document Generation","Binding Processing","Number Assignment","First Premium Collection","Delivery Coordination","Quality Verification","System Integration"];
const RESPONSIBILITIES = ["Issue approved policies and generate policy documents","Process binding requests and confirm coverage effective dates","Assign policy numbers and maintain numbering sequences","Coordinate first premium collection and payment setup","Manage policy delivery to agents and policyholders","Verify issuance quality and integrate with policy systems"];
const METRICS = [{"label":"Policies Issued","value":"8,421","change":"+421","trend":"up"},{"label":"Issuance Time","value":"3.2 min","change":"-28%","trend":"up"},{"label":"Quality Score","value":"99.4%","change":"+0.2%","trend":"up"},{"label":"Binding Rate","value":"97.8%","change":"+1.2%","trend":"up"}];

export default function PolicyIssuerPage() {
  ...
  const activities = [{"time":"2 min ago","text":"Issued 18 new commercial policies in batch","icon":"FileText"},{"time":"9 min ago","text":"Processed 4 binding requests for immediate coverage","icon":"Zap"},{"time":"16 min ago","text":"Verified quality on 42 issued policies","icon":"SquareCheck"}];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>{"AI Policy Issuer"}</Text>
      ...
      <AgentFeatures agentId="policy-issuer" agentName="AI Policy Issuer" />
