...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'1,509',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.5s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.8%',icon:Target,color:'#004D40'}];
  ...
  const activities = [{time:'3 min ago',text:'Identified $450K in suspicious claims',icon:CheckCircle2},{time:'6 min ago',text:'Analyzed fraud pattern trends',icon:Clock},{time:'9 min ago',text:'Referred 5 cases to SIU',icon:Zap}];
  return (
