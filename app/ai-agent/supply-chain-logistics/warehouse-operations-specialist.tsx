...
export default function WarehouseOperationsSpecialistPage() {
  const agent = {
    id: 'warehouse-operations-specialist',
    name: 'AI Warehouse Operations Specialist',
    title: 'AI Warehouse Operations Specialist',
    description: 'AI Warehouse Operations Specialist provides specialized expertise and executes critical tasks for the Supply Chain & Logistics department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'warehouse-operations-specialist',
    infrastructure: {
      status: 'online',
