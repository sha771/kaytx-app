...
export default function E-commerceFulfillmentSpecialistPage() {
  const agent = {
    id: 'e-commerce-fulfillment-specialist',
    name: 'AI E-commerce Fulfillment Specialist',
    title: 'AI E-commerce Fulfillment Specialist',
    description: 'AI E-commerce Fulfillment Specialist provides specialized expertise and executes critical tasks for the Supply Chain & Logistics department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'e-commerce-fulfillment-specialist',
    infrastructure: {
      status: 'online',
