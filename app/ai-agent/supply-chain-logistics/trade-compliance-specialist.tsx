...
export default function TradeComplianceSpecialistPage() {
  const agent = {
    id: 'trade-compliance-specialist',
    name: 'AI Trade Compliance Specialist',
    title: 'AI Trade Compliance Specialist',
    description: 'AI Trade Compliance Specialist provides specialized expertise and executes critical tasks for the Supply Chain & Logistics department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'trade-compliance-specialist',
    infrastructure: {
      status: 'online',
