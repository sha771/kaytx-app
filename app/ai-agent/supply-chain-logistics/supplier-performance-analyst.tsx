...
export default function SupplierPerformanceAnalystPage() {
  const agent = {
    id: 'supplier-performance-analyst',
    name: 'AI Supplier Performance Analyst',
    title: 'AI Supplier Performance Analyst',
    description: 'AI Supplier Performance Analyst provides specialized expertise and executes critical tasks for the Supply Chain & Logistics department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'supplier-performance-analyst',
    infrastructure: {
      status: 'online',
