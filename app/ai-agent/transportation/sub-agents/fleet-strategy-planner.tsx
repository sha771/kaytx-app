...
import { Activity, Star, CircleCheckBig, Target, ArrowRight, Zap, Users, MessageSquare, Calendar, ChartBarBig, TrendingUp, AlertTriangle, FileText, ChevronRight, Map } from 'lucide-react-native';
...
export default function FleetStrategyPlannerPage() {
  ...
  const capabilities = [
    'Fleet Strategy Planner', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Fleet Strategy Planner operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Fleet Strategy Planner workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Fleet Strategy Planner parameters for 5% improvement', icon: TrendingUp },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#0EA5E920' }]}>
          <Map size={56} color="#0EA5E9" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Fleet Strategy Planner</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Fleet Strategy Planner is a specialized sub-agent supporting AI VP Transportation. It provides enterprise-grade Fleet Strategy Planner capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="fleet-strategy-planner" agentName="AI Fleet Strategy Planner" />
