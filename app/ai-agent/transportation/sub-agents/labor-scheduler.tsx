...
export default function LaborSchedulerPage() {
  ...
  const capabilities = [
    'Labor Scheduler', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Labor Scheduler operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Labor Scheduler workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Labor Scheduler parameters for 5% improvement', icon: TrendingUp },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#0EA5E920' }]}>
          <Users size={56} color="#0EA5E9" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Labor Scheduler</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Labor Scheduler is a specialized sub-agent supporting AI Warehouse Manager. It provides enterprise-grade Labor Scheduler capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="labor-scheduler" agentName="AI Labor Scheduler" />
