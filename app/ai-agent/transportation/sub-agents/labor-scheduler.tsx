...
export default function LaborSchedulerPage() {
  const agent = {
    ...
    description: 'Automated Labor Scheduler agent specializing in transportation operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
