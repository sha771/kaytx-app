...
import { Activity, Star, CircleCheckBig, Target, ArrowRight, Zap, Users, MessageSquare, Calendar, ChartBarBig, TrendingUp, AlertTriangle, FileText, ChevronRight, MapPin } from 'lucide-react-native';
...
export default function NetworkOptimizerPage() {
  ...
  const capabilities = [
    'Network Optimizer', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Network Optimizer operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Network Optimizer workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Network Optimizer parameters for 5% improvement', icon: TrendingUp },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#0EA5E920' }]}>
          <MapPin size={56} color="#0EA5E9" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Network Optimizer</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Network Optimizer is a specialized sub-agent supporting AI Chief Logistics Officer. It provides enterprise-grade Network Optimizer capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="network-optimizer" agentName="AI Network Optimizer" />
