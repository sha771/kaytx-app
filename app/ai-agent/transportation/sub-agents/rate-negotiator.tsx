...
import { Activity, Star, CircleCheckBig, Target, ArrowRight, Zap, Users, MessageSquare, Calendar, ChartBarBig, TrendingUp, AlertTriangle, FileText, ChevronRight, DollarSign } from 'lucide-react-native';
...
export default function rateNegotiatorPage() {
  ...
  const capabilities = [
    'Rate Negotiator', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Rate Negotiator operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Rate Negotiator workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Rate Negotiator parameters for 5% improvement', icon: TrendingUp },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#0EA5E920' }]}>
          <DollarSign size={56} color="#0EA5E9" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Rate Negotiator</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Rate Negotiator is a specialized sub-agent supporting AI Freight Broker. It provides enterprise-grade Rate Negotiator capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="rate-negotiator" agentName="AI Rate Negotiator" />
