...
export default function DriverAssignmentAgentPage() {
  const agent = {
    id: 'driver-assignment-agent',
    name: 'AI Driver Assignment Agent',
    title: 'Transportation Agent',
    description: 'Automated Driver Assignment Agent agent specializing in transportation operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Driver Assignment Agent',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
