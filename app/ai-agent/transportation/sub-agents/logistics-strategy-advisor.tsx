...
export default function LogisticsStrategyAdvisorPage() {
  ...
  const capabilities = [
    'Logistics Strategy Advisor', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Logistics Strategy Advisor operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Logistics Strategy Advisor workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Logistics Strategy Advisor parameters for 5% improvement', icon: TrendingUp },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#0EA5E920' }]}>
          <Globe size={56} color="#0EA5E9" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Logistics Strategy Advisor</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Logistics Strategy Advisor is a specialized sub-agent supporting AI Chief Logistics Officer. It provides enterprise-grade Logistics Strategy Advisor capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="logistics-strategy-advisor" agentName="AI Logistics Strategy Advisor" />
