...
export default function exceptionAlerterPage() {
  ...
  const capabilities = [
    'Exception Alerter', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Exception Alerter operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Exception Alerter workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Exception Alerter parameters for 5% improvement', icon: TrendingUp },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#0EA5E920' }]}>
          <AlertTriangle size={56} color="#0EA5E9" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Exception Alerter</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Exception Alerter is a specialized sub-agent supporting AI Tracking Specialist. It provides enterprise-grade Exception Alerter capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="exception-alerter" agentName="AI Exception Alerter" />
