...
export default function documentPreparerPage() {
  ...
  const capabilities = [
    'Document Preparer', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Document Preparer operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Document Preparer workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Document Preparer parameters for 5% improvement', icon: TrendingUp },
  ];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Document Preparer</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Document Preparer is a specialized sub-agent supporting AI Customs Specialist. It provides enterprise-grade Document Preparer capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
