...
import { Activity, Star, CircleCheckBig, Target, ArrowRight, Zap, Users, MessageSquare, Calendar, ChartBarBig, TrendingUp, AlertTriangle, FileText, ChevronRight, Shield } from 'lucide-react-native';
...
export default function carrierQualifierPage() {
  ...
  const capabilities = [
    'Carrier Qualifier', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Carrier Qualifier operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Carrier Qualifier workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Carrier Qualifier parameters for 5% improvement', icon: TrendingUp },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#0EA5E920' }]}>
          <Shield size={56} color="#0EA5E9" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Carrier Qualifier</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Carrier Qualifier is a specialized sub-agent supporting AI Freight Broker. It provides enterprise-grade Carrier Qualifier capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="carrier-qualifier" agentName="AI Carrier Qualifier" />
