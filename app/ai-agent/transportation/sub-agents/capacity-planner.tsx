...
export default function CapacityPlannerPage() {
  ...
  const capabilities = [
    'Capacity Planner', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Capacity Planner operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Capacity Planner workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Capacity Planner parameters for 5% improvement', icon: TrendingUp },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Capacity Planner is a specialized sub-agent supporting AI VP Transportation. It provides enterprise-grade Capacity Planner capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
