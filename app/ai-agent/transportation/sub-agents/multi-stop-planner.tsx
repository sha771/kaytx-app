...
export default function MultiStopPlannerPage() {
  ...
  const capabilities = [
    'Multi-stop Planner', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Multi-stop Planner operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Multi-stop Planner workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Multi-stop Planner parameters for 5% improvement', icon: TrendingUp },
  ];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Multi-stop Planner</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Multi-stop Planner is a specialized sub-agent supporting AI Route Optimizer. It provides enterprise-grade Multi-stop Planner capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="multi-stop-planner" agentName="AI Multi-stop Planner" />
