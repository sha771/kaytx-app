...
export default function RouteNetworkDesignerPage() {
  const agent = {
    id: 'route-network-designer',
    name: 'AI Route Network Designer',
    title: 'Transportation Agent',
    description: 'Automated Route Network Designer agent specializing in transportation operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Route Network Designer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
