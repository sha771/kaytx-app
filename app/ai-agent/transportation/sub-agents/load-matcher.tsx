...
export default function LoadMatcherPage() {
  const agent = {
    ...
    description: 'Automated Load Matcher agent specializing in transportation operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
