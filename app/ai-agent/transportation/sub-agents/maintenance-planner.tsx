...
import { Activity, Star, CircleCheckBig, Target, ArrowRight, Zap, Users, MessageSquare, Calendar, ChartBarBig, TrendingUp, AlertTriangle, FileText, ChevronRight, Wrench } from 'lucide-react-native';
...
export default function MaintenancePlannerPage() {
  ...
  const capabilities = [
    'Maintenance Planner', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Maintenance Planner operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Maintenance Planner workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Maintenance Planner parameters for 5% improvement', icon: TrendingUp },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#0EA5E920' }]}>
          <Wrench size={56} color="#0EA5E9" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Maintenance Planner</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Maintenance Planner is a specialized sub-agent supporting AI Fleet Manager. It provides enterprise-grade Maintenance Planner capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="maintenance-planner" agentName="AI Maintenance Planner" />
