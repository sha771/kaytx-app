...
export default function CustomerNotifierPage() {
  const agent = {
    ...
    description: 'Automated Customer Notifier agent specializing in transportation operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Customer Notifier',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
