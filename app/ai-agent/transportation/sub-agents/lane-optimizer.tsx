...
export default function LaneOptimizerPage() {
  const agent = {
    ...
    description: 'Automated Lane Optimizer agent specializing in transportation operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
