...
export default function CarrierAllocatorPage() {
  const agent = {
    id: 'carrier-allocator',
    name: 'AI Carrier Allocator',
    title: 'Transportation Agent',
    description: 'Automated Carrier Allocator agent specializing in transportation operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Carrier Allocator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
