...
import { Activity, Star, CircleCheckBig, Target, ArrowRight, Zap, Users, MessageSquare, Calendar, ChartBarBig, TrendingUp, AlertTriangle, FileText, ChevronRight, Package } from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

export default function PickPackCoordinatorPage() {
  ...
  const capabilities = [
    'Pick & Pack Coordinator', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Pick & Pack Coordinator operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Pick & Pack Coordinator workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Pick & Pack Coordinator parameters for 5% improvement', icon: TrendingUp },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#0EA5E920' }]}>
          <Package size={56} color="#0EA5E9" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Pick & Pack Coordinator</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Pick & Pack Coordinator is a specialized sub-agent supporting AI Warehouse Operator. It provides enterprise-grade Pick & Pack Coordinator capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="pick-pack-coordinator" agentName="AI Pick & Pack Coordinator" />
