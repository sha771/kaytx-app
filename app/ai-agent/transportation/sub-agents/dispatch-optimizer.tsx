...
export default function dispatchOptimizerPage() {
  ...
  const capabilities = [
    'Dispatch Optimizer', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Dispatch Optimizer operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Dispatch Optimizer workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Dispatch Optimizer parameters for 5% improvement', icon: TrendingUp },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#0EA5E920' }]}>
          <Zap size={56} color="#0EA5E9" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Dispatch Optimizer</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Dispatch Optimizer is a specialized sub-agent supporting AI Fleet Coordinator. It provides enterprise-grade Dispatch Optimizer capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="dispatch-optimizer" agentName="AI Dispatch Optimizer" />
