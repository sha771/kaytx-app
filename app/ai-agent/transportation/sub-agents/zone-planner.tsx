...
export default function ZonePlannerPage() {
  const agent = {
    ...
    description: 'Automated Zone Planner agent specializing in transportation operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
