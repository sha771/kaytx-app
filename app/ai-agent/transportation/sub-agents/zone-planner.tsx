...
export default function zonePlannerPage() {
  ...
  const capabilities = [
    'Zone Planner', 'Automation', 'AI-Powered', 'Real-time', 'Analytics',
  ...
  const responsibilities = [
    'Execute Zone Planner operations with enterprise-grade precision',
  ...
  const activities = [
    { time: '2 min ago', text: 'Processed Zone Planner workflow batch', icon: Zap },
    ...
    { time: '3 hr ago', text: 'Optimized Zone Planner parameters for 5% improvement', icon: TrendingUp },
  ];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Zone Planner</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Zone Planner is a specialized sub-agent supporting AI Distribution Manager. It provides enterprise-grade Zone Planner capabilities with real-time monitoring, optimization, and analytics integration across the transportation and logistics network.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="zone-planner" agentName="AI Zone Planner" />
