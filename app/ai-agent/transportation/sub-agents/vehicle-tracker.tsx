...
export default function VehicleTrackerPage() {
  const agent = {
    ...
    description: 'Automated Vehicle Tracker agent specializing in transportation operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
