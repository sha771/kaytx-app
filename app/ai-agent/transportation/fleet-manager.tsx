...
import {
  Activity, Star, CircleCheckBig, Clock, Target, ArrowRight, Users, MessageSquare, Calendar, ChartBarBig, TrendingUp, AlertTriangle, FileText, ChevronRight, Truck, Gauge, Wrench
...
const METRICS = [
  { label: 'Vehicle Availability', value: '96.3%', change: '+2.1%', trend: 'up' },
  { label: 'Fuel Efficiency', value: '8.2 mpg', change: '+12%', trend: 'up' },
  { label: 'Maintenance SLA', value: '99.4%', change: '+0.8%', trend: 'up' },
  { label: 'Fleet Size', value: '2,847', change: '+142', trend: 'up' },
];
...
export default function fleetManagerPage() {
  ...
  const stats = [
    { label: 'Tasks', value: '2,893', icon: CircleCheckBig, color: '#34C759' },
  ...
  const capabilities = [
    'Fleet Management', 'Vehicle Scheduling', 'Fuel Management', 'Maintenance Planning', 'Vehicle Tracking', 'Driver Assignment', 'Lifecycle Management', 'Telematics', 'GPS Monitoring', 'Insurance Management', 'Depreciation Tracking', 'Compliance', 'Vehicle Procurement', 'Disposal Planning', 'Safety Programs', 'Cost Control'
  ];

  const responsibilities = [
    'Fleet vehicle scheduling and assignment optimization',
    'Fuel consumption monitoring and efficiency improvement',
    'Preventive maintenance scheduling and lifecycle management',
    'Vehicle tracking and telematics system management',
    'Driver assignment and vehicle allocation coordination',
    'Vehicle procurement and disposal planning',
    'Fleet insurance and compliance management',
    'Depreciation tracking and cost control',
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Fleet Manager</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Fleet Operations & Vehicle Management</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Fleet Manager manages fleet operations & vehicle management across the transportation and logistics network. This agent ensures optimal performance through its specialized sub-agents: Vehicle Scheduler, Fuel Efficiency Monitor, Maintenance Planner.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Direct reports executing specialized functions under AI Fleet Manager direction.
        </Text>
      ...
      <AgentFeatures agentId="fleet-manager" agentName="AI Fleet Manager" />
