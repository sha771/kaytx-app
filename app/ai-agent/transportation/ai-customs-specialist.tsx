...
import {
  Activity, Star, CircleCheckBig, Clock, Target, ArrowRight, Users, MessageSquare, Calendar, ChartBarBig, TrendingUp, AlertTriangle, FileText, ChevronRight, Globe, Calculator, ShieldCheck, DollarSign
...
const METRICS = [
  { label: 'Clearance Rate', value: '98.7%', change: '+1.2%', trend: 'up' },
  { label: 'Duty Savings', value: '$2.4M', change: '+18%', trend: 'up' },
  { label: 'Doc Accuracy', value: '99.9%', change: '+0.1%', trend: 'up' },
  { label: 'Active Entries', value: '1,247', change: '+89', trend: 'up' },
];

export default function aiCustomsSpecialistPage() {
  const { theme } = useTheme();
  const router = useRouter();

  const stats = [
    { label: 'Tasks', value: '7,780', icon: CircleCheckBig, color: '#34C759' },
  ...
  const responsibilities = [
    'Duty and tariff calculation and optimization',
    'Customs document preparation and filing management',
    'Trade compliance verification and restricted party screening',
    'HS code classification and product categorization',
    'Free trade agreement utilization and qualification',
    'Duty drawback program management and claims',
    'Customs broker management and entry filing oversight',
    'Clearance tracking and exception resolution',
    'Sanctions compliance and country of origin management'
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#26A69A20' }]}>
          <Globe size={48} color="#26A69A" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Customs Specialist</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Customs Compliance & Trade Documentation</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Customs Specialist manages customs compliance & trade documentation across the transportation and logistics network. This agent ensures optimal performance through its specialized sub-agents: Duty Calculator, Document Preparer, Compliance Checker.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Direct reports executing specialized functions under AI Customs Specialist direction.
        </Text>
      ...
      <AgentFeatures agentId="ai-customs-specialist" agentName="AI Customs Specialist" />
