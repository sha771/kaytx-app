...
import {
  Activity, Star, CircleCheckBig, Clock, Target, ArrowRight, Users, MessageSquare, Calendar, ChartBarBig, TrendingUp, AlertTriangle, FileText, ChevronRight, MapPin, Truck
...
const METRICS = [
  { label: 'Zone Coverage', value: '98.4%', change: '+1.6%', trend: 'up' },
  { label: 'Window Compliance', value: '96.7%', change: '+2.3%', trend: 'up' },
  { label: 'Carrier Utilization', value: '89.1%', change: '+5.2%', trend: 'up' },
  { label: 'Distribution Centers', value: '24', change: '+2', trend: 'up' },
];
...
export default function distributionManagerPage() {
  ...
  const stats = [
    { label: 'Tasks', value: '8,336', icon: CircleCheckBig, color: '#34C759' },
  ...
  const responsibilities = [
    'Distribution zone design and territory optimization',
    'Delivery window scheduling and appointment management',
    'Carrier allocation and load assignment optimization',
    'Load planning and route balancing across distribution zones',
    'Stock transfer and replenishment coordination',
    'Distribution channel management and analytics',
    'Priority management and service level allocation',
    'Service area design and capacity planning',
    'Cost optimization across distribution network'
  ];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Distribution Manager</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Distribution Network & Zone Management</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Distribution Manager manages distribution network & zone management across the transportation and logistics network. This agent ensures optimal performance through its specialized sub-agents: Zone Planner, Delivery Window Manager, Carrier Allocator.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Direct reports executing specialized functions under AI Distribution Manager direction.
        </Text>
      ...
      <AgentFeatures agentId="distribution-manager" agentName="AI Distribution Manager" />
