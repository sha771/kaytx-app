...
export default function PropertyInvestmentManagerPage() {
  const agent = {
    id: 'property-investment-manager',
    name: 'AI Property Investment Manager',
    title: 'AI Property Investment Manager',
    ...
    replacesRole: 'property-investment-manager',
    infrastructure: {
      status: 'online',
