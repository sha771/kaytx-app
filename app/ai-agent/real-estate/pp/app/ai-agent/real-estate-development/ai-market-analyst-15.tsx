...
export default function AgentPage() {
  const agent = {
    ...
    description: 'AI Market Analyst - Market Analyst level AI agent in the real estate-development department. Part of the Kaytx AI Workforce hierarchy providing specialized real estate-development capabilities.',
