...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'1,603',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.0%',icon:Target,color:'#BF360C'}];
  ...
  const activities = [{time:'3 min ago',text:'Created weekly production schedule',icon:CheckCircle2},{time:'6 min ago',text:'Resolved capacity bottleneck on line 2',icon:Clock},{time:'9 min ago',text:'Updated BOM for 8 products',icon:Zap}];
  return (
