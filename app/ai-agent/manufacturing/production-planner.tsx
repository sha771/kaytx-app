...
import {
  Activity, AlertTriangle, ArrowRight, ChartBarBig, ChevronRight, CircleCheckBig, ClipboardList, Clock, Factory, FileText, Gauge, ListFilter, MessageSquare, Package, Star, Target, TrendingUp, Truck, Users, Zap
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#BF360C20' }]}>
          <ClipboardList size={48} color="#BF360C" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Production Planner</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Production Planning & Material Requirements</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Production Planner provides specialized capabilities within the Manufacturing division. It coordinates with sub-agents for material requirements planner, capacity loader, order sequencer, ensuring operational excellence and continuous improvement across all manufacturing operations.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Specialized sub-agents executing production planner functions.
        </Text>
      ...
      <AgentFeatures agentId="production-planner" agentName="AI Production Planner" />
