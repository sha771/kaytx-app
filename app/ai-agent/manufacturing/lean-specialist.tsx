...
import {
  Activity, AlertTriangle, ArrowRight, ChartBarBig, ChevronRight, CircleCheckBig, Clock, Factory, FileText, GitBranch, LayoutGrid, MessageSquare, Sparkles, Star, Target, Trash2, TrendingUp, Users, Zap
...
export default function LeanSpecialistPage() {
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#BF360C20' }]}>
          <Zap size={48} color="#BF360C" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Lean Specialist</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Lean Manufacturing & Continuous Improvement</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Lean Specialist provides specialized capabilities within the Manufacturing division. It coordinates with sub-agents for waste identifier, value stream mapper, kaizen facilitator, ensuring operational excellence and continuous improvement across all manufacturing operations.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Specialized sub-agents executing lean specialist functions.
        </Text>
      ...
      <AgentFeatures agentId="lean-specialist" agentName="AI Lean Specialist" />
