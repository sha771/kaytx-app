...
import {
  Activity, AlertTriangle, ArrowRight, ChartBarBig, ChevronRight, CircleCheckBig, Clock, Factory, FileCheck, FileText, MessageSquare, Ruler, Search, Star, Target, TrendingUp, Users, Zap
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#BF360C20' }]}>
          <Search size={48} color="#BF360C" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Quality Inspector</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Quality Inspection & Measurement Analysis</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Quality Inspector provides specialized capabilities within the Manufacturing division. It coordinates with sub-agents for measurement analyst, specification checker, non-conformance reporter, ensuring operational excellence and continuous improvement across all manufacturing operations.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Specialized sub-agents executing quality inspector functions.
        </Text>
      ...
      <AgentFeatures agentId="quality-inspector" agentName="AI Quality Inspector" />
