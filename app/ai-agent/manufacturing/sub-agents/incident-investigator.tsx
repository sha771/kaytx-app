...
export default function IncidentInvestigatorPage() {
  const agent = {
    ...
    description: 'Automated Incident Investigator agent specializing in manufacturing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Incident Investigator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
