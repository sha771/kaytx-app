...
export default function OrderSequencerPage() {
  const agent = {
    ...
    description: 'Automated Order Sequencer agent specializing in manufacturing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
