...
export default function SparePartsManagerPage() {
  const agent = {
    ...
    description: 'Automated Spare Parts Manager agent specializing in manufacturing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Spare Parts Manager',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
