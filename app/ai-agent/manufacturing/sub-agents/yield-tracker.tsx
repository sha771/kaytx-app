...
export default function YieldTrackerPage() {
  const agent = {
    ...
    description: 'Automated Yield Tracker agent specializing in manufacturing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
