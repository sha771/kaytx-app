...
export default function DeliveryOptimizerPage() {
  const agent = {
    ...
    description: 'Automated Delivery Optimizer agent specializing in manufacturing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
