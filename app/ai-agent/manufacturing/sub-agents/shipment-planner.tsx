...
export default function ShipmentPlannerPage() {
  const agent = {
    ...
    description: 'Automated Shipment Planner agent specializing in manufacturing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
