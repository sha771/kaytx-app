...
const RESPONSIBILITIES = [
  'Plan and schedule internal and external quality audits',
  'Manage audit calendar and resource allocation',
  'Coordinate audit teams and facility preparation',
  'Track compliance status across all audit requirements',
  'Manage audit findings and corrective actions',
  'Schedule follow-up audits and verification activities',
  'Generate audit reports and executive summaries',
  'Maintain audit history and trend analysis',
];

const ACTIVITIES = [
  { time: '5 min ago', text: 'Scheduled ISO 9001 surveillance audit for next month', icon: Calendar },
  { time: '15 min ago', text: 'Coordinated audit team for supplier visit', icon: Users },
  { time: '30 min ago', text: 'Tracked 12 open audit findings to closure', icon: ClipboardCheck },
  { time: '1 hour ago', text: 'Generated Q2 audit summary report', icon: FileText },
  { time: '3 hours ago', text: 'Scheduled follow-up for 3 critical findings', icon: Clock },
];

const ENDPOINTS = [
  '/consult/audit-scheduler',
  '/audit-scheduler/execute',
  '/audit-scheduler/analyze',
];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Audit Scheduler - Sub-agent supporting AI VP Quality Assurance. Part of the Kaytx AI Workforce hierarchy providing specialized capabilities including audit planning, schedule management, resource allocation, and more.
        </Text>
      </View>
