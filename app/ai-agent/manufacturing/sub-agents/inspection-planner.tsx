...
export default function InspectionPlannerPage() {
  const agent = {
    ...
    name: 'AI Inspection Planner',
    title: 'Manufacturing Agent',
    description: 'Automated Inspection Planner agent specializing in manufacturing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Inspection Planner',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
