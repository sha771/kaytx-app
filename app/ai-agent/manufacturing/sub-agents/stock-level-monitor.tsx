...
export default function StockLevelMonitorPage() {
  const agent = {
    ...
    description: 'Automated Stock Level Monitor agent specializing in manufacturing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
