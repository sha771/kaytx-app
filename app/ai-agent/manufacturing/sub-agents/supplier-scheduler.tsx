...
export default function SupplierSchedulerPage() {
  const agent = {
    id: 'supplier-scheduler',
    name: 'AI Supplier Scheduler',
    title: 'Manufacturing Agent',
    description: 'Automated Supplier Scheduler agent specializing in manufacturing operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Supplier Scheduler',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
