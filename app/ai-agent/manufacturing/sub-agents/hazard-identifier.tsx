...
const RESPONSIBILITIES = [
  'Identify workplace hazards across all manufacturing facilities',
  'Conduct risk assessments and hazard ranking',
  'Perform Job Safety Analysis (JSA) and Job Hazard Analysis',
  'Develop hazard mitigation plans and control measures',
  'Classify hazards by severity and probability',
  'Perform environmental scanning for emerging hazards',
  'Assess PPE requirements and adequacy',
  'Apply hierarchy of controls for hazard elimination',
];

const ACTIVITIES = [
  { time: '5 min ago', text: 'Identified 3 new hazards in assembly area expansion', icon: AlertTriangle },
  { time: '15 min ago', text: 'Completed JSA for new press operation procedure', icon: FileText },
  { time: '30 min ago', text: 'Ranked hazards by risk matrix for prioritization', icon: Gauge },
  { time: '1 hour ago', text: 'Scanned chemical storage area for compliance gaps', icon: Search },
  { time: '3 hours ago', text: 'Applied hierarchy of controls for noise hazard', icon: Shield },
];

const ENDPOINTS = [
  '/consult/hazard-identifier',
  '/hazard-identifier/execute',
  '/hazard-identifier/analyze',
];

export default function HazardIdentifierPage() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Hazard Identifier</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Hazard Identifier - Sub-agent supporting AI Safety Manager. Part of the Kaytx AI Workforce hierarchy providing specialized capabilities including hazard identification, risk assessment, jsa/jha, and more.
        </Text>
      </View>
      ...
      <AgentFeatures agentId="hazard-identifier" agentName="AI Hazard Identifier" />
