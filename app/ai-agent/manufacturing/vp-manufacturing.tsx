...
import { Factory, Activity, CircleCheckBig, Clock, Target, ChartBar, MessageSquare, Calendar, Shield, ArrowRight, Users, Zap, Star, ChartBar } from 'lucide-react-native';
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={styles.statsContainer}>
        {[{label:'Units Made',value:'45,231',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.97%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.6s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.1%',icon:Target,color:'#AF52DE'}].map((stat,index)=>(
