...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'567',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.9s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.1%',icon:Target,color:'#BF360C'}];
  ...
  const activities = [{time:'3 min ago',text:'Led ISO 9001 surveillance audit',icon:CheckCircle2},{time:'6 min ago',text:'Closed 5 CAPA investigations',icon:Clock},{time:'9 min ago',text:'Improved supplier quality score',icon:Zap}];
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#BF360C20' }]}><CheckCircle2 size={48} color="#BF360C" /></View>
