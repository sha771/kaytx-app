...
import { Package, Activity, Star, CheckCircle2, Clock, Target, ArrowRight, Zap } from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

export default function AgentPage() {
  const { theme } = useTheme();
  const stats = [{label:'Tasks',value:'3,701',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.8s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.5%',icon:Target,color:'#BF360C'}];
  ...
  const activities = [{time:'3 min ago',text:'Completed cycle count for zone A',icon:CheckCircle2},{time:'6 min ago',text:'Optimized safety stock levels',icon:Clock},{time:'9 min ago',text:'Reduced inventory holding by 12%',icon:Zap}];
  return (
