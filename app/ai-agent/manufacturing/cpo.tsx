...
import { HardHat, Activity, Star, CheckCircle2, Clock, Target, ArrowRight, Zap } from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

export default function AgentPage() {
  const { theme } = useTheme();
  const stats = [{label:'Tasks',value:'4,060',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.6s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.0%',icon:Target,color:'#BF360C'}];
  ...
  const activities = [{time:'3 min ago',text:'Approved Q3 production plan',icon:CheckCircle2},{time:'6 min ago',text:'Reviewed quality metrics dashboard',icon:Clock},{time:'9 min ago',text:'Led safety committee meeting',icon:Zap}];
  return (
