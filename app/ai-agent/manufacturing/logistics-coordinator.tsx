...
import {
  Activity, AlertTriangle, ArrowRight, ChartBarBig, ChevronRight, CircleCheckBig, Clock, DollarSign, Factory, FileText, Globe, MapPin, MessageSquare, Package, Star, Target, TrendingUp, Truck, Users, Zap
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#BF360C20' }]}>
          <Truck size={48} color="#BF360C" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Logistics Coordinator</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Logistics Planning & Delivery Optimization</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Logistics Coordinator provides specialized capabilities within the Manufacturing division. It coordinates with sub-agents for shipment planner, carrier selector, delivery optimizer, ensuring operational excellence and continuous improvement across all manufacturing operations.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Specialized sub-agents executing logistics coordinator functions.
        </Text>
      ...
      <AgentFeatures agentId="logistics-coordinator" agentName="AI Logistics Coordinator" />
