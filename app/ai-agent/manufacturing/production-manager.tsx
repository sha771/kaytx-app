...
import { Factory, Activity, Star, CheckCircle2, Clock, Target, ArrowRight, Zap } from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

export default function AgentPage() {
  const { theme } = useTheme();
  const stats = [{label:'Tasks',value:'1,590',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.5s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.6%',icon:Target,color:'#BF360C'}];
  ...
  const activities = [{time:'3 min ago',text:'Managed 3 production lines',icon:CheckCircle2},{time:'6 min ago',text:'Achieved 98.5% OEE target',icon:Clock},{time:'9 min ago',text:'Reduced scrap rate by 15%',icon:Zap}];
  return (
