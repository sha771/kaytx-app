...
import {
  Activity, AlertTriangle, ArrowRight, Calendar, ChartBarBig, ChevronRight, CircleCheckBig, Clock, Factory, FileText, MessageSquare, Star, Target, TrendingUp, Users, Zap
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#BF360C20' }]}>
          <Factory size={48} color="#BF360C" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Production Manager</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Production Operations & Shift Management</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Production Manager provides specialized capabilities within the Manufacturing division. It coordinates with sub-agents for shift coordinator, production scheduler, output tracker, ensuring operational excellence and continuous improvement across all manufacturing operations.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Specialized sub-agents executing production manager functions.
        </Text>
      ...
      <AgentFeatures agentId="production-manager" agentName="AI Production Manager" />
