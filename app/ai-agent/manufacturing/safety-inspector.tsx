...
import {
  Activity, AlertTriangle, ArrowRight, ChartBarBig, CheckCircle, ChevronRight, CircleCheckBig, ClipboardCheck, Clock, Factory, FileText, Gauge, MessageSquare, ShieldAlert, Star, Target, TrendingUp, Users, Zap
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#BF360C20' }]}>
          <ShieldAlert size={48} color="#BF360C" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Safety Inspector</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Safety Compliance & Risk Assessment</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Safety Inspector provides specialized capabilities within the Manufacturing division. It coordinates with sub-agents for compliance auditor, risk assessor, corrective action tracker, ensuring operational excellence and continuous improvement across all manufacturing operations.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary, marginBottom: 12 }]}>
          Specialized sub-agents executing safety inspector functions.
        </Text>
      ...
      <AgentFeatures agentId="safety-inspector" agentName="AI Safety Inspector" />
