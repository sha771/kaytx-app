...
const agent = {
  ...
  description: 'Provides comprehensive administrative support to executives including calendar management, correspondence handling, and task coordination.',
  icon: Bot,
  color: '#1976D2',
  type: 'subagent' as const,
  category: 'assistant',
  parentCategory: 'Personal Productivity',
  capabilities: ['Calendar Management', 'Email Management', 'Meeting Coordination', 'Travel Planning', 'Task Prioritization'],
