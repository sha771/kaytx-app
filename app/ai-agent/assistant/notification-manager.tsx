...
const agent = {
  id: 'ai-notification-manager',
  name: 'AI Notification Manager',
  title: 'Notification Management AI',
  description: 'Manages notifications, filters priorities, and reduces notification fatigue.',
  icon: Bot,
  color: '#5D4037',
  type: 'subagent' as const,
  category: 'ai-personal-assistant',
  parentCategory: 'ai-personal-assistant',
  capabilities: ['Notification Management', 'Priority Filtering', 'Fatigue Reduction'],
