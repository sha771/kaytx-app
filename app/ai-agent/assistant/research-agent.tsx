...
const agent = {
  ...
  description: 'Conducts research, analyzes information, and provides comprehensive reports.',
  icon: User,
  color: '#00838F',
  type: 'subagent' as const,
  category: 'ai-personal-assistant',
  parentCategory: 'ai-personal-assistant',
  capabilities: ['Research Execution', 'Information Analysis', 'Report Generation'],
