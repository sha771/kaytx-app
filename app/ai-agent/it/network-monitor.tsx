...
const ACCENT = '#4338CA';
const AGENT_NAME = 'AI Network Monitor';
const AGENT_TITLE = 'Network Intelligence AI';
const AGENT_DESC = 'Monitors network performance, detects anomalies, and manages topology across all locations.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '98.9%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Detected latency spike on node-12",
        "time": "1h ago"
    },
    {
        "action": "Updated network topology map",
        "time": "3h ago"
    },
    {
        "action": "Managed bandwidth allocation",
        "time": "5h ago"
    },
    {
        "action": "Patched VPN gateway firmware",
        "time": "6h ago"
    },
    {
        "action": "Analyzed packet loss report",
        "time": "8h ago"
    }
];
