...
const ACCENT = '#7C3AED';
const AGENT_NAME = 'AI Help Desk';
const AGENT_TITLE = 'IT Support Automation AI';
const AGENT_DESC = 'Resolves IT tickets instantly, manages assets, and provisions user accounts automatically.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '93.6%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Resolved 45 support tickets",
        "time": "2m ago"
    },
    {
        "action": "Reset passwords for 8 users",
        "time": "10m ago"
    },
    {
        "action": "Provisioned 3 new accounts",
        "time": "20m ago"
    },
    {
        "action": "Updated 7 knowledge base articles",
        "time": "40m ago"
    },
    {
        "action": "Remote-fixed printer connectivity",
        "time": "1h ago"
    }
];
