...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'184',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.2s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.3%',icon:Target,color:'#283593'}];
  const capabilities = ['IT Support','Issue Resolution','Ticket Management'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Help Desk</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Provides IT support, resolves technical issues, and manages help desk tickets.</Text></View>
      ...
      <AgentFeatures agentId="help-desk" agentName="AI Help Desk" />
    </ScrollView>
  );
}
