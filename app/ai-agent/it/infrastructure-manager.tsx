...
const ACCENT = '#6D28D9';
const AGENT_NAME = 'AI Infrastructure Manager';
const AGENT_TITLE = 'IT Infrastructure AI';
const AGENT_DESC = 'Optimizes server performance, plans capacity, and manages disaster recovery automatically.';
...
const RECENT_TASKS = [
    {
        "action": "Optimized server resource allocation",
        "time": "5m ago"
    },
    {
        "action": "Updated disaster recovery plan",
        "time": "20m ago"
    },
    {
        "action": "Analyzed 30-day capacity trends",
        "time": "45m ago"
    },
    {
        "action": "Migrated old storage arrays",
        "time": "2h ago"
    },
    {
        "action": "Patched 12 server vulnerabilities",
        "time": "3h ago"
    }
];
