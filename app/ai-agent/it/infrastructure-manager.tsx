...
export default function AgentPage() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Manages IT infrastructure, monitors systems, and ensures optimal performance.</Text></View>
      ...
      <AgentFeatures agentId="infrastructure-manager" agentName="AI Infrastructure Manager" />
    </ScrollView>
  );
}
