...
const ACCENT = '#6366F1';
const AGENT_NAME = 'AI DevOps Agent';
const AGENT_TITLE = 'CI/CD Automation AI';
const AGENT_DESC = 'Manages CI/CD pipelines, automates deployments, and monitors infrastructure health 24/7.';
...
const RECENT_TASKS = [
    ...
    {
        "action": "Scaled K8s cluster from 3 to 5 nodes",
        "time": "10m ago"
    },
    {
        "action": "Fixed broken CI pipeline build",
        "time": "25m ago"
    },
    {
    ...
    {
        "action": "Synced staging environment",
        "time": "1h ago"
    }
];
