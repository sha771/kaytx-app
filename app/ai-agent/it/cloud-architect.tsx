...
const ACCENT = '#5B21B6';
const AGENT_NAME = 'AI Cloud Architect';
const AGENT_TITLE = 'Cloud Strategy AI';
const AGENT_DESC = 'Designs cloud-native architectures, plans migrations, and optimizes multi-cloud spending.';
...
const RECENT_TASKS = [
    ...
    {
        "action": "Optimized AWS spend by 18%",
        "time": "1h ago"
    },
    {
        "action": "Planned on-prem to cloud migration",
        "time": "2h ago"
    },
    {
        "action": "Created serverless API blueprint",
        "time": "3h ago"
    },
    {
        "action": "Evaluated Azure vs GCP options",
        "time": "4h ago"
    }
];
