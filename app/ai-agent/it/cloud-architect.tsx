...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'101',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.5s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.4%',icon:Target,color:'#283593'}];
  const capabilities = ['Cloud Architecture','Cost Optimization','Resource Management'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Cloud Architect</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Designs cloud architectures, optimizes cloud costs, and manages cloud resources.</Text></View>
      ...
      <AgentFeatures agentId="cloud-architect" agentName="AI Cloud Architect" />
    </ScrollView>
  );
}
