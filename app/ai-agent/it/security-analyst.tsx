...
const ACCENT = '#4F46E5';
const AGENT_NAME = 'AI Security Analyst';
const AGENT_TITLE = 'Cybersecurity Intelligence AI';
const AGENT_DESC = 'Detects threats, scans vulnerabilities, and manages incident response with zero-latency precision.';
const PARENT_NAME = 'IT & Technology AI';

const METRICS = [
  { label: 'Tasks Today', value: '234', color: ACCENT },
  { label: 'Success Rate', value: '99%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.2s', color: '#007AFF' },
  { label: 'Accuracy', value: '99.4%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Blocked 12 suspicious IPs",
        "time": "30s ago"
    },
    {
        "action": "Completed full vulnerability scan",
        "time": "5m ago"
    },
    {
        "action": "Updated firewall ACL rules",
        "time": "15m ago"
    },
    {
        "action": "Investigated phishing attempt",
        "time": "30m ago"
    },
    {
        "action": "Generated SIEM alert report",
        "time": "45m ago"
    }
];
