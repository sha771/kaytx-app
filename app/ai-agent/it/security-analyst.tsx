...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'167',icon: CircleCheckBig,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.9s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.9%',icon:Target,color:'#283593'}];
  const capabilities = ['Threat Monitoring','Vulnerability Analysis','Asset Protection'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Monitors security threats, analyzes vulnerabilities, and protects digital assets.</Text></View>
      ...
      <AgentFeatures agentId="security-analyst" agentName="AI Security Analyst" />
    </ScrollView>
  );
}
