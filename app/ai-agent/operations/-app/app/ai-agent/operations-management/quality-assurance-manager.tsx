...
export default function QualityAssuranceManagerPage() {
  const agent = {
    ...
    replacesRole: 'quality-assurance-manager',
    infrastructure: {
      status: 'online',
