...
export default function ProcessOptimizationAgentPage() {
  const agent = {
    ...
    replacesRole: 'process-optimization-agent',
    infrastructure: {
      status: 'online',
