...
export default function WorkflowAutomationAgentPage() {
  const agent = {
    ...
    replacesRole: 'workflow-automation-agent',
    infrastructure: {
      status: 'online',
