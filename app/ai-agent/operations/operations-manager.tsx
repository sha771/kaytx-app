...
const AGENT_TITLE = 'Core Operations AI';
const AGENT_DESC = 'Orchestrates the entire operations floor, manages resource allocation, and tracks enterprise KPIs.';
const PARENT_NAME = 'Operations Management AI';
...
const RECENT_TASKS = [
    {
        "action": "Reallocated resources to Queue A",
        "time": "12m ago"
    },
    {
        "action": "Generated daily operational briefing",
        "time": "30m ago"
    },
    {
        "action": "Resolved 2 cross-department blockers",
        "time": "1h ago"
    },
    {
        "action": "Updated executive KPI dashboard",
        "time": "2h ago"
    },
    {
        "action": "Initiated disaster recovery drill",
        "time": "5h ago"
    }
];
