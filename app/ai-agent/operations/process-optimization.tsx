...
const ACCENT = '#AEAEB2';
const AGENT_NAME = 'AI Process Optimizer';
const AGENT_TITLE = 'Workflow Efficiency AI';
const AGENT_DESC = 'Continuously analyzes workflows to identify bottlenecks and suggests automated process improvements.';
...
const RECENT_TASKS = [
    {
        "action": "Identified bottleneck in approval flow",
        "time": "15m ago"
    },
    {
        "action": "Proposed 3 process automations",
        "time": "45m ago"
    },
    {
        "action": "Simulated new workflow efficiency",
        "time": "2h ago"
    },
    {
        "action": "Measured time-savings since v2",
        "time": "4h ago"
    },
    {
        "action": "Updated standard operating procedures",
        "time": "6h ago"
    }
];
