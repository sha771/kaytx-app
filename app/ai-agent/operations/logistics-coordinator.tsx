...
const agent = {
  ...
  title: 'Logistics & Distribution AI',
  description: 'Coordinates logistics operations, manages shipments, and optimizes delivery routes.',
  icon: Bot,
  color: '#FF8A65',
  type: 'subagent' as const,
  category: 'operations',
  parentCategory: 'Business Operations',
  capabilities: ['Shipment Management', 'Route Optimization', 'Carrier Coordination', 'Delivery Tracking', 'Warehouse Coordination'],
