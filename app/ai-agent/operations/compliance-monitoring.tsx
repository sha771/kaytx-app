...
const ACCENT = '#8E8E93';
const AGENT_NAME = 'AI Compliance Monitor';
const AGENT_TITLE = 'Operations Compliance AI';
const AGENT_DESC = 'Ensures all operational processes adhere to internal policies and external regulations.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '99.7%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Scanned 500 transactions for AML",
        "time": "5m ago"
    },
    {
        "action": "Verified 50 user KYC documents",
        "time": "20m ago"
    },
    {
        "action": "Flagged 3 out-of-policy requests",
        "time": "1h ago"
    },
    {
        "action": "Updated internal policy database",
        "time": "3h ago"
    },
    {
        "action": "Generated daily compliance log",
        "time": "8h ago"
    }
];
