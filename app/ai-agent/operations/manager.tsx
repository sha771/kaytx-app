...
export default function AiOperationsManagerScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Process Optimization","Resource Allocation","Workflow Automation","Performance Monitoring","Capacity Planning","Cost Optimization","Quality Control","Vendor Management"],
