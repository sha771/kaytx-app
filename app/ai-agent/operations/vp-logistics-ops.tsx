...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks',value:'4157',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.6s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.0%',icon:Target,color:'#4E342E'}];
  ...
  const activities = [{time:'3 min ago',text:'Optimized 8 shipping routes',icon:CheckCircle2},{time:'6 min ago',text:'Managed 120 warehouse transactions',icon:Clock},{time:'9 min ago',text:'Coordinated 45 supplier deliveries',icon:Zap}];
  return (
