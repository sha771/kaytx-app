...
export default function UtilizationTrackerPage() {
  const agent = {
    ...
    description: 'Automated Utilization Tracker agent specializing in operations operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Utilization Tracker',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
