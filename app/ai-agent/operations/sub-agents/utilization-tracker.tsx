...
import { Activity, BarChart3, Clock, Target, Zap, ArrowRight, Briefcase, Calendar, TrendingUp, PieChart } from 'lucide-react-native';
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Utilization Tracker</Text>
      ...
      <View style={styles.statsContainer}>
        {[
          {label:'Cost Equiv',value:'$60K/yr',icon: BarChart3, color: '#34C759'},
          {label:'AI Cost',value:'$3K/yr',icon: Clock, color: '#007AFF'},
          {label:'Efficiency',value:'20x',icon: Target, color: '#FF9500'},
          {label:'Tracking',value:'Real-time',icon: Activity, color: '#8B5CF6'}
        ].map((stat,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Utilization Tracker monitors resource usage patterns in real-time across the enterprise. It identifies
          underutilized and overutilized resources, generates efficiency reports, and triggers alerts when utilization
          deviates from optimal thresholds to enable immediate corrective action.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {[
          ...
          'Efficiency Benchmarking & Reporting',
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['Real-time Monitoring','Usage Analytics','Threshold Alerting','Trend Analysis','Efficiency Scoring','Idle Detection','Capacity Planning','Dashboard Reporting'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {[
          { label: 'Avg Utilization', value: '91.4% across org' },
          { label: 'Idle Resources', value: '< 2% at any time' },
          { label: 'Alert Response', value: '< 30 seconds' },
          { label: 'Tracking Scope', value: '100% resources' }
        ].map((metric,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/utilization-tracker', '/utilization-tracker/monitor', '/utilization-tracker/report'].map((endpoint,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.actionsGrid}>
          <TouchableOpacity style={[styles.actionButton, { backgroundColor: '#8B5CF612' }]} onPress={() => router.push('/ai-agent/operations/ai-resource-planner')}>
            <Calendar size={24} color="#8B5CF6" />
            <Text style={[styles.actionText, { color: '#8B5CF6' }]}>Resource Planner</Text>
          </TouchableOpacity>
      ...
      <AgentFeatures agentId="utilization-tracker" agentName="AI Utilization Tracker" />
