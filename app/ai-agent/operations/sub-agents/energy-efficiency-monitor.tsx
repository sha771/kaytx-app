...
export default function EnergyEfficiencyMonitorPage() {
  ...
  const stats = [
    ...
    { label: 'Parent', value: 'AI VP Facilities', icon: Zap, color: '#007AFF' },
  ];

  const capabilities = ["Energy Consumption Monitoring","Efficiency Benchmarking","Peak Load Management","Renewable Energy Integration","Carbon Footprint Tracking","Cost Optimization Algorithms","HVAC Optimization","Lighting Automation Control"];
  const kpiData = [{"metric":"Efficiency Score","value":"92/100","target":"85/100","status":"exceeding"},{"metric":"Carbon Reduction","value":"28%","target":"20%","status":"exceeding"},{"metric":"Cost Savings","value":"$340K/yr","target":"$250K/yr","status":"exceeding"},{"metric":"Peak Load Reduction","value":"18%","target":"12%","status":"exceeding"}];
  const activities = [{"time":"1 min ago","text":"HVAC optimization: Building A 14% energy reduction","icon":"Zap","type":"success"},{"time":"8 min ago","text":"Peak load alert: Auto-switched to battery backup","icon":"AlertTriangle","type":"warning"},{"time":"20 min ago","text":"Carbon report: 28% reduction YoY","icon":"TrendingUp","type":"info"}];
  ...
  const renderOverview = () => (
    <>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>AI Energy Efficiency Monitor is a specialized sub-agent supporting AI VP Facilities. It provides enterprise-level automation and intelligence for its domain, delivering consistent high-quality performance as part of the Kaytx AI Workforce.</Text></View>
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <AgentFeatures agentId="energy-efficiency-monitor" agentName="AI Energy Efficiency Monitor" />
