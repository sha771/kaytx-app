...
export default function DefectLoggerPage() {
  const agent = {
    ...
    description: 'Automated Defect Logger agent specializing in operations operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
