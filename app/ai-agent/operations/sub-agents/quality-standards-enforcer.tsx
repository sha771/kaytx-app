...
export default function QualityStandardsEnforcerPage() {
  const agent = {
    ...
    description: 'Automated Quality Standards Enforcer agent specializing in operations operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
