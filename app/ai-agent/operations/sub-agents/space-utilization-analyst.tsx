...
export default function SpaceUtilizationAnalystPage() {
  const agent = {
    id: 'space-utilization-analyst',
    name: 'AI Space Utilization Analyst',
    title: 'Operations Agent',
    description: 'Automated Space Utilization Analyst agent specializing in operations operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Space Utilization Analyst',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
