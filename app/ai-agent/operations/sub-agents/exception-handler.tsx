...
export default function ExceptionHandlerPage() {
  const agent = {
    ...
    description: 'Automated Exception Handler agent specializing in operations operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
