...
export default function PerformanceReporterPage() {
  ...
  const stats = [
    ...
    { label: 'Parent', value: 'AI Operations Manager', icon: BarChart3, color: '#007AFF' },
  ];

  const capabilities = ["Automated Report Generation","KPI Dashboard Management","Trend Analysis & Forecasting","Executive Summary Creation","Custom Report Builder","Data Visualization","Benchmark Reporting","Compliance Reporting"];
  const kpiData = [{"metric":"Generation Time","value":"12s","target":"60s","status":"exceeding"},{"metric":"Data Accuracy","value":"99.8%","target":"99%","status":"exceeding"},{"metric":"Satisfaction","value":"4.8/5","target":"4.0/5","status":"exceeding"},{"metric":"Coverage","value":"100%","target":"95%","status":"exceeding"}];
  const activities = [{"time":"5 min ago","text":"Weekly report: 12 KPIs trending positive","icon":"BarChart3","type":"success"},{"time":"15 min ago","text":"Executive summary: Q3 operations review delivered","icon":"FileText","type":"info"},{"time":"30 min ago","text":"Custom report: Customer satisfaction analysis complete","icon":"TrendingUp","type":"info"}];
  ...
  const renderOverview = () => (
    <>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>AI Performance Reporter is a specialized sub-agent supporting AI Operations Manager. It provides enterprise-level automation and intelligence for its domain, delivering consistent high-quality performance as part of the Kaytx AI Workforce.</Text></View>
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <AgentFeatures agentId="performance-reporter" agentName="AI Performance Reporter" />
