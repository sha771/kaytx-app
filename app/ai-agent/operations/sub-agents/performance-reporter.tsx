...
export default function PerformanceReporterPage() {
  const agent = {
    ...
    description: 'Automated Performance Reporter agent specializing in operations operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
