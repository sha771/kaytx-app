...
export default function SupplierRiskAssessorPage() {
  const agent = {
    ...
    description: 'Automated Supplier Risk Assessor agent specializing in operations operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
