...
import { Activity, Clock, Target, Zap, ArrowRight, Briefcase, ChevronRight, BarChart3, TrendingUp, ListOrdered, CheckCircle2, AlertTriangle } from 'lucide-react-native';
...
export default function TaskPrioritizerPage() {
  ...
  const stats = [
    ...
    { label: 'Parent', value: 'AI Task Coordinator', icon: ListOrdered, color: '#007AFF' },
  ];

  const capabilities = ["Urgency-Impact Matrix","AI-Driven Priority Scoring","Business Impact Analysis","Resource-Aware Prioritization","Dynamic Re-Prioritization","Critical Path Prioritization","Stakeholder Weight Mapping","Queue Optimization"];
  const kpiData = [{"metric":"Prioritization Accuracy","value":"96%","target":"88%","status":"exceeding"},{"metric":"Critical Detection","value":"99%","target":"95%","status":"exceeding"},{"metric":"Re-Priority Speed","value":"0.3s","target":"2s","status":"exceeding"},{"metric":"Stakeholder Alignment","value":"4.6/5","target":"4.0/5","status":"exceeding"}];
  const activities = [{"time":"2 min ago","text":"Prioritized 28 tasks — 5 critical, 12 high, 11 medium","icon":"ListOrdered","type":"success"},{"time":"10 min ago","text":"Dynamic re-priority: Production incident elevated to P1","icon":"ArrowRight","type":"warning"},{"time":"20 min ago","text":"Queue optimized: 15% reduction in average wait time","icon":"TrendingUp","type":"info"}];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <AgentFeatures agentId="task-prioritizer" agentName="AI Task Prioritizer" />
