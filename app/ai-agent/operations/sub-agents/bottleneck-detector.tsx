...
export default function BottleneckDetectorPage() {
  const agent = {
    ...
    description: 'Automated Bottleneck Detector agent specializing in operations operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
