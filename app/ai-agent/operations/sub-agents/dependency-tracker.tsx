...
import { Activity, Clock, Target, Zap, ArrowRight, Briefcase, ChevronRight, BarChart3, TrendingUp, GitMerge, CheckCircle2, AlertTriangle } from 'lucide-react-native';
...
export default function DependencyTrackerPage() {
  ...
  const stats = [
    ...
    { label: 'Parent', value: 'AI Task Coordinator', icon: GitMerge, color: '#007AFF' },
  ];

  const capabilities = ["Dependency Graph Management","Conflict Detection & Resolution","Cross-Project Mapping","Impact Analysis","Circular Dependency Detection","Automated Resolution","Real-Time Monitoring","Dependency Risk Scoring"];
  const kpiData = [{"metric":"Resolution Time","value":"1.2h","target":"4h","status":"exceeding"},{"metric":"Conflict Detection","value":"98%","target":"90%","status":"exceeding"},{"metric":"Impact Accuracy","value":"94%","target":"85%","status":"exceeding"},{"metric":"Circular Detection","value":"100%","target":"95%","status":"exceeding"}];
  const activities = [{"time":"3 min ago","text":"Resolved: Backend API blocking Frontend Sprint","icon":"GitMerge","type":"success"},{"time":"12 min ago","text":"Circular dependency: Module A ↔ Module C detected","icon":"AlertTriangle","type":"warning"},{"time":"25 min ago","text":"Impact analysis: API v3 affects 14 downstream services","icon":"BarChart3","type":"info"}];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <AgentFeatures agentId="dependency-tracker" agentName="AI Dependency Tracker" />
