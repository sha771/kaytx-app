...
import { Activity, FileCode, Clock, Target, Zap, ArrowRight, Briefcase, Shield, RotateCcw } from 'lucide-react-native';
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#007AFF20' }]}>
          <FileCode size={56} color="#007AFF" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Test Case Generator</Text>
      ...
      <View style={styles.statsContainer}>
        {[
          {label:'Cost Equiv',value:'$55K/yr',icon: FileCode, color: '#34C759'},
          {label:'AI Cost',value:'$2.8K/yr',icon: Clock, color: '#007AFF'},
          {label:'Efficiency',value:'20x',icon: Target, color: '#FF9500'},
          {label:'Coverage',value:'94.7%',icon: Activity, color: '#8B5CF6'}
        ].map((stat,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Test Case Generator automatically creates comprehensive test suites from requirements, user stories,
          and code analysis. It generates unit, integration, and end-to-end test cases with optimal coverage,
          reducing manual testing effort by up to 87% while maintaining enterprise quality standards.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {[
          ...
          'Edge Case & Boundary Condition Discovery',
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['Auto Generation','Coverage Analysis','Edge Case Discovery','Test Data Synthesis','Multi-Level Testing','Requirement Parsing','Suite Optimization','CI/CD Integration'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {[
          { label: 'Coverage Rate', value: '94.7% auto-generated' },
          { label: 'Generation Speed', value: '< 2 min per suite' },
          { label: 'False Positive', value: '< 1.2% rate' },
          { label: 'Test Types', value: 'Unit + Int + E2E' }
        ].map((metric,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/test-case-generator', '/test-case-generator/generate', '/test-case-generator/coverage'].map((endpoint,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.actionsGrid}>
          <TouchableOpacity style={[styles.actionButton, { backgroundColor: '#007AFF12' }]} onPress={() => router.push('/ai-agent/operations/ai-quality-assurance')}>
            <Shield size={24} color="#007AFF" />
            <Text style={[styles.actionText, { color: '#007AFF' }]}>QA Agent</Text>
          </TouchableOpacity>
      ...
      <AgentFeatures agentId="test-case-generator" agentName="AI Test Case Generator" />
