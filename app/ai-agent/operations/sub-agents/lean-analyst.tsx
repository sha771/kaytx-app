...
export default function LeanAnalystPage() {
  const agent = {
    ...
    description: 'Automated Lean Analyst agent specializing in operations operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
