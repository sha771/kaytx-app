...
import { Activity, Clock, Target, Zap, ArrowRight, Briefcase, ChevronRight, BarChart3, TrendingUp, Workflow, CheckCircle2, AlertTriangle } from 'lucide-react-native';
...
export default function ProcessMapperPage() {
  ...
  const stats = [
    ...
    { label: 'Parent', value: 'AI Workflow Automation Agent', icon: Workflow, color: '#007AFF' },
  ];

  const capabilities = ["Process Discovery & Mapping","Value Stream Visualization","Process Flow Documentation","Bottleneck Identification","Automation Readiness Assessment","Process Comparison & Benchmarking","Compliance Flow Mapping","Integration Point Discovery"];
  const kpiData = [{"metric":"Processes Mapped","value":"340+","target":"250","status":"exceeding"},{"metric":"Readiness Score","value":"84/100","target":"75/100","status":"exceeding"},{"metric":"Discovery Accuracy","value":"97%","target":"92%","status":"exceeding"},{"metric":"Mapping Speed","value":"2.4h","target":"8h","status":"exceeding"}];
  const activities = [{"time":"2 min ago","text":"Mapped 5 new procurement processes for automation","icon":"Workflow","type":"success"},{"time":"10 min ago","text":"Automation readiness: 84% of processes ready","icon":"TrendingUp","type":"info"},{"time":"20 min ago","text":"Integration point: 3 new API connections for HR workflow","icon":"Zap","type":"success"}];
  ...
  const renderOverview = () => (
    <>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>AI Process Mapper is a specialized sub-agent supporting AI Workflow Automation Agent. It provides enterprise-level automation and intelligence for its domain, delivering consistent high-quality performance as part of the Kaytx AI Workforce.</Text></View>
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <AgentFeatures agentId="process-mapper" agentName="AI Process Mapper" />
