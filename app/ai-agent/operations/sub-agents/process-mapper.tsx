...
export default function ProcessMapperPage() {
  const agent = {
    ...
    description: 'Automated Process Mapper agent specializing in operations operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
