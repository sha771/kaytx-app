...
export default function WorkflowMonitorPage() {
  const agent = {
    ...
    description: 'Automated Workflow Monitor agent specializing in operations operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
