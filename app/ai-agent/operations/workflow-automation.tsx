...
const ACCENT = '#98989D';
const AGENT_NAME = 'AI Workflow Automation';
const AGENT_TITLE = 'Robotic Process AI';
const AGENT_DESC = 'Builds and maintains internal integrations and automates repetitive operational tasks across systems.';
const PARENT_NAME = 'Operations Management AI';

const METRICS = [
  { label: 'Tasks Today', value: '5.4k', color: ACCENT },
  { label: 'Success Rate', value: '99%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.05s', color: '#007AFF' },
  { label: 'Accuracy', value: '99.8%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Synced CRM data to ERP",
        "time": "30s ago"
    },
    {
        "action": "Executed daily database backup",
        "time": "2h ago"
    },
    {
        "action": "Triggered onboarding workflow",
        "time": "3h ago"
    },
    {
        "action": "Handled API webhook failure",
        "time": "5h ago"
    },
    {
        "action": "Processed 500 batch records",
        "time": "6h ago"
    }
];
