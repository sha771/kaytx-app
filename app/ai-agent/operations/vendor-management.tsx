...
const ACCENT = '#8E8E93';
const AGENT_NAME = 'AI Vendor Manager';
const AGENT_TITLE = 'Third-Party Operations AI';
const AGENT_DESC = 'Tracks vendor performance, manages SLAs, and handles procurement approvals automatically.';
...
const RECENT_TASKS = [
    {
        "action": "Reviewed AWS monthly SLA",
        "time": "20m ago"
    },
    {
        "action": "Processed 5 procurement requests",
        "time": "45m ago"
    },
    {
        "action": "Flagged missed SLA by Vendor C",
        "time": "2h ago"
    },
    {
        "action": "Evaluated 3 new RFPs",
        "time": "4h ago"
    },
    {
        "action": "Updated vendor risk scorecard",
        "time": "6h ago"
    }
];
