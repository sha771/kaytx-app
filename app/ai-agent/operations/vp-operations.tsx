...
import { Settings, Activity, CircleCheckBig, Clock, Target, ChartBar, MessageSquare, Calendar, Shield, ArrowRight, Users, Zap, Star, Layers, Gauge } from 'lucide-react-native';
...
export default function VPOperationsPage() {
  ...
  const stats = [
    { label: 'Processes', value: '8,421', icon: CircleCheckBig, color: '#34C759' },
    { label: 'Uptime', value: '99.98%', icon: Activity, color: '#007AFF' },
    { label: 'Response', value: '0.7s', icon: Clock, color: '#FF9500' },
    { label: 'Accuracy', value: '99.1%', icon: Target, color: '#AF52DE' },
  ];

  const capabilities = [
    'Process Optimization', 'Workflow Design', 'Resource Planning', 'Quality Control',
    'Facilities Mgmt', 'Project Mgmt', 'Lean Six Sigma', 'Automation'
  ];
  ...
  const activities = [
    { time: '1 min ago', text: 'Optimized 3 core workflows saving 12h/week', icon: Zap },
    { time: '12 min ago', text: 'Approved facilities expansion plan', icon: Layers },
    { time: '45 min ago', text: 'Updated resource capacity forecast', icon: Gauge },
    { time: '2 hours ago', text: 'Completed quality audit cycle', icon: Shield },
    { time: '4 hours ago', text: 'Launched lean initiative for Q3', icon: Target },
  ];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { backgroundColor: theme.colors.primary + '18' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>VP Operations</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Operations & Management Department</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The VP Operations AI oversees all business operations, process optimization, and resource management. This agent ensures operational excellence through workflow automation, quality control, and strategic capacity planning.
        </Text>
      </View>
    ...
    <AgentFeatures agentId="vp-operations" agentName="VP Operations" />
