...
const ACCENT = '#D1D1D6';
const AGENT_NAME = 'AI Resource Planner';
const AGENT_TITLE = 'Capacity & Logistics AI';
const AGENT_DESC = 'Forecasts demand and optimally allocates human and systems resources ahead of time.';
...
const METRICS = [
  ...
  { label: 'Avg Speed', value: '2.1s', color: '#007AFF' },
  { label: 'Accuracy', value: '95.9%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Forecasted Q4 support ticket volume",
        "time": "10m ago"
    },
    {
        "action": "Adjusted shift schedules for next week",
        "time": "1h ago"
    },
    {
        "action": "Allocated server capacity for launch",
        "time": "2h ago"
    },
    {
        "action": "Identified upcoming resource shortage",
        "time": "4h ago"
    },
    {
        "action": "Optimized supply chain routing",
        "time": "6h ago"
    }
];
