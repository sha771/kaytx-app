...
const ACCENT = '#C7C7CC';
const AGENT_NAME = 'AI Quality Control';
const AGENT_TITLE = 'QA & Standards AI';
const AGENT_DESC = 'Monitors outputs, catches defects, and ensures all operational deliverables meet quality standards.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '98.5%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Inspected 250 outgoing deliverables",
        "time": "2m ago"
    },
    {
        "action": "Flagged 5 items for manual review",
        "time": "18m ago"
    },
    {
        "action": "Analyzed defect root causes",
        "time": "1h ago"
    },
    {
        "action": "Updated quality threshold parameters",
        "time": "3h ago"
    },
    {
        "action": "Sent QA report to production team",
        "time": "4h ago"
    }
];
