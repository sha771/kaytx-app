...
const ACCENT = '#E5E5EA';
const AGENT_NAME = 'AI Task Coordinator';
const AGENT_TITLE = 'Workflow Dispatch AI';
const AGENT_DESC = 'Automatically routes tasks to the best-suited human or AI agent based on availability and skills.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '99.1%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Routed 50 high-priority tasks",
        "time": "1m ago"
    },
    {
        "action": "Reassigned task due to timeout",
        "time": "5m ago"
    },
    {
        "action": "Matched skill requirement to Agent-8",
        "time": "12m ago"
    },
    {
        "action": "Balanced queue load across team",
        "time": "30m ago"
    },
    {
        "action": "Escalated aged ticket to manager",
        "time": "1h ago"
    }
];
