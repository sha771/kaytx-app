...
export default function AgentWorkPage() {
  const agent = {
    ...
    name: 'AI Agent Work',
    title: 'AI Agent',
    description: 'Automated Agent Work agent with advanced AI capabilities for task automation, data processing, and workflow coordination.',
