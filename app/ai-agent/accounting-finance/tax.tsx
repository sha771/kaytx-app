...
export default function TaxPage() {
  const agent = {
    ...
    description: 'Automated Tax agent specializing in accounting-finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
