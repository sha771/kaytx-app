...
export default function AiTaxAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Tax Calculation & Optimization","Tax Return Preparation & Filing","Regulatory Compliance Monitoring","Sales Tax Management","VAT/GST Processing","Tax Audit Support","Tax Planning Strategy","Transfer Pricing Analysis","International Tax Compliance","Tax Document Management"],
