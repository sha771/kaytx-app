...
export default function AiPayrollAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Salary Calculation & Processing","Tax Withholding & Deductions","Payroll Tax Compliance","Direct Deposit Management","Payroll Reconciliation","W-2 & 1099 Form Generation","Benefits Deduction Processing","Garnishment Management","Payroll Reporting","Labor Law Compliance"],
