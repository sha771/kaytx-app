...
export default function AiApAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Invoice Processing & Validation","Vendor Payment Management","Payment Schedule Optimization","Purchase Order Matching","Vendor Communication","Early Payment Discount Capture","Payment Reconciliation","1099 Form Preparation","Vendor Master Data Management","Cash Flow Preservation"],
