...
export default function AiExpenseAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Expense Report Processing","Receipt Management & OCR","Reimbursement Processing","Expense Policy Enforcement","Mileage & Travel Expense Tracking","Corporate Card Management","Spending Analytics & Reports","Budget Compliance Monitoring","Expense Categorization","Fraud Detection in Expenses"],
