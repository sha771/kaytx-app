...
export default function AiAuditAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Internal Audit Execution","Fraud Detection & Prevention","Risk Assessment & Control","Compliance Verification","Financial Controls Testing","Anomaly Detection","Audit Documentation","SOX Compliance","Regulatory Compliance Review","Financial Risk Reporting"],
