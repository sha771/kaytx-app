...
export default function InventoryManagementPage() {
  const agent = {
    ...
    description: 'Automated Inventory Management agent specializing in accounting-finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Inventory Management',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
