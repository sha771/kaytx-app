...
export default function AiInventoryAccountingAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Inventory Tracking & Valuation","Stock Level Optimization","COGS Calculation & Analysis","Inventory Reconciliation","FIFO/LIFO/WAC Management","Inventory Audit Support","Stock Movement Analysis","Reorder Point Optimization","Inventory Cost Analysis","Obsolete Inventory Detection"],
