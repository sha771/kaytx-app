...
export default function AiPayrollAccountingAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Payroll Journal Entry Creation","Wage Expense Allocation","Payroll Tax Accounting","Benefits Accounting Entries","Accrued Payroll Management","Payroll Reconciliation","401(k) Contribution Accounting","Workers Comp Accounting","Payroll Variance Analysis","Multi-State Payroll Accounting"],
