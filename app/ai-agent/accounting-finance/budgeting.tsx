...
export default function AiBudgetingAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Budget Creation & Management","Scenario Modeling & Analysis","Revenue Forecasting","Expense Projections","Variance Analysis","Zero-Based Budgeting","Rolling Forecasts","Capital Budgeting","Departmental Budgeting","Budget vs Actual Analysis"],
