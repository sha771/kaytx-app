...
export default function AiBookkeeperScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Daily Transaction Recording","General Ledger Management","Account Reconciliation","Journal Entry Processing","Bank Statement Reconciliation","Chart of Accounts Maintenance","Trial Balance Preparation","Accrual Management","Adjusting Entries","Financial Record Integrity"],
