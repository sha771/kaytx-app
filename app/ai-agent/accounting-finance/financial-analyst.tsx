...
export default function AiFinancialAnalystScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Financial Statement Analysis","Ratio Analysis & Benchmarking","Performance Metrics Tracking","Trend Analysis","Financial Modeling","Variance Analysis","KPI Dashboard Creation","Investor Reporting","Management Reporting","Financial Forecasting"],
