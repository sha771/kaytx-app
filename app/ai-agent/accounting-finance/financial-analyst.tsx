...
export default function FinancialAnalystPage() {
  const agent = {
    ...
    description: 'Automated Financial Analyst agent specializing in accounting-finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
