...
export default function AiInvestmentAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Investment Opportunity Analysis","ROI Tracking & Measurement","Capital Allocation Optimization","Portfolio Performance Analysis","Investment Risk Assessment","Asset Allocation Strategy","Capital Budgeting Analysis","NPV & IRR Calculations","Investment Reporting","Strategic Investment Planning"],
