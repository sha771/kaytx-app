...
export default function AiTreasuryAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Cash Flow Forecasting","Liquidity Management","Bank Account Management","Wire Transfer Processing","Cash Position Reporting","Working Capital Optimization","Short-term Investment Management","Debt Service Management","Bank Relationship Management","Treasury Risk Management"],
