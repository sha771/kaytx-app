...
export default function AccountsReceivablePage() {
  const agent = {
    ...
    description: 'Automated Accounts Receivable agent specializing in accounting-finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
