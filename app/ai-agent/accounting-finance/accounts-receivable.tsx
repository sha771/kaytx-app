...
export default function AiArAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Customer Billing & Invoicing","Payment Collection Management","Cash Inflow Tracking","Payment Reconciliation","Aging Report Analysis","Collection Follow-ups","Credit Limit Management","Revenue Recognition","Bad Debt Assessment","Customer Account Reconciliation"],
