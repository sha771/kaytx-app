...
export default function AiFinancialReportingAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Balance Sheet Preparation","Income Statement Compilation","Cash Flow Statement Creation","Statement of Equity Reporting","Footnote Disclosure Writing","GAAP/IFRS Compliance Review","Consolidated Reporting","Interim Financial Statements","Annual Report Preparation","MD&A Drafting Support"],
