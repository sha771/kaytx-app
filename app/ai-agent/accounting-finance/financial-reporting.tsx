...
export default function FinancialReportingPage() {
  const agent = {
    ...
    description: 'Automated Financial Reporting agent specializing in accounting-finance operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
