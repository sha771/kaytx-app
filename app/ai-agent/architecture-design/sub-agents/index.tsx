...
export default function ArchitectureDesignSubAgentsPage() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Architecture & Design Sub-Agents</Text>
      <Text style={styles.subtitle}>Specialized Operational AI Agents</Text>
