...
export default function ArchitectureDesignPage() {
  ...
  const getLevelColor = (level: string) => {
    switch (level) {
      case 'c_level': return '#DC2626';
      case 'vp_director': return '#EA580C';
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Architecture & Design AI Agents</Text>
      <Text style={styles.subtitle}>Enterprise-Grade Architecture Intelligence Platform</Text>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.statsContainer}>
          ...
          <View style={styles.statBox}>
            ...
            <Text style={styles.statLabel}>Strategic Core</Text>
          </View>
          <View style={styles.statBox}>
            <Text style={styles.statNumber}>78</Text>
            <Text style={styles.statLabel}>Specialized</Text>
          </View>
        </View>

        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Core Architecture Intelligence</Text>
            ...
            >
              <View style={styles.agentInfo}>
                ...
                <View style={styles.agentMeta}>
                  <Text style={[styles.agentLevel, { color: getLevelColor(agent.level) }]}>
                    {agent.level.replace('_', ' ').toUpperCase()}
                  </Text>
                  <Text style={styles.agentEfficiency}>Efficiency: {agent.efficiency}</Text>
                </View>
              </View>
              <View style={[styles.efficiencyBadge, { backgroundColor: agent.color + '20' }]}>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Web Design Specialization</Text>
          {agents.slice(12, 24).map((agent) => (
            <Pressable
              key={agent.id}
              style={[styles.agentCard, { borderLeftColor: agent.color }]}
              onPress={() => router.push(agent.route)}
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Architectural Design Specialization</Text>
          {agents.slice(24, 39).map((agent) => (
            <Pressable
              key={agent.id}
              style={[styles.agentCard, { borderLeftColor: agent.color }]}
              onPress={() => router.push(agent.route)}
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Interior Design Specialization</Text>
          {agents.slice(39, 51).map((agent) => (
            <Pressable
              key={agent.id}
              style={[styles.agentCard, { borderLeftColor: agent.color }]}
              onPress={() => router.push(agent.route)}
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Urban Design Specialization</Text>
          {agents.slice(51, 63).map((agent) => (
            <Pressable
              key={agent.id}
              style={[styles.agentCard, { borderLeftColor: agent.color }]}
              onPress={() => router.push(agent.route)}
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Landscape Architecture Specialization</Text>
          {agents.slice(63, 75).map((agent) => (
            <Pressable
              key={agent.id}
              style={[styles.agentCard, { borderLeftColor: agent.color }]}
              onPress={() => router.push(agent.route)}
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Project Management Specialization</Text>
          {agents.slice(75, 87).map((agent) => (
            <Pressable
              key={agent.id}
              style={[styles.agentCard, { borderLeftColor: agent.color }]}
              onPress={() => router.push(agent.route)}
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>BIM Specialization</Text>
          {agents.slice(87, 100).map((agent) => (
            <Pressable
              key={agent.id}
              style={[styles.agentCard, { borderLeftColor: agent.color }]}
              onPress={() => router.push(agent.route)}
