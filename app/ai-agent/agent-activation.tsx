...
const initialMainAgents: MainAgent[] = [
  ...
  },
  {
    ...
    version: '2.9.1',
    subAgents: [
      { id: 'di-1', name: 'AI Data Analyst', description: 'Analyzes business data', icon: ChartBarBig, enabled: true, status: 'active', tasksCompleted: 2340, successRate: 94, lastActive: '3 min ago', capabilities: ['Data Mining', 'Statistical Analysis', 'Report Generation', 'Data Visualization'], tier: 'enterprise', learningProgress: 92, efficiency: 96 },
