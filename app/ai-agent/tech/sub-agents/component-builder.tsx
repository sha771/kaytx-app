...
export default function ComponentBuilderPage() {
  const agent = {
    ...
    title: 'Tech Agent',
    description: 'Automated Component Builder agent specializing in tech operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Component Builder',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
