...
export default function IncidentPostMortemFacilitatorPage() {
  const agent = {
    id: 'incident-post-mortem-facilitator',
    name: 'AI Incident Post Mortem Facilitator',
    title: 'Tech Agent',
    description: 'Automated Incident Post Mortem Facilitator agent specializing in tech operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Incident Post Mortem Facilitator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
