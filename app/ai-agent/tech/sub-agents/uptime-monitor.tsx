...
export default function UptimeMonitorPage() {
  const agent = {
    ...
    title: 'Tech Agent',
    description: 'Automated Uptime Monitor agent specializing in tech operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
