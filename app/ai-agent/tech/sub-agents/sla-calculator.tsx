...
export default function SlaCalculatorPage() {
  const agent = {
    ...
    title: 'Tech Agent',
    description: 'Automated Sla Calculator agent specializing in tech operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
