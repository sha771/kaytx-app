...
export default function EthicsReviewerPage() {
  const agent = {
    ...
    title: 'Tech Agent',
    description: 'Automated Ethics Reviewer agent specializing in tech operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
