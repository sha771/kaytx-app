...
export default function ModelPerformanceMonitorPage() {
  const agent = {
    ...
    title: 'Tech Agent',
    description: 'Automated Model Performance Monitor agent specializing in tech operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
