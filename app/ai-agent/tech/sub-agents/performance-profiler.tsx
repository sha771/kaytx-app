...
export default function PerformanceProfilerPage() {
  const agent = {
    ...
    title: 'Tech Agent',
    description: 'Automated Performance Profiler agent specializing in tech operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Performance Profiler',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
