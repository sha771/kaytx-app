...
export default function SecurityToolEvaluatorPage() {
  const agent = {
    id: 'security-tool-evaluator',
    name: 'AI Security Tool Evaluator',
    title: 'Tech Agent',
    description: 'Automated Security Tool Evaluator agent specializing in tech operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Security Tool Evaluator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
