...
export default function RunbookAuthorPage() {
  const agent = {
    ...
    title: 'Tech Agent',
    description: 'Automated Runbook Author agent specializing in tech operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
