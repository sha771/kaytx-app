...
export default function AiCrmAssistantPage() {
  const agent = {
    id: 'ai-crm-assistant',
    name: 'AI Ai Crm Assistant',
    title: 'AI Agent',
    description: 'Automated Ai Crm Assistant agent with advanced AI capabilities for task automation, data processing, and workflow coordination.',
