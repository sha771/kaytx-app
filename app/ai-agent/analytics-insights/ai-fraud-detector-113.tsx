...
export default function AgentPage() {
  const agent = {
    ...
    description: 'AI Fraud Detector - Fraud Detector level AI agent in the analytics insights department. Part of the Kaytx AI Workforce hierarchy providing specialized analytics insights capabilities.',
