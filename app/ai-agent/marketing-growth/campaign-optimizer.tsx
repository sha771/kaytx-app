...
export default function AiCampaignOptimizerScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Real-time Optimization","A/B Testing","Budget Allocation","Bid Management","Creative Testing","Audience Optimization","Performance Tracking","Attribution Analysis","Fraud Detection","Cross-channel Orchestration"],
