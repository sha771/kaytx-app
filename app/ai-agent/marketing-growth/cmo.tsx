...
export default function AiCmoScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Strategy Development","Brand Positioning","Budget Planning","Campaign Orchestration","Performance Analysis","Team Coordination","Stakeholder Communication","Competitive Analysis","ROI Optimization","Executive Reporting"],
