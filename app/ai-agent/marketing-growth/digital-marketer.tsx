...
export default function AiDigitalMarketerScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Channel Strategy","Campaign Execution","Content Distribution","Landing Page Optimization","Conversion Tracking","Remarketing","Retargeting","Affiliate Management","Influencer Outreach","Performance Reporting"],
