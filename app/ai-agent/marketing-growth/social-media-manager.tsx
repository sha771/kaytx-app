...
export default function AiSocialMediaManagerScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Content Calendar","Post Scheduling","Community Management","Influencer Outreach","Social Listening","Trend Monitoring","Engagement Response","Crisis Management","Analytics Reporting","Hashtag Optimization"],
