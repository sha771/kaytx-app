...
export default function AiContentGeneratorScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Blog Writing","Ad Copy","Landing Page Content","Email Copy","Social Media Posts","Video Scripts","Whitepapers","Case Studies","SEO Optimization","Brand Voice Consistency"],
