...
export default function AiCompetitiveIntelScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Competitor Monitoring","Pricing Intelligence","Market Analysis","Trend Forecasting","SWOT Analysis","Battlecard Creation","News Aggregation","Social Listening","Feature Comparison","Strategic Recommendations"],
