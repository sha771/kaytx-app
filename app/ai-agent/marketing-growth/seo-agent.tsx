...
export default function AiSeoAgentScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Technical SEO Audit","Keyword Research","Content Optimization","Link Building","Local SEO","Schema Markup","Site Speed Optimization","Mobile Optimization","Rank Tracking","Competitor Analysis"],
