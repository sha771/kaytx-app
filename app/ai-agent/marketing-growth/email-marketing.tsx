...
export default function AiEmailMarketingScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Campaign Creation","Automation Workflows","List Segmentation","A/B Testing","Personalization","Deliverability Optimization","Template Design","Drip Campaigns","Lead Nurturing","Performance Analytics"],
