...
export default function PipelineAutomatorPage() {
  const agent = {
    ...
    title: 'Data Agent',
    description: 'Automated Pipeline Automator agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Pipeline Automator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
