...
export default function DataLineageTrackerPage() {
  const agent = {
    ...
    title: 'Data Agent',
    description: 'Automated Data Lineage Tracker agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Data Lineage Tracker',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
