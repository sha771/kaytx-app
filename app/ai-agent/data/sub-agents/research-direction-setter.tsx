...
export default function ResearchDirectionSetterPage() {
  const agent = {
    id: 'research-direction-setter',
    name: 'AI Research Direction Setter',
    title: 'Data Agent',
    description: 'Automated Research Direction Setter agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Research Direction Setter',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
