...
export default function PipelineArchitectPage() {
  const agent = {
    ...
    title: 'Data Agent',
    description: 'Automated Pipeline Architect agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Pipeline Architect',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
