...
export default function IssueResolverPage() {
  const agent = {
    ...
    title: 'Data Agent',
    description: 'Automated Issue Resolver agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
