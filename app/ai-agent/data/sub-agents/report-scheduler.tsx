...
export default function ReportSchedulerPage() {
  const agent = {
    ...
    title: 'Data Agent',
    description: 'Automated Report Scheduler agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
