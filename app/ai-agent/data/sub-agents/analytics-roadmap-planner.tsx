...
export default function AnalyticsRoadmapPlannerPage() {
  const agent = {
    id: 'analytics-roadmap-planner',
    name: 'AI Analytics Roadmap Planner',
    title: 'Data Agent',
    description: 'Automated Analytics Roadmap Planner agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Analytics Roadmap Planner',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
