...
export default function PriorityPlannerPage() {
  const agent = {
    ...
    title: 'Data Agent',
    description: 'Automated Priority Planner agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
