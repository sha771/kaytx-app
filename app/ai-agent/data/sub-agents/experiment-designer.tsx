    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          AI Experiment Designer - Sub-agent supporting AI Data Scientist. Part of the Kaytx AI Workforce hierarchy providing automated capabilities.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.tagsContainer}>
          {['Experiment Designer','AI-Powered','Real-time','Analytics','Integration','Automation'].map((cap,index)=>(
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        {['/consult/experiment-designer','/experiment-designer/execute','/experiment-designer/analyze'].map((endpoint,index)=>(
