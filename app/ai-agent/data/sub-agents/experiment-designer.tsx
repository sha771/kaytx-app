...
export default function ExperimentDesignerPage() {
  const agent = {
    ...
    title: 'Data Agent',
    description: 'Automated Experiment Designer agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
