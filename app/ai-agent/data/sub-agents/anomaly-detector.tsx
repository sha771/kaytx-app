...
export default function AnomalyDetectorPage() {
  const agent = {
    ...
    title: 'Data Agent',
    description: 'Automated Anomaly Detector agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
