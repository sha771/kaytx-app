...
export default function QueryBuilderPage() {
  const agent = {
    ...
    title: 'Data Agent',
    description: 'Automated Query Builder agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
