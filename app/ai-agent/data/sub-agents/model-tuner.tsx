...
export default function ModelTunerPage() {
  const agent = {
    ...
    name: 'AI Model Tuner',
    title: 'Data Agent',
    description: 'Automated Model Tuner agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
