...
export default function DataCostOptimizerPage() {
  const agent = {
    id: 'data-cost-optimizer',
    name: 'AI Data Cost Optimizer',
    title: 'Data Agent',
    description: 'Automated Data Cost Optimizer agent specializing in data operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Data Cost Optimizer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
