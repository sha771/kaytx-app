...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'211',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.9s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.0%',icon:Target,color:'#1A237E'}];
  const capabilities = ['Fraud Detection','Transaction Monitoring','Loss Prevention'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Detects fraudulent activities, monitors transactions, and prevents financial losses.</Text></View>
      ...
      <AgentFeatures agentId="fraud-detection" agentName="AI Fraud Detection Agent" />
    </ScrollView>
  );
}
