...
const ACCENT = '#FF3B30';
const AGENT_NAME = 'AI Fraud Detection';
const AGENT_TITLE = 'Security Analytics AI';
const AGENT_DESC = 'Scans thousands of transactions per second to detect and block fraudulent activity with near-zero false positives.';
const PARENT_NAME = 'Data Intelligence AI';

const METRICS = [
  { label: 'Tasks Today', value: '45.2k', color: ACCENT },
  { label: 'Success Rate', value: '99%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.01s', color: '#007AFF' },
  { label: 'Accuracy', value: '99.9%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Blocked 3 high-risk transactions",
        "time": "1m ago"
    },
    {
        "action": "Flagged login from unfamiliar IP",
        "time": "5m ago"
    },
    {
        "action": "Analyzed behavioral biometric pattern",
        "time": "12m ago"
    },
    {
        "action": "Approved $5k wire transfer post-verification",
        "time": "30m ago"
    },
    {
        "action": "Updated machine learning ruleset",
        "time": "2h ago"
    }
];
