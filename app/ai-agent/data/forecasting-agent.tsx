...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'173',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.4s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.6%',icon:Target,color:'#1A237E'}];
  const capabilities = ['Predictive Analytics','Machine Learning','Accurate Forecasting'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Forecasting Agent</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Creates accurate forecasts using predictive analytics and machine learning.</Text></View>
      ...
      <AgentFeatures agentId="forecasting-agent" agentName="AI Forecasting Agent" />
    </ScrollView>
  );
}
