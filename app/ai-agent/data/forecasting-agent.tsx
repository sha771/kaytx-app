...
const ACCENT = '#00C7BE';
const AGENT_NAME = 'AI Forecasting Agent';
const AGENT_TITLE = 'Predictive Modeling AI';
const AGENT_DESC = 'Uses machine learning on historical data to accurately forecast revenue, demand, and resource needs.';
const PARENT_NAME = 'Data Intelligence AI';

const METRICS = [
  { label: 'Tasks Today', value: '89', color: ACCENT },
  { label: 'Success Rate', value: '93%', color: '#00C853' },
  { label: 'Avg Speed', value: '3.1s', color: '#007AFF' },
  { label: 'Accuracy', value: '94.5%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Forecasted Q4 sales revenue +/- 2%",
        "time": "20m ago"
    },
    {
        "action": "Predicted inventory requirement for Nov",
        "time": "1h ago"
    },
    {
        "action": "Adjusted model for seasonality",
        "time": "3h ago"
    },
    {
        "action": "Simulated best/worst case scenarios",
        "time": "5h ago"
    },
    {
        "action": "Updated pipeline conversion probabilities",
        "time": "8h ago"
    }
];
