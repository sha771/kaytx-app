...
const ACCENT = '#FF9500';
const AGENT_NAME = 'AI Risk Analyst';
const AGENT_TITLE = 'Enterprise Risk AI';
const AGENT_DESC = 'Quantifies operational and market risks, performs stress testing, and ensures business continuity.';
...
const RECENT_TASKS = [
    {
        "action": "Ran macro-economic stress test",
        "time": "45m ago"
    },
    {
        "action": "Updated enterprise risk matrix",
        "time": "2h ago"
    },
    {
        "action": "Assessed supply chain vulnerabilities",
        "time": "4h ago"
    },
    {
        "action": "Calculated Value at Risk (VaR)",
        "time": "6h ago"
    },
    {
