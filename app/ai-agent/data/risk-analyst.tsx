...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'178',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'2.0s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'99.8%',icon:Target,color:'#1A237E'}];
  const capabilities = ['Risk Identification','Risk Assessment','Predictive Modeling'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Risk Analyst</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Identifies, assesses, and monitors business risks with predictive modeling.</Text></View>
      ...
      <AgentFeatures agentId="risk-analyst" agentName="AI Risk Analyst" />
    </ScrollView>
  );
}
