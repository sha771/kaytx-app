...
const AGENT_TITLE = 'Business Intelligence AI';
const AGENT_DESC = 'Processes complex datasets into clean dashboards and answers ad-hoc business questions via natural language SQL.';
const PARENT_NAME = 'Data Intelligence AI';

const METRICS = [
  { label: 'Tasks Today', value: '128', color: ACCENT },
  { label: 'Success Rate', value: '97%', color: '#00C853' },
  { label: 'Avg Speed', value: '1.8s', color: '#007AFF' },
  { label: 'Accuracy', value: '97.5%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Wrote complex SQL join for sales data",
        "time": "8m ago"
    },
    {
        "action": "Built real-time KPI dashboard",
        "time": "30m ago"
    },
    {
        "action": "Cleaned dataset of 50k messy rows",
        "time": "1h ago"
    },
    {
        "action": "Answered CEO query on Q3 margins",
        "time": "2h ago"
    },
    {
        "action": "Detected anomaly in daily active users",
        "time": "4h ago"
    }
];
