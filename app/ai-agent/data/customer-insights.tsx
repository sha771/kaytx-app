...
const ACCENT = '#28A745';
const AGENT_NAME = 'AI Customer Insights';
const AGENT_TITLE = 'Behavior Analytics AI';
const AGENT_DESC = 'Analyzes user behavior across apps and websites to identify friction points and predict future actions.';
const PARENT_NAME = 'Data Intelligence AI';

const METRICS = [
  { label: 'Tasks Today', value: '3.4k', color: ACCENT },
  { label: 'Success Rate', value: '96%', color: '#00C853' },
  { label: 'Avg Speed', value: '0.4s', color: '#007AFF' },
  { label: 'Accuracy', value: '96.8%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Analyzed 1,000 onboarding sessions",
        "time": "12m ago"
    },
    {
        "action": "Identified 40% drop-off at Step 3",
        "time": "45m ago"
    },
    {
        "action": "Segmented power users by feature usage",
        "time": "2h ago"
    },
    {
        "action": "Predicted churn for 15 accounts",
        "time": "3h ago"
    },
    {
        "action": "Correlated NPS score with usage time",
        "time": "5h ago"
    }
];
