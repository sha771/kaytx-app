...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'244',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.9s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.1%',icon:Target,color:'#1A237E'}];
  const capabilities = ['Sales Data Analysis','Trend Identification','Performance Insights'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Sales Data Analyst</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Analyzes sales data, identifies trends, and provides sales performance insights.</Text></View>
      ...
      <AgentFeatures agentId="sales-data-analyst" agentName="AI Sales Data Analyst" />
    </ScrollView>
  );
}
