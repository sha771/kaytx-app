...
const AGENT_TITLE = 'Sales Performance AI';
const AGENT_DESC = 'Analyzes rep performance, optimizes sales territories, and uncovers the highest converting lead sources.';
const PARENT_NAME = 'Data Intelligence AI';

const METRICS = [
  { label: 'Tasks Today', value: '76', color: ACCENT },
  { label: 'Success Rate', value: '95%', color: '#00C853' },
  { label: 'Avg Speed', value: '1.5s', color: '#007AFF' },
  { label: 'Accuracy', value: '96.2%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Analyzed pipeline velocity by rep",
        "time": "10m ago"
    },
    {
        "action": "Re-balanced 3 sales territories",
        "time": "1h ago"
    },
    {
        "action": "Identified top performing lead source",
        "time": "2h ago"
    },
    {
        "action": "Generated weekly quota attainment report",
        "time": "4h ago"
    },
    {
        "action": "Correlated win rate with demo length",
        "time": "7h ago"
    }
];
