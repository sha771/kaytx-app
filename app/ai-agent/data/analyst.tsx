...
export default function AiDataAnalystScreen() {
  ...
  const agent = useMemo(() => ({
    ...
    type: 'subagent',
    status: 'active',
    capabilities: ["Statistical Analysis","Data Visualization","Predictive Modeling","Trend Analysis","Pattern Recognition","Report Generation","Dashboard Creation","Data Mining"],
