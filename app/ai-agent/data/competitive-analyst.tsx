...
export default function AgentPage() {
  ...
  const stats = [{label:'Tasks/Day',value:'143',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'0.5s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'97.2%',icon:Target,color:'#1A237E'}];
  const capabilities = ['Competitor Monitoring','Market Positioning','Strategic Intelligence'];
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>Monitors competitors, analyzes market positioning, and provides strategic intelligence.</Text></View>
