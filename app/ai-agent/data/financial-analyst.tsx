...
const ACCENT = '#20C997';
const AGENT_NAME = 'AI Financial Analyst';
const AGENT_TITLE = 'Financial Modeling AI';
const AGENT_DESC = 'Builds complex financial models, analyzes P&L statements, and identifies cost-saving opportunities.';
...
const METRICS = [
  ...
  { label: 'Accuracy', value: '98.7%', color: '#5856D6' },
];

const RECENT_TASKS = [
    {
        "action": "Updated 3-year P&L projection",
        "time": "15m ago"
    },
    {
        "action": "Identified $15k AWS overspend",
        "time": "1h ago"
    },
    {
        "action": "Compiled board investor deck",
        "time": "3h ago"
    },
    {
        "action": "Modeled impact of 5% price increase",
        "time": "4h ago"
    },
    {
        "action": "Calculated departmental CAC/LTV",
        "time": "1d ago"
    }
];
