...
export default function ProfessionalServicesDashboard() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      >
        <View style={styles.navCardHeader}>
          ...
          <View style={styles.navCardInfo}>
            <Text style={[styles.navCardTitle, { color: theme.colors.text }]}>AI Professional Services Command Center</Text>
            <Text style={[styles.navCardSubtitle, { color: theme.colors.textSecondary }]}>Global Consulting & Delivery Intelligence</Text>
          </View>
        </View>
      ...
      {/* Standard Dashboard */}
      <DepartmentDashboard 
        config={professionalServicesDashboardConfig}
