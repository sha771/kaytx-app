...
export default function ProfessionalServicesAICommandCenter() {
  ...
  const deliveryKPIs: KPICard[] = [
    { id: '6', title: 'Active Projects', value: '12450', change: '+4.2%', trend: 'up', color: colors.electricBlue, subtitle: 'Global engagements', icon: Briefcase, forecast: '13200 Q1', aiCommentary: 'AI: Capacity utilization optimal' },
  ...
  const resourceKPIs: KPICard[] = [
    ...
    { id: '14', title: 'Resource Availability', value: '1240', change: '+5.8%', trend: 'up', color: colors.electricBlue, subtitle: 'Ready to deploy', icon: User, forecast: '1380 Q1', aiCommentary: 'AI: Staffing pipeline healthy' },
  ...
  const aiKPIs: KPICard[] = [
    ...
    { id: '24', title: 'Delivery Acceleration', value: '+28%', change: '+5.3%', trend: 'up', color: colors.purple, subtitle: 'Time-to-delivery', icon: TrendingUp, forecast: '+32% Q1', aiCommentary: 'AI: Speed improvements sustained' },
    { id: '25', title: 'AI Recommendations', value: '48200', change: '+24.8%', trend: 'up', color: colors.electricBlue, subtitle: 'Generated this month', icon: Sparkles, forecast: '58500 Q1', aiCommentary: 'AI: Intelligence scaling' },
  ];
  ...
  const agents: Agent[] = [
    ...
    },
    {
      ...
      color: colors.purple,
      metrics: [
        { label: 'Accounts Managed', value: '1240' },
    ...
    },
    {
      ...
      color: colors.amber,
      metrics: [
        { label: 'Resources Assigned', value: '4820' },
