...
import { ChartBarBig, TrendingUp, TrendingDown, Activity, Globe, Zap } from 'lucide-react-native';
...
export default function CommoditiesScreen() {
  ...
  const customTabs = [
    { id: 'commodities', label: 'Markets', icon: ChartBarBig, component: commoditiesTab },
