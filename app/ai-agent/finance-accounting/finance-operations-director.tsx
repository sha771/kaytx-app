...
export default function FinanceOperationsDirectorPage() {
  const agent = {
    id: 'finance-operations-director',
    name: 'AI Finance Operations Director',
    title: 'AI Finance Operations Director',
    description: 'AI Finance Operations Director provides specialized expertise and executes critical tasks for the Finance & Accounting department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'finance-operations-director',
    infrastructure: {
      status: 'online',
