...
export default function FinancialPlanningDirectorPage() {
  const agent = {
    id: 'financial-planning-director',
    name: 'AI Financial Planning Director',
    title: 'AI Financial Planning Director',
    description: 'AI Financial Planning Director provides specialized expertise and executes critical tasks for the Finance & Accounting department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'financial-planning-director',
    infrastructure: {
      status: 'online',
