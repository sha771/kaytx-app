...
export default function BotHealthMonitorPage() {
  const agent = {
    ...
    title: 'Ai-mgmt Agent',
    description: 'Automated Bot Health Monitor agent specializing in ai-mgmt operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
