...
export default function AutomationRunbookAuthorPage() {
  const agent = {
    ...
    title: 'Ai-mgmt Agent',
    description: 'Automated Automation Runbook Author agent specializing in ai-mgmt operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
