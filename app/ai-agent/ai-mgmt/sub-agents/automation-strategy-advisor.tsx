...
export default function AutomationStrategyAdvisorPage() {
  const agent = {
    ...
    title: 'Ai-mgmt Agent',
    description: 'Automated Automation Strategy Advisor agent specializing in ai-mgmt operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
