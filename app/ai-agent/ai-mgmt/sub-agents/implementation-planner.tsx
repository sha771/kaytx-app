...
export default function ImplementationPlannerPage() {
  const agent = {
    ...
    title: 'Ai-mgmt Agent',
    description: 'Automated Implementation Planner agent specializing in ai-mgmt operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
