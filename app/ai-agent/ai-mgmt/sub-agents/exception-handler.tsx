...
export default function ExceptionHandlerPage() {
  const agent = {
    ...
    title: 'Ai-mgmt Agent',
    description: 'Automated Exception Handler agent specializing in ai-mgmt operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
