...
import { Zap, Activity, Star, CircleCheckBig, Clock, Target, ArrowRight, GitBranch, Puzzle, Calendar } from 'lucide-react-native';
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        ...
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI VP Automation</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>AI Management & Governance</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}><Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Overview</Text><Text style={[styles.description, { color: theme.colors.textSecondary }]}>The AI VP Automation leads automation pipeline management, tool selection, and implementation planning to drive enterprise-wide automation initiatives.</Text></View>
