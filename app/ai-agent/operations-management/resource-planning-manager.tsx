...
export default function ResourcePlanningManagerPage() {
  const agent = {
    id: 'resource-planning-manager',
    name: 'AI Resource Planning Manager',
    title: 'AI Resource Planning Manager',
    description: 'AI Resource Planning Manager provides specialized expertise and executes critical tasks for the Operations & Management department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'resource-planning-manager',
    infrastructure: {
      status: 'online',
