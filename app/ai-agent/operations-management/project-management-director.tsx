...
export default function ProjectManagementDirectorPage() {
  const agent = {
    id: 'project-management-director',
    name: 'AI Project Management Director',
    title: 'AI Project Management Director',
    description: 'AI Project Management Director provides specialized expertise and executes critical tasks for the Operations & Management department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'project-management-director',
    infrastructure: {
      status: 'online',
