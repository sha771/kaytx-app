...
export default function ProcessImprovementAnalystPage() {
  const agent = {
    id: 'process-improvement-analyst',
    name: 'AI Process Improvement Analyst',
    title: 'AI Process Improvement Analyst',
    description: 'AI Process Improvement Analyst provides specialized expertise and executes critical tasks for the Operations & Management department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'process-improvement-analyst',
    infrastructure: {
      status: 'online',
