...
export default function BusinessOperationsDirectorPage() {
  const agent = {
    id: 'business-operations-director',
    name: 'AI Business Operations Director',
    title: 'AI Business Operations Director',
    description: 'AI Business Operations Director provides specialized expertise and executes critical tasks for the Operations & Management department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'business-operations-director',
    infrastructure: {
      status: 'online',
