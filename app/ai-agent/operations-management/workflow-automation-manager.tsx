...
export default function WorkflowAutomationManagerPage() {
  const agent = {
    id: 'workflow-automation-manager',
    name: 'AI Workflow Automation Manager',
    title: 'AI Workflow Automation Manager',
    description: 'AI Workflow Automation Manager provides specialized expertise and executes critical tasks for the Operations & Management department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'workflow-automation-manager',
    infrastructure: {
      status: 'online',
