...
export default function ChangeManagementCoordinatorPage() {
  const agent = {
    id: 'change-management-coordinator',
    name: 'AI Change Management Coordinator',
    title: 'AI Change Management Coordinator',
    description: 'AI Change Management Coordinator provides specialized expertise and executes critical tasks for the Operations & Management department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'change-management-coordinator',
    infrastructure: {
      status: 'online',
