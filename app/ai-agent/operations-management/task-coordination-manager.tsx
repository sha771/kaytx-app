...
export default function TaskCoordinationManagerPage() {
  const agent = {
    id: 'task-coordination-manager',
    name: 'AI Task Coordination Manager',
    title: 'AI Task Coordination Manager',
    description: 'AI Task Coordination Manager provides specialized expertise and executes critical tasks for the Operations & Management department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'task-coordination-manager',
    infrastructure: {
      status: 'online',
