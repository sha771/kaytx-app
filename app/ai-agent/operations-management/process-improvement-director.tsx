...
export default function ProcessImprovementDirectorPage() {
  const agent = {
    id: 'process-improvement-director',
    name: 'AI Process Improvement Director',
    title: 'AI Process Improvement Director',
    description: 'AI Process Improvement Director provides specialized expertise and executes critical tasks for the Operations & Management department. This AI agent automates complex workflows, provides intelligent insights, and collaborates with other agents to achieve organizational goals with maximum efficiency.',
    ...
    replacesRole: 'process-improvement-director',
    infrastructure: {
      status: 'online',
