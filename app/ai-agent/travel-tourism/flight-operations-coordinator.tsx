...
export default function FlightOperationsCoordinatorPage() {
  const agent = {
    id: 'flight-operations-coordinator',
    name: 'AI Flight Operations Coordinator',
    title: 'AI Flight Operations Coordinator',
    ...
    capabilities: ["Travel Operations","Hotel Operations","Tour Operations","Revenue Management","Customer Experience","Safety Management"],
    icon: Bot,
    color: '#0891B2',
    ...
    replacesRole: 'flight-operations-coordinator',
    infrastructure: {
      status: 'online',
