...
export default function AiCompetitiveAnalystPage() {
  const agent = {
    id: 'ai-competitive-analyst',
    name: 'AI Ai Competitive Analyst',
    title: 'AI Agent',
    description: 'Automated Ai Competitive Analyst agent with advanced AI capabilities for task automation, data processing, and workflow coordination.',
