...
export default function EthicsMonitorPage() {
  const agent = {
    ...
    description: 'Automated Ethics Monitor agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
