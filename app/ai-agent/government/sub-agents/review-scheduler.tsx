...
export default function ReviewSchedulerPage() {
  const agent = {
    ...
    description: 'Automated Review Scheduler agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
