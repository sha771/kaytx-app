...
export default function ApplicationWriterPage() {
  const agent = {
    ...
    description: 'Automated Application Writer agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Application Writer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
