...
export default function FilingCoordinatorPage() {
  const agent = {
    id: 'filing-coordinator',
    name: 'AI Filing Coordinator',
    title: 'Government Agent',
    description: 'Automated Filing Coordinator agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Filing Coordinator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
