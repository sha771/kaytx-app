...
export default function PerformanceReporterPage() {
  const agent = {
    ...
    description: 'Automated Performance Reporter agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Performance Reporter',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
