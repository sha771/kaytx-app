...
export default function CommentDrafterPage() {
  const agent = {
    ...
    description: 'Automated Comment Drafter agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
