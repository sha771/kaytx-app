...
export default function RecommendationDrafterPage() {
  const agent = {
    id: 'recommendation-drafter',
    name: 'AI Recommendation Drafter',
    title: 'Government Agent',
    description: 'Automated Recommendation Drafter agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Recommendation Drafter',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
