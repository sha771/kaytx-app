...
export default function InterAgencyCoordinatorPage() {
  const agent = {
    id: 'inter-agency-coordinator',
    name: 'AI Inter Agency Coordinator',
    title: 'Government Agent',
    description: 'Automated Inter Agency Coordinator agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Inter Agency Coordinator',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
