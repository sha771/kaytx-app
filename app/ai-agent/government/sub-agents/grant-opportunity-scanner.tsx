...
export default function GrantOpportunityScannerPage() {
  const agent = {
    id: 'grant-opportunity-scanner',
    name: 'AI Grant Opportunity Scanner',
    title: 'Government Agent',
    description: 'Automated Grant Opportunity Scanner agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Grant Opportunity Scanner',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
