...
export default function RegulatoryTrackerPage() {
  const agent = {
    ...
    description: 'Automated Regulatory Tracker agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Regulatory Tracker',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
