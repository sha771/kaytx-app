...
export default function DataAnalystPage() {
  const agent = {
    ...
    description: 'Automated Data Analyst agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
