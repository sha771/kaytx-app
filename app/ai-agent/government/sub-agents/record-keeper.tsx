...
export default function RecordKeeperPage() {
  const agent = {
    ...
    description: 'Automated Record Keeper agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
