...
export default function CommunicationStrategistPage() {
  const agent = {
    ...
    description: 'Automated Communication Strategist agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Communication Strategist',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
