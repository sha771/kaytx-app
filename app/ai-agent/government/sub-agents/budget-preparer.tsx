...
export default function BudgetPreparerPage() {
  const agent = {
    ...
    description: 'Automated Budget Preparer agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
