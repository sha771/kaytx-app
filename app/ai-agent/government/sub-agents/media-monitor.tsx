...
export default function MediaMonitorPage() {
  const agent = {
    ...
    description: 'Automated Media Monitor agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
