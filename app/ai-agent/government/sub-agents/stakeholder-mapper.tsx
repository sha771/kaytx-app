...
export default function StakeholderMapperPage() {
  const agent = {
    ...
    description: 'Automated Stakeholder Mapper agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Stakeholder Mapper',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
