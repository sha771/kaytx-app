...
export default function FoiaResponderPage() {
  const agent = {
    ...
    description: 'Automated Foia Responder agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
