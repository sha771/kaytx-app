...
export default function PolicyResearcherPage() {
  const agent = {
    ...
    description: 'Automated Policy Researcher agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Policy Researcher',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
