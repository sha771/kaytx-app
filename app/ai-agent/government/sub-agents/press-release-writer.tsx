...
export default function PressReleaseWriterPage() {
  const agent = {
    ...
    description: 'Automated Press Release Writer agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Press Release Writer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
