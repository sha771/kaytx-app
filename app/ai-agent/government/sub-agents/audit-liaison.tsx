...
export default function AuditLiaisonPage() {
  const agent = {
    ...
    description: 'Automated Audit Liaison agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
