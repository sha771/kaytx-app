...
export default function ImpactAssessorPage() {
  const agent = {
    ...
    description: 'Automated Impact Assessor agent specializing in government operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
