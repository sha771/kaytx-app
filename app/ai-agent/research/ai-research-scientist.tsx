...
import { Microscope, Activity, Star, CheckCircle2, Clock, Target, ArrowRight, Zap } from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

export default function AgentPage() {
  const { theme } = useTheme();
  const stats = [{label:'Tasks',value:'3,765',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.2s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.5%',icon:Target,color:'#006064'}];
  ...
  const activities = [{time:'3 min ago',text:'Submitted paper to NeurIPS',icon:CheckCircle2},{time:'6 min ago',text:'Developed novel attention mechanism',icon:Clock},{time:'9 min ago',text:'Reviewed 4 research papers',icon:Zap}];
  return (
