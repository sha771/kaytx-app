...
export default function VPResearchPage() {
  ...
  const capabilities = ['R&D Strategy', 'Experiment Design', 'Patent Research', 'Innovation Pipeline', 'Prototyping', 'Market Research', 'Tech Scouting', 'Feasibility Studies'];
  ...
  const activities = [
    { time: '5 min ago', text: 'Initiated feasibility study for edge AI' },
    { time: '25 min ago', text: 'Updated patent landscape for NLP' },
    { time: '1 hour ago', text: 'Completed 12 experiment result analyses' },
    { time: '3 hours ago', text: 'Published Q3 research findings brief' },
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { backgroundColor: theme.colors.primary + '18' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: theme.colors.primary + '25' }]}>
          <Microscope size={48} color={theme.colors.primary} />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>VP Research</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>R&D Department</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The VP Research AI leads R&D strategy, experimental design, and innovation discovery. This agent drives cutting-edge research, manages the innovation pipeline, and translates emerging technologies into competitive advantages.
        </Text>
      </View>
    ...
    <AgentFeatures agentId="vp-research" agentName="VP Research" />
