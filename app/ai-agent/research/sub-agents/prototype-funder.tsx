...
export default function PrototypeFunderPage() {
  const agent = {
    ...
    description: 'Automated Prototype Funder agent specializing in research operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
