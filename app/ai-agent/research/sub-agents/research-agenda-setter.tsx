...
import { Activity, Telescope, Clock, Target, Zap, ArrowRight, Briefcase, TrendingUp, BarChart3, MessageSquare, Calendar, Shield, FileText, Users, Lightbulb, CheckCircle, Layers, Settings, Compass, Map } from 'lucide-react-native';
...
export default function ResearchAgendaSetterPage() {
  ...
  const stats = [
    { label: 'Agendas Set', value: '156', icon: Target, color: '#34C759' },
    { label: 'Uptime', value: '99.9%', icon: Activity, color: '#007AFF' },
    { label: 'Response', value: '0.8s', icon: Clock, color: '#FF9500' },
    { label: 'Accuracy', value: '97.2%', icon: Briefcase, color: '#10B981' },
  ];

  const capabilities = ['Strategic Planning', 'Priority Mapping', 'Resource Allocation', 'Timeline Definition', 'Milestone Setting', 'Stakeholder Alignment', 'Gap Analysis', 'Opportunity Identification'];

  const responsibilities = [
    'Define and maintain research agenda priorities',
    'Align research initiatives with business objectives',
    'Coordinate cross-functional research priorities',
    'Identify emerging research opportunities',
    'Balance short-term and long-term research goals',
    'Communicate agenda changes to stakeholders'
  ];

  const activities = [
    { time: '5 min ago', text: 'Updated Q3 research priorities', icon: Map },
    { time: '20 min ago', text: 'Aligned agenda with board strategy', icon: Target },
    { time: '1 hour ago', text: 'Identified 3 new research gaps', icon: Compass },
    { time: '3 hours ago', text: 'Coordinated with VP Innovation', icon: Users },
  ];

  const quickActions = [
    { label: 'Agenda', icon: Map, route: '/ai-agent/research' },
  ...
  const a2aEndpoints = [
    { method: 'GET', endpoint: '/api/v1/research/agenda', description: 'Get current agenda' },
    { method: 'POST', endpoint: '/api/v1/research/agenda/update', description: 'Update agenda' },
    { method: 'GET', endpoint: '/api/v1/research/agenda/priorities', description: 'List priorities' },
    { method: 'POST', endpoint: '/api/v1/research/agenda/align', description: 'Align with strategy' },
  ];

  const performanceMetrics = [
    { label: 'Agendas Created', value: '156', trend: '+22%' },
    { label: 'Alignment Score', value: '94%', trend: '+8%' },
    { label: 'Stakeholder OK', value: '98%', trend: '+5%' },
    { label: 'On-Time', value: '97%', trend: '+12%' },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { backgroundColor: '#10B98118', borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#10B98125' }]}>
          <Telescope size={56} color="#10B981" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Research Agenda Setter</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Research Agenda Setter defines and maintains strategic research priorities, aligning initiatives with business objectives and coordinating cross-functional research goals.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <TouchableOpacity onPress={() => router.push('/ai-agent/research/vp-research' as any)} style={[styles.parentCard, { backgroundColor: '#00968815' }]}>
          <Telescope size={24} color="#009688" />
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.relatedAgentsRow}>
          <TouchableOpacity onPress={() => router.push('/ai-agent/research/research-lead' as any)} style={[styles.relatedAgentCard, { backgroundColor: '#6366F115' }]}>
            <Target size={18} color="#6366F1" />
            <Text style={[styles.relatedAgentText, { color: '#6366F1' }]}>Research Lead</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => router.push('/ai-agent/research/vp-innovation' as any)} style={[styles.relatedAgentCard, { backgroundColor: '#E91E6315' }]}>
            <Lightbulb size={18} color="#E91E63" />
            <Text style={[styles.relatedAgentText, { color: '#E91E63' }]}>VP Innovation</Text>
          </TouchableOpacity>
        </View>
      </View>

      <AgentFeatures agentId="research-agenda-setter" agentName="AI Research Agenda Setter" />
