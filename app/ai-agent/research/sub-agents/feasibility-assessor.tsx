...
export default function FeasibilityAssessorPage() {
  const agent = {
    ...
    description: 'Automated Feasibility Assessor agent specializing in research operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Feasibility Assessor',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
