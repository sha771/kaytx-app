...
import { Activity, Lightbulb, Clock, Target, Zap, ArrowRight, Briefcase, TrendingUp, BarChart3, MessageSquare, Calendar, Shield, FileText, Users, CheckCircle, Layers, Settings, Star, Award, ThumbsUp, PieChart } from 'lucide-react-native';
...
export default function IdeaScorerPage() {
  ...
  const stats = [
    { label: 'Ideas Scored', value: '5,234', icon: Star, color: '#34C759' },
    { label: 'Uptime', value: '99.9%', icon: Activity, color: '#007AFF' },
    { label: 'Response', value: '0.3s', icon: Clock, color: '#FF9500' },
    { label: 'Accuracy', value: '94.7%', icon: Briefcase, color: '#E91E63' },
  ];

  const capabilities = ['Idea Evaluation', 'Scoring Criteria', 'Market Potential', 'Feasibility Analysis', 'Risk Assessment', 'ROI Prediction', 'Competitive Analysis', 'Priority Ranking'];

  const responsibilities = [
    'Evaluate and score innovation ideas',
    'Apply consistent scoring criteria',
    'Assess market potential and viability',
    'Analyze technical feasibility',
    'Evaluate risks and challenges',
    'Predict ROI and business impact'
  ];

  const activities = [
    { time: '5 min ago', text: 'Scored 12 new product ideas', icon: Star },
    { time: '20 min ago', text: 'Completed feasibility analysis', icon: Target },
    { time: '1 hour ago', text: 'Ranked innovation pipeline', icon: Award },
    { time: '3 hours ago', text: 'Generated ROI predictions', icon: TrendingUp },
  ];

  const quickActions = [
    { label: 'Score', icon: Star, route: '/ai-agent/research' },
  ...
  const a2aEndpoints = [
    { method: 'GET', endpoint: '/api/v1/idea/scorer/list', description: 'List scored ideas' },
    { method: 'POST', endpoint: '/api/v1/idea/scorer/evaluate', description: 'Evaluate idea' },
    { method: 'GET', endpoint: '/api/v1/idea/scorer/rankings', description: 'Get rankings' },
    { method: 'POST', endpoint: '/api/v1/idea/scorer/predict', description: 'Predict ROI' },
  ];

  const performanceMetrics = [
    { label: 'Ideas Scored', value: '5,234', trend: '+48%' },
    { label: 'Accuracy', value: '94%', trend: '+12%' },
    { label: 'Avg Time', value: '0.3s', trend: '-60%' },
    { label: 'Top Picks', value: '847', trend: '+35%' },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { backgroundColor: '#E91E6318', borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#E91E6325' }]}>
          <Star size={56} color="#E91E63" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Idea Scorer</Text>
        <Text style={[styles.heroSubtitle, { color: theme.colors.textSecondary }]}>Sub-Agent of AI VP Innovation</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Idea Scorer evaluates innovation ideas using consistent criteria, assesses market potential, and predicts ROI to prioritize the innovation pipeline.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <TouchableOpacity onPress={() => router.push('/ai-agent/research/vp-innovation' as any)} style={[styles.parentCard, { backgroundColor: '#E91E6315' }]}>
          <Lightbulb size={24} color="#E91E63" />
          <View style={styles.parentInfo}>
            <Text style={[styles.parentName, { color: theme.colors.text }]}>AI VP Innovation</Text>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.relatedAgentsRow}>
          <TouchableOpacity onPress={() => router.push('/ai-agent/research/sub-agents/innovation-pipeline-manager' as any)} style={[styles.relatedAgentCard, { backgroundColor: '#6366F115' }]}>
            <Target size={18} color="#6366F1" />
            <Text style={[styles.relatedAgentText, { color: '#6366F1' }]}>Pipeline Manager</Text>
          </TouchableOpacity>
      ...
      <AgentFeatures agentId="idea-scorer" agentName="AI Idea Scorer" />
