...
export default function ResearchMentorPage() {
  const agent = {
    ...
    description: 'Automated Research Mentor agent specializing in research operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
