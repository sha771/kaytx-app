...
export default function DemoBuilderPage() {
  const agent = {
    ...
    description: 'Automated Demo Builder agent specializing in research operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
