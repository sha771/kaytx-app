...
export default function PublicationPlannerPage() {
  const agent = {
    ...
    description: 'Automated Publication Planner agent specializing in research operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Publication Planner',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
