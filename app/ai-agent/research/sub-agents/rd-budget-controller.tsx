...
export default function RdBudgetControllerPage() {
  const agent = {
    id: 'rd-budget-controller',
    name: 'AI Rd Budget Controller',
    title: 'Research Agent',
    description: 'Automated Rd Budget Controller agent specializing in research operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Rd Budget Controller',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
