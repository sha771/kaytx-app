...
export default function TrendSpotterPage() {
  const agent = {
    ...
    description: 'Automated Trend Spotter agent specializing in research operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
