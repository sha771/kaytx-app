...
import { Activity, Lightbulb, Clock, Target, Zap, ArrowRight, Briefcase, TrendingUp, BarChart3, MessageSquare, Calendar, Shield, FileText, Users, GitBranch, CheckCircle, Layers, Settings, Rocket, Workflow, Filter, Layers2 } from 'lucide-react-native';
...
export default function InnovationPipelineManagerPage() {
  ...
  const stats = [
    { label: 'Projects', value: '89', icon: Rocket, color: '#34C759' },
    { label: 'Uptime', value: '99.9%', icon: Activity, color: '#007AFF' },
    { label: 'Response', value: '0.4s', icon: Clock, color: '#FF9500' },
    { label: 'Success', value: '94%', icon: Briefcase, color: '#E91E63' },
  ];

  const capabilities = ['Pipeline Management', 'Stage Gate Tracking', 'Resource Optimization', 'Risk Assessment', 'Milestone Planning', 'Progress Analytics', 'Stakeholder Updates', 'Portfolio View'];

  const responsibilities = [
    'Manage innovation pipeline stages',
    'Track projects through stage gates',
  ...
  const activities = [
    { time: '5 min ago', text: 'Advanced 3 projects to Stage 2', icon: GitBranch },
    { time: '20 min ago', text: 'Optimized pipeline resources', icon: Target },
    { time: '1 hour ago', text: 'Generated portfolio report', icon: BarChart3 },
    { time: '3 hours ago', text: 'Updated stakeholder dashboard', icon: Users },
  ];

  const quickActions = [
    { label: 'Pipeline', icon: Workflow, route: '/ai-agent/research' },
  ...
  const a2aEndpoints = [
    { method: 'GET', endpoint: '/api/v1/innovation/pipeline/list', description: 'List pipeline' },
    { method: 'POST', endpoint: '/api/v1/innovation/pipeline/advance', description: 'Advance stage' },
    { method: 'GET', endpoint: '/api/v1/innovation/pipeline/analytics', description: 'Get analytics' },
    { method: 'POST', endpoint: '/api/v1/innovation/pipeline/risk', description: 'Assess risk' },
  ];

  const performanceMetrics = [
    { label: 'Projects Active', value: '89', trend: '+18%' },
    { label: 'Stage Pass Rate', value: '78%', trend: '+12%' },
    { label: 'Avg Cycle Time', value: '42d', trend: '-25%' },
    { label: 'ROI Average', value: '3.2x', trend: '+35%' },
  ];
    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={[styles.hero, { backgroundColor: '#E91E6318', borderBottomColor: theme.colors.border || '#E5E5EA' }]}>
        <View style={[styles.heroIconWrap, { backgroundColor: '#E91E6325' }]}>
          <Workflow size={56} color="#E91E63" />
        </View>
        <Text style={[styles.heroTitle, { color: theme.colors.text }]}>AI Innovation Pipeline Manager</Text>
        ...
        <View style={styles.badgesRow}>
          ...
          <View style={[styles.badge, { backgroundColor: '#E91E6322' }]}><Briefcase size={12} color="#E91E63" /><Text style={[styles.badgeText, { color: '#E91E63' }]}>Manager</Text></View>
        </View>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <Text style={[styles.description, { color: theme.colors.textSecondary }]}>
          The AI Innovation Pipeline Manager oversees innovation projects through stage gates, optimizes resources, and provides comprehensive portfolio analytics.
        </Text>
      </View>
      ...
      <View style={[styles.section, { backgroundColor: theme.colors.card || '#F2F2F7' }]}>
        ...
        <View style={styles.relatedAgentsRow}>
          ...
          <TouchableOpacity onPress={() => router.push('/ai-agent/research/sub-agents/prototype-funder' as any)} style={[styles.relatedAgentCard, { backgroundColor: '#22C55E15' }]}>
            <Rocket size={18} color="#22C55E" />
            <Text style={[styles.relatedAgentText, { color: '#22C55E' }]}>Prototype Funder</Text>
          </TouchableOpacity>
        </View>
      </View>

      <AgentFeatures agentId="innovation-pipeline-manager" agentName="AI Innovation Pipeline Manager" />
