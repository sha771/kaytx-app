...
export default function PatentDrafterPage() {
  const agent = {
    ...
    description: 'Automated Patent Drafter agent specializing in research operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
