...
export default function ExperimentExecutorPage() {
  const agent = {
    ...
    description: 'Automated Experiment Executor agent specializing in research operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Experiment Executor',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
