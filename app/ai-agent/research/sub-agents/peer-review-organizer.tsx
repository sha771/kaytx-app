...
export default function PeerReviewOrganizerPage() {
  const agent = {
    id: 'peer-review-organizer',
    name: 'AI Peer Review Organizer',
    title: 'Research Agent',
    description: 'Automated Peer Review Organizer agent specializing in research operations with advanced AI capabilities for task automation, data processing, and workflow coordination.',
    ...
    replacesRole: 'Peer Review Organizer',
    infrastructure: {
      status: 'online',
      health: 95,
      uptime: '99.5%',
