...
import { Rocket, Activity, Star, CheckCircle2, Clock, Target, ArrowRight, Zap } from 'lucide-react-native';
import AgentFeatures from '@/components/ai-agent/AgentFeatures';

export default function AgentPage() {
  const { theme } = useTheme();
  const stats = [{label:'Tasks',value:'5,351',icon:CheckCircle2,color:'#34C759'},{label:'Uptime',value:'99.9%',icon:Activity,color:'#007AFF'},{label:'Response',value:'1.3s',icon:Clock,color:'#FF9500'},{label:'Accuracy',value:'98.9%',icon:Target,color:'#006064'}];
  ...
  const activities = [{time:'3 min ago',text:'Presented innovation strategy to board',icon:CheckCircle2},{time:'6 min ago',text:'Approved $5M innovation budget',icon:Clock},{time:'9 min ago',text:'Established 3 research partnerships',icon:Zap}];
  return (
