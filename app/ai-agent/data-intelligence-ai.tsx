...
export default function DataIntelligenceAIPage() {
  const agent = {
    id: 'data-intelligence',
    name: 'AI Data Intelligence',
    title: 'Data Intelligence AI',
    description: 'The Data Intelligence AI provides specialized services and automation within its department with full support for chat, analytics, performance tracking, capabilities, history, counseling, live monitoring, and comprehensive settings.',
    ...
    replacesRole: 'Data Intelligence',
