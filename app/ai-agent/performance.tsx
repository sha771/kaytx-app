...
const SYSTEM_METRICS: Metric[] = [
  { label: 'Active Agents', value: '47', change: '+3 today', positive: true, icon: Bot, color: '#3B82F6' },
  ...
  { label: 'Success Rate', value: '99.2%', change: '+0.3% vs yesterday', positive: true, icon: CheckCircle, color: '#8B5CF6' },
];
...
const COST_METRICS: Metric[] = [
  ...
  { label: 'This Month', value: '$38.5K', change: '+12% vs last month', positive: false, icon: BarChart3, color: '#3B82F6' },
  { label: 'Projected', value: '$46.2K', change: 'On budget', positive: true, icon: PieChart, color: '#F59E0B' },
...
export default function PerformanceDashboardScreen() {
  ...
  const getAlertIcon = (type: string) => {
    switch (type) {
      case 'error':
        return <AlertTriangle size={20} stroke="#EF4444" />;
      case 'warning':
        return <AlertTriangle size={20} stroke="#F59E0B" />;
      case 'info':
        return <CheckCircle size={20} stroke="#3B82F6" />;
      default:
          ...
          <>
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                ...
                <TouchableOpacity>
                  <Filter size={18} color={colors.tint} />
                </TouchableOpacity>
              </View>
